...
//
// ---------------------------------------------------------------------------
// FACET MAP: the 29 domain facets (each IWorld member assigned exactly once;
...
// with PHAA-574's crafting.ts facet (2 members), PHAA-626's collections.ts
// facet (2 members), and PHAA-687's achievements.ts facet (2 members). One
// interface per file under ./world_api/; aux types travel with their facet.
// The authoritative member-per-facet split is the W0c parity test
...
//   tests/world_api_parity.test.ts (W0c)  IWORLD_MEMBERS (184) present + same-kind on
