...
- `i18n.resolved.generated.ts` is the **generated dense table** the runtime imports
  (do not hand-edit). `i18n.status.json` is the **registry** (translated/pending/blocked).
