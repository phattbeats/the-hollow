    ...
    hud: {
      ...
      keybinds: {
        ...
        actions: {
          ...
          target: "Bersaglia il nemico più vicino", attackMove: "Movimento d'attacco", interact: "Interagisci / Saccheggia", char: "Personaggio", spellbook: "Libro degli incantesimi", questlog: "Registro missioni", map: "Mappa del mondo", bags: "Borse", nameplates: "Mostra nomi", meters: "Misuratori danni", social: "Amici e gilda", arena: "Arena (Colosseo Cinereo)", chat: "Apri chat", attack: "Attacca", actionBarSlot: "Barra azioni {slot}",
        },
      },
      meters: {
    ...
    hud: {
      ...
      keybinds: {
        ...
        actions: {
          ...
          target: "Nächsten Gegner anvisieren", attackMove: "Angriffsbewegung", interact: "Interagieren / Plündern", char: "Charakter", spellbook: "Zauberbuch", questlog: "Questlog", map: "Weltkarte", bags: "Taschen", nameplates: "Namensplaketten umschalten", meters: "Schadensanzeigen", social: "Freunde & Gilde", arena: "Arena (Aschenes Kolosseum)", chat: "Chat öffnen", attack: "Angreifen", actionBarSlot: "Aktionsleiste {slot}",
        },
      },
      meters: {
    ...
    hud: {
      ...
      keybinds: {
        ...
        actions: {
          ...
          target: "选中最近敌人", attackMove: "攻击移动", interact: "互动 / 拾取", char: "角色", spellbook: "法术书", questlog: "任务日志", map: "世界地图", bags: "背包", nameplates: "切换姓名板", meters: "伤害统计", social: "好友与公会", arena: "竞技场（灰烬斗技场）", chat: "打开聊天", attack: "攻击", actionBarSlot: "动作条 {slot}",
        },
      },
      meters: {
    ...
    hud: {
      ...
      keybinds: {
        ...
        actions: {
          ...
          target: "選取最近敵人", attackMove: "攻擊移動", interact: "互動 / 拾取", char: "角色", spellbook: "法術書", questlog: "任務日誌", map: "世界地圖", bags: "背包", nameplates: "切換姓名板", meters: "傷害統計", social: "好友與公會", arena: "競技場（灰燼競技場）", chat: "開啟聊天", attack: "攻擊", actionBarSlot: "動作列 {slot}",
        },
      },
      meters: {
    ...
    hud: {
      ...
      keybinds: {
        ...
        actions: {
          ...
          target: "가장 가까운 적 대상 지정", attackMove: "공격 이동", interact: "상호작용 / 전리품", char: "캐릭터", spellbook: "마법책", questlog: "퀘스트 기록", map: "세계 지도", bags: "가방", nameplates: "이름표 전환", meters: "피해량 미터", social: "친구 및 길드", arena: "투기장 (잿빛 원형경기장)", chat: "채팅 열기", attack: "공격", actionBarSlot: "행동 단축바 {slot}",
        },
      },
      meters: {
    ...
    hud: {
      ...
      keybinds: {
        ...
        actions: {
          ...
          target: "最も近い敵をターゲット", attackMove: "アタックムーブ", interact: "相互作用 / 戦利品", char: "キャラクター", spellbook: "魔法書", questlog: "クエストログ", map: "ワールドマップ", bags: "バッグ", nameplates: "ネームプレート切り替え", meters: "ダメージメーター", social: "フレンド & ギルド", arena: "アリーナ（灰の闘技場）", chat: "チャットを開く", attack: "攻撃", actionBarSlot: "アクションバー {slot}",
        },
      },
      meters: {
    ...
    hud: {
      ...
      keybinds: {
        ...
        actions: {
          ...
          target: "Selecionar inimigo mais próximo", attackMove: "Mover e atacar", interact: "Interagir / Saquear", char: "Personagem", spellbook: "Livro de feitiços", questlog: "Registro de missões", map: "Mapa do mundo", bags: "Bolsas", nameplates: "Alternar placas de nome", meters: "Medidores de dano", social: "Amigos e guilda", arena: "Arena (Coliseu Cinzento)", chat: "Abrir chat", attack: "Atacar", actionBarSlot: "Barra de ação {slot}",
        },
      },
      meters: {
...
const itemStrings = {
  ...
  es: {
    itemUi: {
      ...
      slots: { mainhand: "Mano principal", chest: "Pecho", legs: "Piernas", feet: "Pies", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  fr_FR: {
    itemUi: {
      ...
      slots: { mainhand: "Main droite", chest: "Torse", legs: "Jambes", feet: "Pieds", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  it_IT: {
    itemUi: {
      ...
      slots: { mainhand: "Mano principale", chest: "Torace", legs: "Gambe", feet: "Piedi", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  de_DE: {
    itemUi: {
      ...
      slots: { mainhand: "Waffenhand", chest: "Brust", legs: "Beine", feet: "Füße", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  zh_CN: {
    itemUi: {
      ...
      slots: { mainhand: "主手", chest: "胸部", legs: "腿部", feet: "脚部", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  zh_TW: {
    itemUi: {
      ...
      slots: { mainhand: "主手", chest: "胸部", legs: "腿部", feet: "腳部", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  ko_KR: {
    itemUi: {
      ...
      slots: { mainhand: "주장비", chest: "가슴", legs: "다리", feet: "발", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  ja_JP: {
    itemUi: {
      ...
      slots: { mainhand: "メインハンド", chest: "胸", legs: "脚", feet: "足", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  pt_BR: {
    itemUi: {
      ...
      slots: { mainhand: "Mão principal", chest: "Peito", legs: "Pernas", feet: "Pés", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
  ...
  ru_RU: {
    itemUi: {
      ...
      slots: { mainhand: "Правая рука", chest: "Грудь", legs: "Ноги", feet: "Ступни", helmet: "Helmet", shoulder: "Shoulder", waist: "Waist", gloves: "Gloves" /* i18n-todo */ },
