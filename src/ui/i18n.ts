...
// Re-export the authoritative en base, gameStrings, and the type machinery so
// importers of './i18n' keep an unchanged public surface. The per-locale objects
// are exported inline below.
export { en };
