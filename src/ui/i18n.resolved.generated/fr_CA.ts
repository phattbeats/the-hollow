...
export const fr_CA: EnTranslations = {
  ...
  "guide": {
    ...
    "family": {
      ...
      "spider": {
        "name": "Araignées",
        "desc": "Tisseuses de toiles et rôdeuses venimeuses qui nichent dans les recoins sombres et enchevêtrés. Les Hunters peuvent les apprivoiser, au même titre que les bêtes."
      },
      "murloc": {
        "name": "Murlocs",
