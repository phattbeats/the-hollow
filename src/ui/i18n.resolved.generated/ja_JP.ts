...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorial": {
      ...
      "talkBodyTouch": "緑掌修道士に近づき、「使用」ボタンをタップして話しかけ、頼まれごとを引き受けましょう。",
      "returnBodyTouch": "燃えるものを手にしています。緑掌修道士のもとへ戻り、「使用」ボタンをタップして渡しましょう。",
      "doneBodyTouch": "基本は覚えましたね、{name}。空洞はあなたのもの、自由に歩き回りましょう。緑掌修道士にはいつでも次の用事があります。いつでも「その他」から「クエストログ」をタップしてクエストログを確認できます。"
    },
    "widgets": {
    ...
    "npcJournal": {
      "readLabel": "日記について聞かせてください。",
      "readAria": "{name}の日記を読む",
  ...
  "guide": {
    ...
    "home": {
      ...
      "world": {
        ...
        "cta": "ワールドを見る",
        "hollowReachesName": "ホロウ低地",
        "hollowReachesBlurb": "聖堂の門の下に広がる静かな土地。新参者はFallow AcresとRoot Hollow周辺で腕を磨く。",
        "valeName": "イーストブルックの谷",
    ...
    "hollowPage": {
      "heading": "The Hollow",
      "intro": "聖堂の門をくぐると花瓶のある広場に出る。すべての新たな英雄が目覚め、そして必ず戻ってくる場所だ。大陸全体で共有される一つの拠点であり、最初に出会う顔ぶれも、最初の依頼も、そして本当に必要な唯一の我が家もここにある。",
      "greeting": "戻ってきたか、それは何よりだ……いくつか神聖な用事が溜まっている、前と同じ波長でな。ちょっとこっちへ……",
      "greeter": "グリーンポー修道士、花瓶のそばで",
      "vaseHeading": "花瓶",
      "vaseBody": "誰もが花瓶から始まる。ホロウが築かれた中心にある、古く耳を傾ける存在だ。エンバーバルブを一つ燃やす、洞窟モーセルを一つ与える、そんな小さな捧げ物を求め、受け取ると気づいているようだ。花瓶の下手には洞窟の入り口があり、地下聖堂へと続いている。両脇には自分だけの我が家を築ける区画が並ぶ。",
      "figuresHeading": "誰が世話をしているか",
      "figuresBody": "花瓶を維持している二人がいて、最初の数分でどちらにも出会うことになる。",
      "npcFmt": "{name}, {title}",
      "greenpawBody": "花瓶の唯一の世話役であり、最初の依頼を渡してくる人物。自称の肩書きであることを本人が真っ先に認めており、ホロウにおける案内役に一番近い存在だ。",
      "yarrowBody": "第二の天職の指南役。どのクラスも彼女から副業を学ぶことができ、花瓶を挟んでグリーンポーの向かいに立っている。",
      "questsHeading": "最初の依頼",
      "questsBody": "グリーンポー自身の依頼の連なりが最初にやることだ。花瓶のリズムを教えてくれる四つの短い用事をこなしてから、より広いホロウへと送り出される。",
      "questBurnsBody": "花瓶が光のために燃やす、洞窟育ちの球根をひとつかみ集める。",
      "questFillsBody": "もっと静かな空腹を満たす、洞窟で育つモーセルを同じように集める。",
      "questWavelengthBody": "花瓶の第二の天職への案内と、自分の手で餌をやることを教わる。",
      "questKeepLitBody": "一度きりの頼みを、三回続けて習慣に変える。",
      "housingHeading": "自分だけの我が家",
      "housingBody": "花瓶の周りには{n}区画の宅地が並び、あなただけのホロウの片隅として、手に入れて飾り付けるのを待っている。",
      "shrineHeading": "地下聖堂",
      "shrineBody": "花瓶のそばの洞窟の入り口は地下聖堂へと続く。ホロウ自身のインスタンスダンジョンであり、新たな英雄が初めてパーティで臨む本当の試練だ。",
      "outsiderHeading": "外の世界からはどう見られているか",
      "outsiderBody": "聖域の門を出れば、花瓶のことを知る者などほとんどいない。知っている数少ない者たちも、その番人たちをヒッピーだの変わり者だの、もっと言えば壺に話しかける変人だのと片付けてしまう。それ以外に伝わる話といえば、もっと奇妙な目撃談ばかりだ。空き地から遠く離れてしまった信者や、いるはずのない場所で見つかった小さな緑の生き物の噂だ。"
    },
    "worldPage": {
      "heading": "世界",
      "intro": "花瓶から聖堂の門を出ると、ホロウの奥地に出る。新たな来訪者が屋外で最初の一歩を踏み出す静かな土地だ。さらに北へ3つのゾーンが南から北へと連なっているが、そこへの道はまだ開かれていない。とはいえそれらは実在し、待っている。",
      "hub": "拠点",
      "mapHeading": "北への道",
      "mapSub": "南から北へ三つのゾーンが並び、それぞれレベルが一段ずつ上がります。クエストの道筋をたどれば、土地が谷から峰々へとあなたを運んでいきます。",
      "places": "注目の場所",
      "residents": "出会う者たち",
      "hollowReachesBlurb": "聖堂の門をすぐ越えた先の穏やかな土地で、新参者はFallow AcresとRoot Hollow周辺の狼や猪を相手に腕を磨く。",
      ...
      "hollowReachesGreeting": "この低地は暦通りに保とうとしている、努力はしているがな。土がゆるいから気をつけて、台帳には触れるな。",
      "hollowReachesGreeter": "ヴァージャー・ゼベディア、Root Hollow",
      ...
      "hollowReachesPlaceNotes": "the Hollow Gateは、開けた土地へと再び開いた聖堂の門だ。西のFallow Acresでは、セクストン・ファディックが建設予定地から狼を追い払っている。東のRoot Hollowでは、ヴァージャー・ゼベディアが猪に荒らされた区画を暦通りに管理している。湖畔のMossbankは釣りに適した静かな場所だ。",
    ...
    "questsPage": {
      ...
      "storyBody": "最初の糸口は花瓶のすぐそばにある、グリーンポー修道士自身の短い依頼の連なりだ。その先にはホロウの奥地の静かな用事があり、さらにその先には谷から山頂まで進軍する死のカルトを巡る、より長い物語がある。それは本物で完結した内容だが、新たな英雄がまだ歩ける道ではない。花瓶自身の依頼はホロウのページで、残りは来るべきものとして以下に記す。",
      "soloNote": "メインストーリーは各章のフィナーレまで完全にソロで進められます。そのフィナーレは五人用のダンジョンです。",
      "sagaGateNote": "この物語は本物で、完結した内容だ。北への道が再び開いた時に開放される、同じ道筋である。新たな英雄が今日歩き出す場所ではない。その場所は花瓶、ホロウの中にある。",
  ...
  "coldOpen": {
    ...
    "orientBody": "祠は静まり返り、煙のにおいがかすかに漂っている。まずは足元を確かめるといい。準備ができたら、緑の光をたどって進もう。この先で誰かが炎の番をしている。あなたが失ったものを知っているかもしれない。",
    "continue": "つづける",
    "begin": "はじめる",
    "skip": "スキップ"
  },
  ...
  "hud": {
    ...
    "tutorial": {
      ...
      "dismiss": "閉じる",
      "doneTitle": "立ち上る煙",
      "doneBody": "基本は覚えましたね、{name}。空洞はあなたのもの、自由に歩き回りましょう。緑掌修道士にはいつでも次の用事があります。いつでも {questKey} キーでクエストを確認できます。",
      "moveTitle": "まず一歩を",
      "moveBody": "{moveKeys} で移動し、マウスで周囲を見回します。数歩進んで始めましょう。",
      "seekTitle": "緑掌修道士を探す",
      "seekBody": "緑掌修道士は壺のふもとで、何もかも底をつき腹を空かせて待っています。目印をたどって彼のもとへ向かいましょう。",
      "talkTitle": "頼まれごとを聞く",
      "talkBody": "緑掌修道士に近づき、{interactKey} を押して話しかけ、頼まれごとを引き受けましょう。",
      "gatherTitle": "燃えるもの",
      "gatherBody": "残り火の球根は光の届かぬ場所に育ちます。地下祠へ降り、蒼白喰らいから奪い取りましょう。彼らはあなたではなく、灯りに引き寄せられます。",
      "gatherProgress": "集めた残り火の球根：{current} / {needed}",
      "returnTitle": "炉に捧げる",
      "returnBody": "燃えるものを手にしています。緑掌修道士のもとへ戻り、{interactKey} を押して渡しましょう。"
    },
    "markers": {
      "names": {
        "star": "星",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "verger_zebediah": {
        "name": "堂守のゼベダイア",
        "title": "根の空洞の衛士",
        "greeting": "堂守のゼベダイアだ。この外域を暦に沿って管理しておる、少なくとも努めてはおる。根の空洞は今季、休ませると記しておいた。だが猪どもは告示を読まん。緩んだ土に気をつけ、台帳には触れるな。",
        "introLines": {
          "0": "堂守のゼベダイア。根の空洞の衛士、ただ今のところその職は私一人でございます。ほとんどの日はここにおります。それ以外の日は、私がここにいるように感じております。外域には定足数は要りません、要るのは記録だけでございます。",
          "1": "私が暦を継いでおります。暦は私を継いではくれませんが、季節の折に触れて試みてまいります。根の空洞は今季、休むと記されておりますが、下の巣にはその通達が届いておりません。鷺ももう驚いたふりをやめてしまいました。これが現状です。苦情ではございません、苦情には証人が要りますので。",
          "2": "祠の中には台帳がございます。触れぬよう。足元には猪の掘り返した緩い土が広がっております。両方にお気をつけを。もしも御用がお務めについてのことでございましたら、二つの仕事をご用意できます。どちらも小さくはございません、そのうち一つは三度目の書き直しを避けたい次第で。これが、そもそも何故あなた様にお声を掛けておるかの次第でございます。"
        },
        "journalLines": {
          "0": "台帳は鷺よりも古い。私が始まりの頁を書いたわけではないし、私が最後の頁を書くわけでもない。継ぐ者をお待ちにならない務め、それがこの職の慰めでございます。外域はかつては往来の通路でございました。塩を抱えた方々が湖の道を通って上り、名を持たぬ何かを持って下りてこられた。尋ねてはならぬと申されておりましたので、私も尋ねませんでした。台帳は往き来と、その長い空白の一区を記しております。空白も私が継いでおります。",
          "1": "鷺は台帳より古く、台帳はそれを快く思っておりませぬ。口には出しませぬ。出す必要もございませぬ。梨の木を枯らした季節を片足で立ち過ごして瞬き一つなさらぬのを見てまいりましたので、それは何かについての御立場と受け止めておりますが、伺ったことはございませぬ。祠の地下に、私が足を踏み入れぬ部屋がございます。鷺は入ってまいります。何をなさるか伺わず、鷺も私が上で何をするか伺いません。この取り決めは、互いの齢より永く続いてまいりました。",
          "2": "ここまで読まれた方は、物好きか、猪を避けているかのどちらかでございまして、どちらにも敬意を表します。長い記録の短い版を申し上げますと、この場所はかつて何であったかと、再び何であろうとしているかとを覚えておりますが、その差こそが仕事でございます。覚えるのは私の勤めでございます。再び何になるか、その主が誰かは存ぜぬ。保留と申し添えて床に就きます。台帳は保留を許します。忘却は許しません。",
          "3": "湖道を上ってきて花瓶の噂を耳にした旅人は、たいてい二つの結論のどちらかに行き着きますが、どちらもあまり褒めたものではございません。この一団をヒッピーだの変わり者だのと呼んで笑いながら去る者もあれば、もっと辛辣な言葉を残して立ち止まりもしない者もございます。ほとんどの者は花瓶のことなど耳にすらしませぬ。それこそがこの取り決めの本来の姿であろうと、近ごろは思うようになりました。静かなものは、名高いものより長く生き延びるものでございます。"
        }
      },
      "sexton_faddick": {
        "name": "墓守のファディック",
        ...
        "introLines": {
          "0": "ファディックだ。まだ墓守を務めるべき祠があるうちは、墓守を務める。そうした祠は、以前より少なくなったがの。俺はどこにも留まらん、ただ守るだけだ。守ること、それが今でも俺のほぼ全てでござる。",
          "1": "長く回れば、回っている相手の形を覚えるものだ。休閑地の狼どもは、私が通りかかるずっと前から、毎晩群れの周りを回っておった。群れの形はまだ覚えておらぬ、それが何と言うか。群れの方こそ、彼らを覚えておる、それ以上のことでござる。",
          "2": "お茶でもお出ししたいところだが、薬罐は私が昨日いたどこかにございます。湖のほとりには、建物が建つのを待っておる静かな土地が広がっておる。闇で狼が働く土地には、何も根を下ろせぬ。さて、二つの仕事がある、一つは一人でやりたくない仕事だ。歩きながら話しませうぞ。"
        },
        "journalLines": {
          "0": "継いできた場所の覚えを、頭にだけ置いておく。紙の方が土地より早く持ち主を変えるので。祠がほとんどだ、もう誰も祀らぬ祠。休閑地もその一つだ。湖の東の、名の知らぬ池もそうだし、百年の風で丸まった立石もそうだ。覚えは長くない。覚えが肝のところでは、覚えが、つまりは全部だ。場所に留まることで場所は継がれぬ。かつてそこにあったと知る者でい続けば、それが継ぎ方だ。",
          "1": "土地の方が我々よりよく覚えておる。それが取引の全てだ。地上を歩く者は、二代で己の名を忘れ、新しい名を作って同じと呼ぶ。地下に留まる者は、何も忘れず、待つ。石の下の遅い時間がある。一度だけ、それを聞いたが、答えなかった。答えるのが、あれに扉のありかを知らせることになるからだ。答えぬことの鍵は私が持っている。金属の鍵ではない。習慣だ、重い。",
          "2": "狼が問題ではない。狼は兆しだ。問題は、土地を静まり返らせて、狼どもが己のものと思うほどにした何かなのだ。そういうのは見たことがある。誤った方角に静かになる土地で、療法はいつも同じだ:正しい騒音で再び騒がしくする。騒音とは人だ。人が建てる理由がそれだ。誰だとお思いかもしれぬが、歩く者でいる私、それが要件の全てだ。足りぬようで足りており、その間にある隔たりには折り合いをつけてきた。"
        }
      },
      "shade": {
        "name": "シェイド",
      ...
      "gate_bard": {
        "name": "吟遊詩人ハルデン",
        "title": "門前の弾き手",
        "greeting": "一曲、銅貨一枚でどう？いらない？いいのよ、たいていの日はいらないと言われる。私はこの門のために弾くけれど、門は一度も財布に手を伸ばしてくれたことがない。通りすがりの連中はここをヒッピーの溜まり場だの、もっとひどいことだの言うけれど、大抵はただの通りすがりだから、好きに言わせているわ。"
      },
      "goodwife_orla": {
        "name": "オルラ",
        "title": "かつて根の空洞の者",
      ...
      "withered_planting": {
        "name": "枯れかけた苗木",
        "title": "部族の古い柳",
        "greeting": "乾いた根、乾いた葉。これが何になるはずだったにせよ、まだそうはなっていない。ずっと待たされたままだ。"
      },
      "buried_root": {
        "name": "埋もれた根",
        "title": "祠の下",
        "greeting": "乾いてる。ここの何もかもと同じくらい、とことん乾いてる。"
      }
    },
    "quests": {
      "q_wolves": {
      ...
      "q_what_fills": {
        ...
        "dialog": {
          "complain": "ついさっき下りてきたところだ。俺が穴から這い出るのを見ていただろう。",
          "complainReply": "わかってる、友よ、わかってるんだ……壺は暦なんて持っちゃいないし、俺の腹もそうだ。だがそのブーツを見てみろ、もう一回くらい下りられるって顔してるだろう……急がなくていい。穴はどこにも行きゃしない。それがあいつの持ち味ってやつだ……",
          "refuse": "いやだ。もう二度とあそこには下りない。",
      ...
      "q_root_hollow_boars": {
        ...
        "completion": "五頭。数え、日付を入れ、台帳に記した。根の空洞は今や自らの季にわずか二週の遅れ、この職ではこれを大勝利と呼ぶ。今のところ俺一人となった教団を代表して、礼を言う。",
        "objectives": {
          "0": {
            "label": "野生の猪を討伐"
          }
      ...
      "q_fallow_acres_wolves": {
        "title": "畝を追われる狼たち",
        "text": "誰かが休閑地に家を建てるつもりらしい。よいことだ。人の住む地は住まぬ地より物覚えがよい、そしてこの一帯は多くを忘れてしまった。だが狼が夜を働かせているうちは、何も落ち着かん。群れを五頭まで間引いてくれ、その足労には必ず報いる。報いること、それが今の俺に残された役目のほとんどだ。",
        "completion": "静かになった。よい。俺はかつて人で賑わっていた静かな地に数多く立ってきた。ここは逆の道をたどる望みがある。礼を言う、道中気をつけてな。",
        "objectives": {
          "0": {
            "label": "森の狼を討伐"
          }
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "最後の群れ",
        "text": "端は薄くなったが、巣はそうでない。あと八頭で、休閑地は夜のうちに屋根の下で眠る者を失わずに、家を構えられる。俺が自ら見てやりたいが、同じ場所に二度いることは滅多にない。それに祠の下の地の方が、この畝よりも守りを要しておる。",
        "completion": "よし。静かな夜が一つ、その後ろにおそらく百の夜が続く。よく建てよ。そしてもしいつか、深く掘って地の底で何かがゆっくりと時を刻むのを聞いても、応えてはならん。それは俺が守るべきもの、その鍵は俺が持っておる。さあ、行け。",
        "objectives": {
          "0": {
            "label": "森の狼を討伐"
          }
      ...
      "q_the_long_way_around": {
        "title": "遠回りの道",
        "text": "部族が古い柳のところに途中までしか植えなかった苗があってね、あと一度たっぷり水をやらないと枯れてしまう。あそこまでもう登れないんだ、でもあんたなら脚がある。この水差しを持っていっておくれ。枝には気をつけて——素直に扱えば、ちゃんと支えてくれるから。",
        "completion": "これでもう大丈夫、生きていける。一度登って、一度水をやっただけで、そう大したことじゃないと思うかもしれない。世の中の他のことに比べたらね。大したことじゃない。でも水をやられたその一本にとっては、それがすべてなんだよ。",
        "objectives": {
          "0": {
            "label": "柳の小道へ水を届けた"
          }
      ...
      "q_the_watering_can": {
        "title": "あの水差し",
        "text": "今まで小さな頼み事ばかりしてきたのに、あんたは理由も聞かずに全部やってくれた。これが最後の頼みだ、見た目は小さそうだけど、実はそうじゃない。私の水差しを持って祠の下まで下りて、そこに埋まっているものに水をあげておくれ。ずっと待っていたんだよ、何かを求められることじゃなく、何かを与えられることをね。",
        "completion": "やってくれたね。もちろんそうすると思ってた。それが水だったんだよ、わかるかい。あの湖のほとりで私に出会って、何とも思わなかったあの日まで、ずっと全部つながっていた。同じ水やり、同じ約束を、もう一度果たしただけ。ありがとう。さあ、行きなさい。世界に優しくしておくれ。それだけが、世界を本当に変えてきたものなんだから。",
        "objectives": {
          "0": {
            "label": "埋もれた根に水を与えた"
          }
