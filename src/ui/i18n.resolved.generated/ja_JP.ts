  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        "name": "緑掌修道士",
        "title": "初代預言者（自称）",
        "greeting": "えっと……よお。よお。近づいてくるの気づかなかったよ、ちょいと緑のどこかに心が飛んでてな……名は緑掌。初代預言者、自称だがね、大した意味はねえ。だが誰かが壺の面倒を見なきゃならんし、古い部族の残りももういなくて、文句を言う奴もいねえのさ。まあ来いよ、片付けなきゃならん神聖な用事が二つばかりある。ほとんど食い物のことだけどな。緑掌的にはそれも同じようなもんだ。"
      },
      "warden_fennick": {
        "name": "番人フェニック",
        "title": "外域の野伏せり",
        "greeting": "根の空洞は今季、猪だらけだ。虫を追って根を掘り返しておる。やり合う気がないなら、緩んだ土に気をつけるんだな。"
      },
      "old_badger_thistlewick": {
        "name": "老アナグマのシスルウィック",
        "title": "休閑地の農夫",
        "greeting": "ここは良い土地だ、柵さえ保てばな。毎晩狼が群れの周りをうろついて、何も建てられやしない。"
      }
    },
    "quests": {
      "q_wolves": {
      ...
      "q_root_hollow_boars": {
        "title": "根の空洞の猪",
        "text": "猪どもが虫を追って根の空洞を半分も掘り返し、もう滅多なことじゃ怖がらん。五頭狩れば、根も一季は休めよう。",
        "completion": "土を掘り返す鼻面が五つ減った。根の空洞は感謝しておる、口には出せんがな。",
        "objectives": {
          "0": {
            "label": "野生の猪を討伐"
          }
      ...
      "q_root_hollow_boars_ii": {
        "title": "根の空洞の清算",
        "text": "五頭は始まりに過ぎん、下の巣からまだまだ湧いてくる。けりをつけろ、あと八頭で根の空洞も本当に休める。",
        "completion": "これでほぼ最後の掘り返し屋どもだ。根も息がつける。",
        "objectives": {
          "0": {
            "label": "野生の猪を討伐"
          }
      ...
      "q_fallow_acres_wolves": {
        "title": "畝を追われる狼たち",
        "text": "毎晩狼がうろついて、ここでは何も守れやしない。休閑地の群れを間引いてくれ、わざわざ来た甲斐はあるはずだ。",
        "completion": "これで幾晩か安眠できるというもんだ。恩に着る。",
        "objectives": {
          "0": {
            "label": "森の狼を討伐"
          }
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "最後の群れ",
        "text": "端は間引いたが、巣はまだいっぱいだ。あと八頭で休閑地にも静かな夜が来よう。",
        "completion": "やっと静かになった。これで柵の続きに取りかかれる。",
        "objectives": {
          "0": {
            "label": "森の狼を討伐"
          }
