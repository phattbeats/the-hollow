  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        "name": "브라더 초록발",
        "title": "초대 선지자(자칭)",
        "greeting": "어······ 안녕. 안녕하신가. 다가오는 걸 못 들었네, 잠깐 어딘가 푸른 데로 정신이 팔려 있어서 말이야······ 이름은 그린포우. 초대 선지자, 자칭이지만 뭐 대단할 건 없지. 그래도 누군가는 이 항아리를 돌봐야 하고, 옛 부족에 남은 이들도 이제 없으니 딱히 뭐라 할 사람도 없다네. 이리 와 보게, 처리해야 할 신성한 일이 몇 가지 있어. 대부분 간식거리지만. 뭐, 그린포우 식으로 치면 그게 그거지."
      },
      "warden_fennick": {
        "name": "감시관 페닉",
        "title": "외곽의 순찰자",
        "greeting": "이번 철엔 뿌리굴에 멧돼지가 들끓어서, 벌레를 쫓다가 뿌리를 다 파헤쳐 놨소. 맞붙을 생각이 아니면 무른 흙을 조심하시오."
      },
      "old_badger_thistlewick": {
        "name": "늙은 오소리 시슬윅",
        "title": "묵정밭 농부",
        "greeting": "여기 땅은 좋아, 울타리만 버텨준다면 말이지. 밤마다 늑대가 가축 떼 주위를 맴도니 뭘 짓지도 못하겠구먼."
      }
    },
    "quests": {
      "q_wolves": {
      ...
      "q_root_hollow_boars": {
        "title": "뿌리굴의 멧돼지",
        "text": "멧돼지들이 벌레를 쫓다가 뿌리굴 절반을 파헤쳐 놨고, 이젠 겁도 잘 안 내오. 다섯 마리만 잡아주면 뿌리도 한 철은 쉴 수 있을 거요.",
        "completion": "흙 파헤치던 주둥이가 다섯 개 줄었군. 뿌리굴이 고마워하고 있소, 말은 못 해도.",
        "objectives": {
          "0": {
            "label": "야생 멧돼지 처치"
          }
      ...
      "q_root_hollow_boars_ii": {
        "title": "뿌리굴의 결산",
        "text": "다섯 마리는 시작에 불과했고, 아래 굴에서 계속 튀어나오는구려. 끝을 봅시다: 여덟 마리만 더 잡으면 뿌리굴도 제대로 쉴 수 있을 거요.",
        "completion": "이제 땅 파헤치던 놈들은 거의 다 정리됐군. 뿌리도 숨을 돌리겠소.",
        "objectives": {
          "0": {
            "label": "야생 멧돼지 처치"
          }
      ...
      "q_fallow_acres_wolves": {
        "title": "이랑에서 몰아낸 늑대",
        "text": "밤마다 늑대가 맴돌아서야 땅뙈기 하나 지킬 수가 없소. 묵정밭의 무리를 솎아주면, 헛걸음은 안 되게 해주리다.",
        "completion": "그거면 며칠 밤은 편히 잘 수 있겠구먼. 고맙소.",
        "objectives": {
          "0": {
            "label": "숲늑대 처치"
          }
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "마지막 무리",
        "text": "가장자리는 솎았지만 굴은 아직도 가득하오. 여덟 마리만 더 잡으면 묵정밭에도 조용한 밤이 오겠지.",
        "completion": "드디어 조용해졌군. 이제 울타리를 마저 손볼 수 있겠소.",
        "objectives": {
          "0": {
            "label": "숲늑대 처치"
          }
