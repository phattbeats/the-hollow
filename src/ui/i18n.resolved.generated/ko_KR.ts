  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "dialogNode": {
          "hearth": "하우디, 친구, 또 항아리 곁으로 왔구먼, 오늘은 그 녀석이 조용해, 진짜 열심히 듣고 있는 건지 아니면 그냥 무시하는 건지, 도무지 모르겠단 말이지, 솔직히 말해서… 그나저나 할로우는 자네한테 어땠나, 좋았나 나빴나, 간식 좀 있나, 없어? 알았어 그냥 물어본 거야, 친구를 위해 물어보는 거지, 그 친구가 바로 나야…",
          ...
          "vase": "늘 똑같지, 그 녀석은 연기를 원하고, 보살핌을 원하고, 곁에 앉아서 이 고요를 대화처럼 느끼게 해줄 누군가를 원해, 뭐, 나한테는 그게 잘 통하거든, 나는 맨날 그 녀석한테 말 걸고 있고 그 녀석은 한 번도 대답 안 했지, 어, 한 번도, 근데 뭐 괜찮아, 대충 그런 거야, 그린포 기준으로 괜찮은 거지… 잠깐, 우리 무슨 얘기 하고 있었지… 아. 맞다. 그 녀석 얘기. 걘 괜찮아. 아마 배고플 거야. 동감.",
          "faith": "믿는다는 건 거창한 말이야, 친구, 난 그냥 돌보는 거야, 돌보는 건 이 두 손으로 할 수 있는 일이니까, 라이터 하나 있고, 이력서에 그게 다야… 그 녀석이 듣고 있는지 아닌지는 나도 몰라, 근데 연기는 어쨌든 향기롭게 피어오르니까, 파장은 어떻게든 맞춰지는 거지. 그렇고말고.",
          ...
          "mended": "괜찮아, 친구, 다 도박이야, 원래부터 그랬어, 내 안의 카우보이가 하는 말인데… 이런 곳은 가끔 모진 말 한마디쯤 나올 만하지, 아니라고는 안 할게… 근데 자네는 돌아와서 미안하다고 했잖아, 그건 뭔가 의미가 있는 거야, 아니면 뭔가 원하는 게 있다는 거고, 어느 쪽이든 우리 이제 셈은 끝났어, 자네랑 나 말이야, 파장도 맞고, 나중에 간식 필요하면 내가 살게.",
