    ...
    "npcs": {
      ...
      "verger_zebediah": {
        ...
        "introLines": {
          ...
          "2": "사당 안엔 장부가 있소. 손대지 마시오. 발밑에는 멧돼지가 뒤집어놓은 무른 흙이 퍼져 있소. 둘 다 조심하시오. 만약 이곳 파수一事로 오신 거라면, 두 가지 일을 맡길 수 있소. 어느 쪽도 작진 않고, 그중 하나는 세 번째 고치고 싶지 않은 일이오. 이게 결국 내가 그대에게 말을 붙인 까닭이라오."
        },
        "journalLines": {
