...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "npcJournal": {
      "readLabel": "일지에 대해 들려주세요.",
      "readAria": "{name}의 일지 읽기",
  ...
  "guide": {
    ...
    "home": {
      ...
      "world": {
        ...
        "levels": "{min} - {max} 레벨",
        "cta": "세계 둘러보기",
        "hollowReachesName": "우묵골 지대",
        "hollowReachesBlurb": "성소 문 아래 고요한 땅으로, 새 이주자들이 묵정밭과 뿌리굴 주변에서 실력을 쌓는 곳.",
        "valeName": "동부개울 골짜기",
    ...
    "hollowPage": {
      ...
      "outsiderHeading": "바깥세상이 이곳을 보는 시선",
      "outsiderBody": "성역의 문 너머에서는 대부분의 사람들이 화병의 존재조차 들어본 적이 없다. 들어본 소수도 그 수호자들을 히피니, 괴짜니, 심하면 항아리에게 말을 거는 별종이니 하며 치부해 버린다. 그 밖에 흘러나오는 이야기는 더 기이한 목격담뿐이다. 공터에서 너무 멀리 벗어난 신도, 혹은 있어서는 안 될 곳에서 발견된 작은 초록빛 생물에 관한 소문이다."
    },
    "worldPage": {
      "heading": "세계",
      ...
      "places": "주요 명소",
      "residents": "만나게 될 이들",
      "hollowReachesBlurb": "성소 문을 막 지난 고요한 땅으로, 새내기들이 묵정밭과 뿌리굴 주변에서 늑대와 멧돼지를 상대로 실력을 갈고닦는 곳.",
      ...
      "hollowReachesGreeting": "이 우묵골을 달력대로 지키려 하오, 애는 쓰고 있소. 흙이 무르니 조심하고, 장부에는 손대지 마시오.",
      "hollowReachesGreeter": "성물지기 제베디아, 뿌리굴",
      ...
      "hollowReachesPlaceNotes": "홀로우 관문은 열린 땅으로 다시 열린 성소의 문이다. 서쪽 묵정밭에서는 묘지기 패딕이 건설 예정지에서 늑대를 몰아내고, 동쪽 뿌리굴에서는 성물지기 제베디아가 멧돼지가 들끓는 구획을 달력대로 관리한다. 호숫가의 이끼둑은 낚시하기 좋은 조용한 곳이다.",
  ...
  "coldOpen": {
    "title": "공동",
    "wakeBody": "당신은 따뜻한 땅 위에서 깨어난다. 자신의 이름도, 일족도, 어떻게 이곳에 왔는지도 기억나지 않는다. 앞쪽의 커다란 항아리에서 초록빛이 배어 나오고, 그 빛은 마치 줄곧 당신을 기다려 온 것만 같다.",
    "orientBody": "사당은 고요하고, 연기 냄새가 은은히 남아 있다. 잠시 숨을 고르며 발밑을 살펴보라. 준비가 되면 초록빛을 따라 나아가라. 저 앞에서 누군가 불꽃을 지키고 있으니, 당신이 잃어버린 것을 알고 있을지도 모른다.",
    "continue": "계속",
    "begin": "시작",
    "skip": "건너뛰기"
  },
  ...
  "housingUi": {
    "claimedBanner": "당신은 이 부지를 보금자리로 인정했습니다.",
    "ownerBanner": "여기는 {name}의 보금자리입니다.",
    "prompt": {
      "claim": "이 부지 인정하기",
      "manage": "보금자리 관리하기",
      "visit": "{name}의 집 방문하기"
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "introLines": {
          ...
          "2": "여기가 바로 공동일세. 한때는 부족 하나가 통째로 있었지, 큰일들도 많았다더군, 뭐 들은 얘기지만. 이제는 대부분 나하고, 저 항아리하고, 저 동굴 밑에서 숨 쉬는 뭔가뿐이야……아무튼. 저 아이도 배고프고, 나도 배고프고, 같은 주파수지. 이리 와 보게, 처리해야 할 신성한 일이 몇 가지 있어."
        },
        "dialogNode": {
          "hearth": "하우디, 친구, 또 항아리 곁으로 왔구먼, 오늘은 그 녀석이 조용해, 진짜 열심히 듣고 있는 건지 아니면 그냥 무시하는 건지, 솔직히 둘 다 존경해, 나도 설정이 그 두 개뿐이거든… 그나저나 할로우는 자네한테 어땠나, 좋았나 나빴나, 간식 좀 있나, 없어? 알았어 그냥 물어본 거야, 친구를 위해 물어보는 거지, 그 친구가 바로 나야…",
          "warmed": "…우와, 그거 진짜 좋은 말이네, 친구, 진짜 좋은 말이야, 예상 못 했는데, 대부분은 기회만 되면 바로 문 쪽으로 튀거든… 자네 꽤 괜찮은 사람이야, 알고 있나, 그린포 기준으로 괜찮은 거라고, 이거 아무한테나 그냥 주는 말 아니거든… 주식이란 게 있었으면 자네 주식을 샀을 텐데, 새 친구는 사고 오래된 징조는 팔고, 그게 그냥 경제라는 거지…",
          "vase": "늘 똑같지, 그 녀석은 연기를 원하고, 보살핌을 원하고, 곁에 앉아서 이 고요를 대화처럼 느끼게 해줄 누군가를 원해… 어. 그거 대부분의 대화가 그렇잖아. 우와. 그래, 아무튼, 나는 맨날 그 녀석한테 말 걸고 있고 그 녀석은 한 번도 대답 안 했지, 어, 한 번도, 근데 뭐 괜찮아, 대충 그런 거야, 그린포 기준으로 괜찮은 거지… 잠깐, 우리 무슨 얘기 하고 있었지… 아. 맞다. 그 녀석 얘기. 걘 괜찮아. 아마 배고플 거야. 동감.",
          "faith": "믿는다는 건 거창한 말이야, 친구, 난 그냥 돌보는 거야, 돌보는 건 이 두 손으로 할 수 있는 일이니까, 라이터 하나 있고, 이력서에 그게 다야… 그 녀석이 듣고 있는지 아닌지는 나도 몰라, 근데 연기는 향기롭고 나를 판단하지도 않으니까, 귀 달린 것들 대부분보다 낫지, 그러니 파장은 어떻게든 맞춰지는 거지. 그렇고말고.",
          "stung": "…아야, 그래 알았어, 아프네 친구, 이런… 그럴 수도 있지, 나도 모르겠어, 진짜 추운 아침이면 나도 그런 생각 든다고, 아무도 이 길을 안 올라오고 항아리는 한숨도 안 쉴 때 말이야… 근데 나는 여전히 여기 있잖아, 그럼 그게 뭔가 의미가 있는 거 아니겠어? 맞지? 맞아. 아 그건 그렇고 간식 줄까, 나 간식 있어, 화제 전환. F.",
          "mended": "괜찮아, 친구, 다 도박이야, 원래부터 그랬어, 내 안의 카우보이가 하는 말인데, 걔한테 도박이 무슨 뜻이냐고 묻지는 마, 걔도 몰라, 그냥 엄청 자신 있게 말할 뿐이야… 이런 곳은 가끔 모진 말 한마디쯤 나올 만하지, 아니라고는 안 할게… 근데 자네는 돌아와서 미안하다고 했잖아, 그건 뭔가 의미가 있는 거야, 아니면 뭔가 원하는 게 있다는 거고, 어느 쪽이든 우리 이제 셈은 끝났어, 자네랑 나 말이야, 파장도 맞고, 나중에 간식 필요하면 내가 살게.",
          "tribe": "옛날엔 큰 부족이었대, 오래된 표식들이 그렇게 말하더라고, 뭐 나는 글은 잘 못 읽지만 숫자는 셀 줄 알거든, 저 밑에 다섯씩 그은 눈금이 엄청 많이 새겨져 있어, 지운 자국들이, 한 사람 손으로 만들 수 있는 것보다 훨씬 많아, 그 계산은 나도 피할 수가 없다고… 오랫동안 그 녀석 불을 밝혀뒀지, 결국 나 혼자 남을 때까지 말이야. 다들 어디로 갔는지는 몰라, 친구, 진짜 몰라, 가끔 파장으로 뭔가 느껴지긴 하는데, 그 느낌이 자기 말을 끝까지 못 맺어, 그래서 나도 못 맺겠어… 근데 이 심지는 내가 지키는 동안엔 못 꺼져. 그건 확실히 알아.",
          "confide": "…그거 참 친절한 말이네, 친구, 진짜 친절해… 있잖아, 내가 자네한테 말하는 건 절반은 항아리가 대답을 안 해서고, 절반은 무섭기 때문이야, 어떤 밤엔, 아무도 다시는 이 길을 안 올라올까 봐, 그럼 나랑 그 녀석이랑 이 고요만 남을까 봐… 그러니까. 올라와 줘서 고마워. 그게 바로 신성한 부분이야, 내가 보기엔 말이지. …아 그건 그렇고. 간식 좀 있나? 항아리 대신 물어보는 거야. 파장도 배고프거든."
        },
        "dialogChoice": {
          "kind": "여기가 점점 마음에 들어요, 그린포. 진짜로, 진짜 진심이에요.",
          "ask": "그래서 요즘 항아리가 뭐라고 하던가요?",
          "blunt": "마스코트 딸린 무덤가일 뿐이잖아요, 그린포. 그게 다예요.",
          "tribe": "그 부족 이야기 좀 들려주세요, 당신 전에 있었다는 그 부족이요.",
          "warm_bye": "그럼 그 녀석 곁으로 돌아가시게 둘게요.",
          "vase_more": "그래서 진짜로 그가 듣고 있다고 믿으세요?",
          "vase_bye": "그럼 그 녀석 곁을 지켜 주세요.",
          "faith_bye": "그럴 만하네요, 그린포.",
          "sorry": "본심보다 심하게 말이 나왔어요. 미안해요, 그린포.",
          "cold_bye": "믿고 싶은 대로 믿으세요.",
          "mended_bye": "우리 셈은 끝났어요. 또 봬요, 그린포.",
          "confide": "그걸 혼자 짊어질 필요는 없어요, 형님.",
          "tribe_bye": "그래도 아직 누군가 돌보고 있잖아요.",
          "confide_bye": "앞으로도 이 길을 계속 올라올게요, 그린포."
        }
      },
      "verger_zebediah": {
        "name": "성당지기 제베디아",
        "title": "뿌리굴의 파수꾼",
        "greeting": "성당지기 제베디아요. 나는 이 외곽을 달력에 맞춰 관리하오, 적어도 그러려고 애는 쓰지. 뿌리굴은 이번 철엔 쉬게 한다고 적어 뒀는데, 멧돼지들은 그 고시를 읽지 않았소. 무른 흙을 조심하고, 장부엔 손대지 마시오.",
        "introLines": {
          "0": "성당지기 제베디아요. 뿌리굴의 파수꾼, 현재로선 그 직책도 나 한 사람이오. 대부분의 날은 여기서 찾을 수 있고, 나머지 날에도 여기서 나를 찾게 되오. 외곽에는 정족수는 필요 없소, 장부만 있으면 되오.",
          "1": "달력을 지킨다는 게 내 일이오. 달력이 날 지키는 건 아니지만, 철에 따라 시도는 해보지. 뿌리굴은 이번 철에 쉰다고 적혀 있소만, 아래 굴들에는 그 통지가 닿지 않았고, 왜가리도 더는 놀란 척을 하질 않소. 이게 현 상황이라오. 불평은 아니오, 불평엔 증인이 필요하니까.",
          "2": "사당 안엔 장부가 있소. 손대지 마시오. 발밑에는 멧돼지가 뒤집어놓은 무른 흙이 퍼져 있소. 둘 다 조심하시오. 만약 이곳 파수 일로 오신 거라면, 두 가지 일을 맡길 수 있소. 어느 쪽도 작진 않고, 그중 하나는 세 번째 고치고 싶지 않은 일이오. 이게 결국 내가 그대에게 말을 붙인 까닭이라오."
        },
        "journalLines": {
          "0": "장부는 왜가리보다 더 오래되었소. 첫 항목을 적은 사람이 나였던 것도 아니요, 마지막 항목을 적을 사람도 내가 아닐 것이오. 그게 이 직을 기다리는 이가 없는 위로라오. 외곽은 한때 통행로였다오. 소금을 안은 이들이 호숫길로 올라와, 이름 붙일 수 없는 무엇을 가지고 내려갔었소. 그것은 내가 물을 일이 아니었기에, 나 또한 묻지 않았소. 장부에는 오고 감과, 그 어느 쪽도 없던 긴 공백이 적혀 있소. 그 공백도 내가 지키고 있소.",
          "1": "왜가리는 장부보다 나이가 많소. 장부는 그것을 탐탁치 않게 여기오. 말로는 하지 않소. 할 필요도 없소. 배나무들을 말라 죽인 한 철을 한쪽 다리로 버티며 눈 하나 깜짝이지 않는 것을 보아 왔으니, 그것이 무엇에 관한 입장이라 받아들이고 있소만, 그게 무엇인지는 들어 본 적이 없소. 사당 아래에 내가 들어가지 않는 방이 있소. 왜가리는 들어가지. 무엇을 하는지 묻지 않고, 왜가리도 내가 위에서 무엇을 하는지 묻지 않소. 이 합의는 우리 둘의 나이보다 더 오래 이어져 왔소.",
          "2": "이만큼 읽으신 분이면 호기심이 있거나 멧돼지를 피하는 중이거나, 둘 다 존중하오. 긴 기록의 짧은 요약을 말씀드리자면, 이 자리는 자기가 무엇이었는지, 그리고 무엇이 되고자 하는지를 기억하고 있고, 그 차이가 바로 일이오. 기억하는 게 내 몫이오. 무엇이 되는가의 주인이 누구인지는 모르겠소. 보류로 적어 두고 잠자리에 듭니다. 장부는 보류를 허용하오. 망각은 허용하지 않소.",
          "3": "호숫가 길을 따라 올라와 화병에 대해 듣게 되는 여행자들은 대개 두 가지 결론 중 하나에 다다르는데, 둘 다 그다지 좋은 말은 아니오. 어떤 이들은 이 신도들을 히피니 괴짜니 부르며 웃고 지나가고, 또 어떤 이들은 더 심한 말을 남기고 웃지도 않고 떠나오. 대부분은 화병에 대해 아예 들어 본 적조차 없는데, 그것이야말로 이 안배가 제대로 작동하고 있다는 뜻이라고 나는 점점 생각하게 되었소. 조용한 것이 유명한 것보다 오래 살아남는 법이오."
        }
      },
      "sexton_faddick": {
        "name": "무덤지기 패딕",
        ...
        "introLines": {
          "0": "패딕이오. 무덤지기 노릇을 할 사당이 아직 있는 한, 무덤지기 노릇을 하지. 그런 사당은 예전보다 적어졌소만. 나는 어디에도 머물지 않소, 그저 지킬 뿐이오. 지키는 일, 그것이 지금도 내가 하고 있는 거의 전부라오.",
          "1": "오래 맴돌다 보면 제가 맴도는 것의 모양을 익히게 되는 법이오. 묵정밭의 늑대들은 내가 오기 훨씬 전부터 밤마다 가축 떼 주위를 맴돌아 왔소만, 떼의 모양은 아직 못 익혔으니, 그게 어떤 의미가 있소. 떼 쪽이 오히려 그들을 더 잘 알고 있으니, 그것이 더 큰 의미라오.",
          "2": "찻물을 내고 싶지만, 주전자는 내가 어제 있던 어딘가에 있소. 호수가엔 집을 짓기를 기다리는 조용한 땅이 있소. 어둠 속에서 늑대가 노는 땅엔 아무것도 뿌리를 내지 못하오. 자, 두 가지 일이 있소, 그중 하나는 혼자 하고 싶지 않은 일이오. 걸으면서 이야기를 나누는 편이 낫겠소."
        },
        "journalLines": {
          "0": "지켜온 곳들의 목록을 머릿속에 두오. 종이보다 땅이 더 오래 남고, 종이는 더 자주 주인을 바꾸니까. 대부분은 사당이오, 이제는 아무도 돌보지 않는 사당들. 묵정밭도 그 목록에 있소. 호수 동쪽의 이름을 모르는 못도 그렇고, 백 년의 바람에 둥글게 깎인 세움돌도 그렇고. 목록은 길지 않소. 그러나 의미가 있는 자리에서는 목록 자체가 곧 전부라오. 머무는 것으로 자리는 지켜지지 않소. 거기에 있었다는 것을 아는 자로 남아 있을 때, 그것이 지키는 일이오.",
          "1": "땅이 우리보다 더 잘 기억하오. 그게 거래의 전부라오. 위를 걷는 이는 두어 세대 안에 자기의 이름도 잊어버리고, 새 이름을 지어 같은 이름이라 부르지. 아래에 머무는 것은 아무것도 잊지 않고 기다리오. 돌 아래의 느린 시간이 있소. 한 번 들어 보았소만, 대답하지 않았소. 대답하는 것이 느린 것에게 문을 알려 주는 길이니까. 대답하지 않음의 열쇠는 내가 지니고 있소. 쇠로 된 열쇠가 아니오. 습관이오, 무거운.",
          "2": "늑대가 문제가 아니오. 늑대는 증상이오. 문제는, 땅을 너무 조용하게 만들어서 늑대들이 자기 땅이라 여긴 그 무엇이오. 그런 것은 보아 왔소, 잘못된 쪽으로 조용해지는 자리를. 처방은 늘 같소: 옳은 소란으로 다시 시끄럽게 만드는 것. 소란이 곧 사람이오. 누군가가 지어야 하는 까닭이 바로 그것이오. 내가 무엇이라고 그 모든 것을 지니고 있겠냐고 물으실 수 있겠소. 아직 걷고 있는 자가 나라오. 그게 자격의 전부라오. 부족하면서도 충분하고, 그 사이의 간격과는 화해해 왔소."
        }
      },
      "shade": {
        "name": "셰이드",
      ...
      "gate_bard": {
        "name": "음유시인 할덴",
        "title": "문앞의 악사",
        "greeting": "노래 한 곡에 동전 한 닢? 싫다고요? 괜찮아요, 대개는 싫다고들 하죠. 나는 이 문을 위해 연주하지만, 문은 단 한 번도 지갑에 손을 댄 적이 없어요. 지나가는 사람들은 여기를 히피 캠프라고, 심지어 더 심하게 부르기도 하지만, 어차피 대부분 그냥 지나가는 사람들이니 그냥 그러라고 둬요."
      },
      "goodwife_orla": {
        "name": "오를라",
        "title": "한때 뿌리굴의 사람",
      ...
      "withered_planting": {
        "name": "시들어가는 묘목",
        "title": "부족의 오래된 버드나무",
        "greeting": "마른 뿌리, 마른 잎. 이게 무엇이 되려 했든 아직 그러지 못했고, 오랫동안 기다려 왔다."
      },
      "buried_root": {
        "name": "묻힌 뿌리",
        "title": "사당 아래",
        "greeting": "말랐어. 여기 아래 있는 모든 것만큼이나 바싹 말랐어."
      }
    },
    "quests": {
      "q_wolves": {
      ...
      "q_root_hollow_boars": {
        ...
        "completion": "다섯. 세고, 날짜를 매기고, 장부에 적었소. 뿌리굴은 이제 제 철에서 겨우 두 주 뒤처졌을 뿐, 이 직분에선 이걸 대승이라 부르오. 지금으로선 나 하나 남은 교단을 대신해, 감사드리오.",
        "objectives": {
          "0": {
            "label": "야생 멧돼지 처치"
          }
      ...
      "q_fallow_acres_wolves": {
        "title": "이랑에서 몰아낸 늑대",
        "text": "누군가 묵정밭에 집을 지으려는 모양이오. 좋은 일이지. 사람이 산 땅은 그렇지 않은 땅보다 기억을 잘하는 법인데, 이 언저리는 너무 많은 걸 잊었소. 허나 늑대가 밤을 부리는 한 무엇도 자리 잡지 못하오. 무리를 다섯 마리까지 솎아주면, 그 걸음값은 반드시 치르리다. 갚는 것, 그게 이제 내게 남은 쓸모의 거의 전부요.",
        "completion": "조용해졌군. 좋소. 나는 한때 사람들로 떠들썩했던 조용한 곳에 숱하게 서 있어 봤소. 이곳은 그 반대의 길을 갈 여지가 있소. 고맙소, 가는 길 조심하시오.",
        "objectives": {
          "0": {
            "label": "숲늑대 처치"
          }
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "마지막 무리",
        "text": "가장자리는 성겨졌지만 굴은 아니오. 여덟만 더 잡으면, 묵정밭은 밤사이 지붕 아래 잠든 이를 잃지 않고도 집을 이고 살 수 있소. 내가 직접 돌보고 싶다만, 나는 한자리에 두 번 있는 일이 드물고, 게다가 사당 아래의 땅이 이 이랑보다 더 지킴을 필요로 하오.",
        "completion": "됐소. 조용한 밤 하나, 그 뒤로 아마 백 개의 밤이 이어지겠지. 잘 지으시오. 그리고 혹여 언젠가 깊이 파 내려가 저 아래에서 무언가 느릿느릿 박자를 맞추는 소리를 듣더라도, 답하지 마시오. 그건 내가 지킬 몫이고, 그 열쇠는 내가 지녔소. 자, 이만 가보시오.",
        "objectives": {
          "0": {
            "label": "숲늑대 처치"
          }
      ...
      "q_the_long_way_around": {
        "title": "멀리 돌아가는 길",
        "text": "부족이 오래된 버드나무 위쪽에 반쯤 심다 만 것이 있는데, 물 한 번 제대로 못 줘서 죽어가고 있어. 나는 이제 그 길을 오를 수가 없지만, 자네는 다리가 있잖나. 이 물통을 가져가게. 나뭇가지들을 조심하고. 정직하게 대하면 버텨줄 거야.",
        "completion": "이제 살아남을 거야. 한 번 오르고 한 번 물을 준 게 뭐 그리 대단하겠냐고 생각할지도 모르지, 세상의 다른 일들에 비하면. 대단한 건 아니야. 하지만 그 물을 받은 그 하나에게는, 그게 전부였어.",
        "objectives": {
          "0": {
            "label": "버드나무 길 위로 물을 날랐다"
          }
        }
      },
      "q_the_watering_can": {
        "title": "그 물뿌리개",
        "text": "지금까지 자네에게 작은 부탁들만 해왔는데, 이유도 묻지 않고 다 들어줬지. 이게 마지막 부탁이야, 작아 보이겠지만 사실 그렇지 않아. 내 물뿌리개를 가지고 사당 아래로 내려가서, 그곳에 묻혀 있는 것에게 물을 주게. 무언가를 요구받는 게 아니라 받는 것을, 그것은 아주 오랫동안 기다려 왔어.",
        "completion": "해냈구나. 물론 그럴 줄 알았지. 그게 바로 그 물이었어, 알겠나. 자네가 호숫가에서 나를 처음 만나고 아무렇지 않게 여겼던 그날부터, 쭉 이어져 온 모든 것 말이야. 같은 물 붓기, 같은 약속을, 한 번 더 지킨 것뿐이야. 고마워. 이제 가서, 이 세상에 다정하게 대해주게. 그것만이 세상을 진정으로 바꿔온 유일한 것이니까.",
        "objectives": {
          "0": {
            "label": "묻힌 뿌리에 물을 주었다"
          }
