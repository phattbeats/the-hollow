...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "glossary": {
      ...
      "augmentDef": "Временное усиление, которое вы выбираете во время матча на арене Fiesta два на два и которое перекраивает ваш набор способностей лишь на этот матч."
    },
    "faqPage": {
