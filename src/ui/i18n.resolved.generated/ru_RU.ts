  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "dialogNode": {
          "hearth": "Ну здоров, друг, снова у сосуда, значит, он сегодня тихий, то ли слушает изо всех сил, то ли просто меня игнорит, с ним никогда не поймёшь, честно... Ну а как тебе Лощина, хорошо, плохо, перекусить с собой есть, нет? Ладно, просто спросил, спрашиваю для друга, а этот друг, это я...",
          "warmed": "...Ого, ладно, это ты приятно сказал, друг, реально приятно, не ожидал, большинство народу сваливает к воротам при первой возможности... А ты ничего так, знаешь, ничего так по меркам Зеленолапа, а это я просто так не раздаю...",
          "vase": "Всё как всегда, он хочет дыма, хочет заботы, хочет, чтобы кто-то сел рядом и притворился, будто тишина, это разговор, ну, мне так вообще нормально, я с ним постоянно болтаю, а он ни разу ничего не ответил, ну, вообще ни разу, но да ладно, так оно и есть, в общем-то, по меркам Зеленолапа нормально...",
          "faith": "Верить, это громкое слово, друг, я просто ухаживаю, ухаживать я умею, две руки есть и зажигалка, вот и всё резюме... Слушает он там или нет, я не знаю, но дым всё равно приятно пахнет, так что с волной как-то разбираемся. Точно так.",
          ...
          "mended": "Всё нормально, друг, реально, такое место иногда заслуживает резкого слова, не буду притворяться, что нет... Но ты вернулся и извинился, а это что-то значит, или значит, что тебе что-то надо, в любом случае мы квиты, ты и я, волна совпадает, в другой раз захочешь перекусить, я угощаю.",
      ...
      "gate_bard": {
        "name": "Бард Халден",
        "title": "Певец у ворот",
        "greeting": "Медяк за песню? Нет? Ничего, чаще всего нет. Я играю для ворот, а ворота ни разу не потянулись за кошельком."
      },
      "goodwife_orla": {
        "name": "Орла",
