...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorial": {
      ...
      "talkBodyTouch": "Подойдите к Брату Зеленолапу и нажмите кнопку «Использовать», чтобы заговорить, затем примите его поручение.",
      "returnBodyTouch": "Вы несете то, что горит. Вернитесь к Брату Зеленолапу и нажмите кнопку «Использовать», чтобы сдать его.",
      "doneBodyTouch": "Основы освоены, {name}. Пустошь в вашем распоряжении, а у Зеленолапа всегда найдется еще одно поручение. Нажмите «Еще», затем «Журнал заданий», чтобы просмотреть свои задания в любой момент."
    },
    "widgets": {
    ...
    "npcJournal": {
      "readLabel": "Расскажите мне о вашем дневнике.",
      "readAria": "Прочитать дневник {name}",
      "pageOf": "Page {index} of {total}",
      "back": "Предыдущая страница",
      "next": "Следующая страница",
      "close": "Закрыть дневник",
      "title": "Дневник {name}"
    },
    "calendar": {
      ...
      "events": {
        "raidCall": {
          "title": "Рейдовый сбор",
          "note": "Стражи трубят в рог: собирайте отряд на рейд."
        },
        "marketDay": {
        ...
        "delveDay": {
          "title": "День вылазки",
          "note": "Хороший день, чтобы бросить вызов Обрушенной реликварии вместе со спутником."
        },
        "moongateCommunion": {
    ...
    "dungeonFinder": {
      ...
      "close": "Закрыть",
      "offlineNote": "Поиск подземелий недоступен в автономном режиме.",
      "roleTank": "Танк",
      "roleHealer": "Лекарь",
      "roleDps": "Урон",
      "queueButton": "В очередь",
      "leaveButton": "Покинуть очередь",
      "idleHint": "Выберите роль для очереди в {dungeon}.",
      "queuedStatus": "В очереди как {role} в {dungeon} (позиция {position})"
    }
  },
  "mailUi": {
    "title": "Воронья почта",
  ...
  "guide": {
    ...
    "home": {
      ...
      "world": {
        ...
        "cta": "Посмотреть мир",
        "hollowReachesName": "Лощинные Плёсы",
        "hollowReachesBlurb": "Тихая земля у ворот святилища, где новички набираются опыта в районе Fallow Acres и Root Hollow.",
    ...
    "hollowPage": {
      "heading": "The Hollow",
      "intro": "За воротами святилища лежит поляна с вазой: место, где пробуждается каждый новый герой и куда он всегда возвращается. Это общая земля, единый узел на весь край, дом для первых лиц, первых заданий и единственный настоящий дом, который вам нужен.",
      "greeting": "ты вернулся, вот это благословение... накопилось пару священных дел, всё на той же волне, что и в прошлый раз. подойди-ка на минутку...",
      "greeter": "Брат Гринпо, у вазы",
      "vaseHeading": "Ваза",
      "vaseBody": "Все начинают у вазы, древнего, внимающего присутствия, вокруг которого построена Лощина. Она просит малого: сжечь уголек-стручок или скормить пещерный кусочек, и, кажется, замечает, когда это получает. Ниже по склону от нее - вход в пещеру, ведущий в Подземное Святилище, а по обе стороны лежат участки, где можно возвести собственный дом.",
      "figuresHeading": "Кто за ней присматривает",
      "figuresBody": "Двое поддерживают жизнь вазы, и вы встретите обоих в первые же минуты.",
      "npcFmt": "{name}, {title}",
      "greenpawBody": "Единственный хранитель вазы и тот, кто раздает ее самые ранние поручения. Самозваный титул он и сам первым признает, и все же он ближе всего к проводнику, какой есть в Лощине.",
      "yarrowBody": "Хранительница второго призвания: любой класс может выучить у нее профессию, она стоит напротив Гринпо, через вазу.",
      "questsHeading": "Ваши первые поручения",
      "questsBody": "Собственная цепочка заданий Гринпо - это самое первое, что вы делаете: четыре коротких поручения, которые учат ритму вазы, прежде чем отправить вас дальше, в более широкую Лощину.",
      "questBurnsBody": "Пещерный клубень, который ваза сжигает ради света, собирается по горстке за раз.",
      "questFillsBody": "Пещерный кусочек, утоляющий более тихий голод, собирается так же.",
      "questWavelengthBody": "Знакомство со вторым призванием вазы и с тем, как кормить ее самому.",
      "questKeepLitBody": "Превращение разовой услуги в постоянную привычку, трижды подряд.",
      "housingHeading": "Собственный дом",
      "housingBody": "{n} усадебных участков окружают вазу, ожидая, когда их займут и обустроят как ваш личный уголок Лощины.",
      "shrineHeading": "Подземное Святилище",
      "shrineBody": "Вход в пещеру рядом с вазой ведет в Подземное Святилище, собственное инстансовое подземелье Лощины и первое настоящее испытание группой для каждого нового героя.",
      "outsiderHeading": "Как на это смотрит остальной мир",
      "outsiderBody": "За воротами святилища почти никто и не слышал о вазе. Те немногие, кто слышал, обычно списывают ее хранителей на хиппи, чудаков, а то и вовсе на странных людей, разговаривающих с кувшином. Остальное, что доходит до посторонних, приходит из еще более странных слухов: то последователь забредет слишком далеко от поляны, то одно из маленьких зеленых существ объявится там, где ему быть совсем не полагалось."
    },
    "worldPage": {
      "heading": "Мир",
      "intro": "Выйдя через ворота святилища из вазы, вы окажетесь в Лощинных Пределах, тихой земле под открытым небом, где каждый новый пришелец делает свои первые шаги. Еще три зоны лежат к северу, выстроенные с юга на север; дорога к ним пока не открыта, но они реальны и ждут своего часа.",
      "hub": "Опорная база",
      ...
      "hollowReachesBlurb": "Спокойная земля сразу за воротами святилища, где новички набираются опыта на волках и кабанах в районе Fallow Acres и Root Hollow.",
      ...
      "hollowReachesGreeting": "Я веду календарь для этих Плёсов, или хотя бы пытаюсь. Берегитесь рыхлой земли и не трогайте реестр.",
      "hollowReachesGreeter": "Ризничий Зебедия, Root Hollow",
      ...
      "hollowReachesPlaceNotes": "Hollow Gate — портал святилища, вновь открывшийся в открытые земли. К западу, в Fallow Acres, пономарь Faddick отгоняет волков от земли, отведённой под застройку; к востоку, в Root Hollow, ризничий Зебедия по календарю следит за участком, кишащим кабанами. Mossbank у озера — тихое место для рыбалки.",
    ...
    "questsPage": {
      ...
      "sagaGateNote": "Эта сага - реальный, завершенный контент, тот же путь, что открывается, когда снова открывается дорога на север. Это не то, откуда новый герой начинает сегодня; начало - у вазы, в Лощине.",
      ...
      "sagaReachesTitle": "Ричес: лампада и календарь",
      "sagaReachesBody": "В Холлоу-Ричес Брат Гринпоу поддерживает живую лампаду у святилищного сосуда, а вергер и секстон правят посев по луне. Первая нить здесь невелика: не дать лампаде погаснуть, вычистить волков, узнать эту землю. Когда дорога наконец откроется, вы уже будете знать, в чьих руках лампада.",
    ...
    "lore": {
      ...
      "zebediahRole": "Вергер Рут-Холлоу",
      "zebediahBody": "Терпеливый вергер, что держит Ричес по своему календарю, его руки всегда наполовину в земле. Он следит за лампадой у сосуда, правит посев по луне и оказывается первым голосом, которым дорога заговаривает с новоприбывшим.",
      "faddickRole": "Секстон Фаллоу-Эйкерс",
      "faddickBody": "Тихий секстон с длинным инструментом в руках, которому лопата ближе меча. Он вычищает то, что подбирается из леса, предаёт мёртвых земле и помнит каждый надел на своей земле. Когда след уходит от святилища, чаще всего дорогу указывает он."
    },
    "dungeonsPage": {
  ...
  "coldOpen": {
    "title": "Пустошь",
    "wakeBody": "Ты приходишь в себя на тёплой земле, не помня ни своего имени, ни своего народа, ни того, как здесь оказался. Впереди из огромного сосуда струится зелёный свет, и что-то в нём словно всё это время ждало тебя.",
    "orientBody": "В святилище тихо, и запах дыма всё ещё держится в воздухе. Не спеши, найди опору под ногами. Когда будешь готов, иди на зелёный свет: впереди кто-то хранит пламя и, быть может, знает, что ты потерял.",
    "continue": "Далее",
    "begin": "Начать",
    "skip": "Пропустить"
  },
  "editor": {
    ...
    "topbar": {
      ...
      "open": "Open",
      "openTitle": "Открыть сохранённую карту (браузер или сервер)",
      "save": "Save",
      "saveTitle": "Сохранить в этом браузере, а при входе в систему - также на сервере (Ctrl+S)",
      "saveAs": "Save As",
      "saveAsTitle": "Сохранить копию под новым именем",
      "fork": "Fork",
      "forkTitle": "Создать собственную серверную копию этой карты",
      "forkDisabledTitle": "Сначала откройте серверную карту, чтобы создать её копию",
      "import": "Импорт",
      "importTitle": "Импортировать карту из файла JSON",
      "export": "Экспорт",
      "exportTitle": "Скачать эту карту как файл JSON",
      "uploadAsset": "Загрузить ассет",
      "uploadAssetTitle": "Загрузите модель GLB (до 8 МиБ), чтобы разместить её на своих картах",
      "uploadAssetDisabledTitle": "Войдите в игру, чтобы загружать ассеты",
      "playtest": "Плейтест",
      ...
      "view2d": "2D",
      "view2dTitle": "Редактировать на условной карте сверху",
      "undoCount": "Undo: {count}",
      "undoCountTitle": "Доступно отмен: {count} (Ctrl+Z - отменить, Ctrl+Y - повторить)",
      "autosave": "Автосохранение",
      "autosaveTitle": "Автоматически сохранять карту при наличии несохранённых изменений. Отключается само при ошибке сохранения.",
      "undo": "Undo",
      "undoTitle": "Отменить последнее изменение (Ctrl+Z)",
      "redo": "Redo",
      "redoTitle": "Повторить последнее отменённое изменение (Ctrl+Y)",
      "offline": "Офлайн",
      "offlineTitle": "Вы не вошли в систему: карты сохраняются только в этом браузере. Войдите в игру, чтобы сохранять онлайн.",
      "signIn": "Sign in",
      "signInTitle": "Открыть экран входа в игру в новой вкладке",
      "help": "Help",
      "helpTitle": "Руководство по редактору: инструменты, горячие клавиши и обучение"
    },
    "tool": {
      ...
      "smooth": "Сгладить",
      "flatten": "Выровнять",
      "paint": "Покрасить биом",
      "water": "Вода",
      "place": "Разместить ассет",
      "blocker": "Стена-блокиратор",
      "camp": "Camp",
  ...
  "sim": {
    ...
    "dungeonFinder": {
      ...
      "dungeonUnavailable": "Это подземелье пока недоступно через Поиск подземелий.",
      "roleUnavailable": "Ваш класс не может встать в очередь на эту роль.",
      "leaveParty": "Покиньте группу, прежде чем вставать в очередь Поиска подземелий.",
      "cannotQueueDueling": "Нельзя встать в очередь Поиска подземелий во время дуэли.",
      "finishTrade": "Завершите обмен, прежде чем вставать в очередь Поиска подземелий.",
      "cannotQueueInstance": "Нельзя встать в очередь Поиска подземелий, находясь в подземелье.",
      "joined": "Вы встали в очередь Поиска подземелий как {role}. Ожидайте группу...",
      "left": "Вы покинули очередь Поиска подземелий.",
      "ready": "Ваша группа Поиска подземелий готова: {dungeon}!",
      "removed": "Вы были удалены из очереди Поиска подземелий."
    },
    "lockpick": {
    ...
    "hearth": {
      ...
      "noItems2": "На тебе одни добрые намерения, а? …добрыми намерениями печь не растопишь.",
      "emberbulb1": "вот это дровишки… гляди, как она задышала, дружище…",
      "emberbulb2": "печь берёт своё медленно и чисто, ей так по нраву…",
      "emberbulb3": "растопили, задымило… уже чую, как открывается волна.",
      "morsel1": "…ох, благослови тебя, дружище. Благослови и землю, по которой ты ходишь.",
      "morsel2": "живот перестал петь гимны хоть на минутку. премного благодарен…",
      "morsel3": "хороший кусок — что хороший друг… редкость, и стоит того, чтобы за ним идти.",
      "helpLine": "Зеленолап: /feed (принеси то, что горит, или то, чем сыт бываешь, от вазы)."
    },
    "house": {
      "mustStandToClaim": "Чтобы заявить права на участок, нужно стоять на нём в Пустоши.",
      "alreadyOwn": "У вас уже есть свой дом в Пустоши.",
      "noFreePlot": "Здесь нет свободного участка. Встаньте на него, чтобы заявить права.",
      "plotTaken": "У этого участка уже есть хозяин.",
      "claimed": "Этот дом теперь ваш. Украсьте его командой /house place <слот> <вид>.",
      "noHomestead": "У вас нет дома. Получите его командой /house claim.",
      "mustBeInHollow": "Чтобы заниматься своим домом, нужно находиться в Пустоши.",
      "slotRange": "Слоты пронумерованы от 1 до {count}.",
      "unknownKind": "Неизвестный вид украшения. Виды: {kinds}.",
      "placed": "В слот {slot} помещено: {kind}.",
      "slotEmpty": "Этот слот уже пуст.",
      "cleared": "Слот {slot} очищен.",
      "readoutNone": "У вас нет дома. Встаньте на свободный участок в Пустоши и введите /house claim.",
  ...
  "errors": {
    ...
    "api": {
      ...
      "realmFull": "Этот сервер сейчас заполнен. Пожалуйста, попробуйте снова через несколько минут.",
  ...
  "hud": {
    ...
    "tutorial": {
      ...
      "doneBody": "Основы освоены, {name}. Пустошь в вашем распоряжении, а у Зеленолапа всегда найдется еще одно поручение. Нажмите {questKey} в любой момент, чтобы просмотреть задания.",
      ...
      "seekBody": "Брат Зеленолап ждет у подножия вазы, отрезанный от всего и голодный. Следуйте за меткой, чтобы добраться до него.",
      "talkTitle": "Выслушайте Поручение",
      "talkBody": "Подойдите к Брату Зеленолапу и нажмите {interactKey}, чтобы заговорить, затем примите его поручение.",
      "gatherTitle": "То, Что Горит",
      "gatherBody": "Тлеющие луковицы растут там, куда не достает свет. Спуститесь в Подсвятилище и заберите их у бледнопитающихся. Они идут на ваш фонарь, а не на вас.",
      "gatherProgress": "Собрано тлеющих луковиц: {current} / {needed}",
      "returnTitle": "Накормите Печь",
      "returnBody": "Вы несете то, что горит. Вернитесь к Брату Зеленолапу и нажмите {interactKey}, чтобы сдать его."
    },
    "markers": {
      "names": {
        "star": "Звезда",
  ...
  "entities": {
    "abilities": {
      ...
      "ironhold": {
        ...
        "description": "Вы укрываетесь за щитом, снижая весь получаемый урон на 40% в течение 8 сек."
      },
      "fireball": {
        "name": "Огненный шар",
      ...
      "sacred_bulwark": {
        "name": "Священный бастион",
        "description": "В течение 10 сек. следующий смертельный удар по вам будет отменен, а здоровье восстановлено до 35%."
      },
      "tame_beast": {
      ...
      "primal_reflexes": {
        ...
        "description": "Ваши инстинкты обостряются, повышая шанс уклонения на 50% в течение 6 сек."
      },
      "mortal_strike": {
    ...
    "items": {
      ...
      "root_token_unbinding": {
        "name": "Развязанный корневой узел",
        "flavorText": "...отполирован с одной стороны большим пальцем, снова и снова, будто развязывая узел, привязанный неизвестно к чему. кто-то верил, что отпустить - это милосердие. этот кто-то ошибался, или поторопился, или и то и другое..."
      },
      "root_token_offering": {
        "name": "Маленький камень кормления",
        "flavorText": "...в камне выцарапана мелкая чаша, не больше монеты, оставить крошку тому, что не может попросить. то, что здесь ело, не перестало голодать. оно просто перестало быть видимым..."
      },
      "root_token_verdict": {
        "name": "Камень с зарубками приговора",
        "flavorText": "...зарубки нанесены по три, а не по пять, приговор выносился и пересматривался снова, вдавлен так глубоко, что на третий раз камень треснул. будто кто-то во тьме снова и снова менял решение об одном и том же вопросе..."
      },
    ...
    "npcs": {
      ...
      "the_ravenpost": {
        "name": "Воронья почта",
        "title": "Хранитель почты",
        "greeting": "Отправьте письмо, {className}, и мои вороны отыщут вашего друга, где бы он ни странствовал, а вложенные монеты и посылки будут в целости, пока их не заберут."
      },
      "marshal_redbrook": {
        "name": "Маршал Редбрук",
      ...
      "brother_greenpaw": {
        ...
        "greeting": "вернулся, это благословение... ваза с утра всё вздыхает, есть парочка святых дел на очереди, та же волна, что и в прошлый раз. подь сюда, переведём дух...",
        "introLines": {
          "0": "э-э... привет. привет. не слыхал, как ты подошёл, я был где-то не здесь, где-то в зелени... у тебя вид только-только проснувшегося, друг. знаю его хорошо, сам ношу почти каждый день...",
          "1": "звать зеленолап. брат зеленолап, первый пророк, самозваный, ваза тебе скажет, что это ровным счётом ничего не значит, и он прав, да только кому-то надо о нём заботиться...",
          "2": "а это вот и есть пустошь. когда-то тут было целое племя, большие дела творились, так мне сказывали, а теперь по большей части только я, ваза да то, что дышит там внизу, в пещере... ну да ладно. он голодный, я голодный, на одной волне. подь сюда, есть парочка святых дел, требующих заботы."
        },
        "dialogNode": {
          "hearth": "Хауди, друг, снова у сосуда, значит, он сегодня тихий, то ли слушает изо всех сил, то ли просто меня игнорит, и честно, я уважаю оба варианта, у меня самого только эти два режима... Ну а как тебе Лощина, хорошо, плохо, перекусить с собой есть, нет? Ладно, просто спросил, спрашиваю для друга, а этот друг, это я...",
          "warmed": "...Ого, ладно, это ты приятно сказал, друг, реально приятно, не ожидал, большинство народу сваливает к воротам при первой возможности... А ты ничего так, знаешь, ничего так по меркам Зеленолапа, а это я просто так не раздаю... Будь у меня акции, купил бы твоих, покупай новых друзей, продавай старые знамения, это ж просто экономика...",
          ...
          "faith": "Верить, это громкое слово, друг, я просто ухаживаю, ухаживать я умею, две руки есть и зажигалка, вот и всё резюме... Слушает он там или нет, я не знаю, но дым приятно пахнет и меня не осуждает, а это больше, чем можно сказать про большинство ушастых, так что с волной как-то разбираемся. Точно так.",
          "stung": "...Ай, ну ладно, больно, друг, блин... В смысле, может быть, я не знаю, у меня самого такие мысли бывают холодными утрами, когда никто не поднимается по тропе и сосуд даже не вздыхает... Но я всё ещё здесь, так что это чего-то да стоит, верно? Верно. Точно. Кстати, перекусить хочешь, у меня есть, меняю тему. Всё.",
          "mended": "Всё нормально, друг, всё это гамбит, всегда им было, это во мне ковбой говорит, только не спрашивай его, что такое гамбит, он тоже не знает, просто говорит очень уверенно... Такое место иногда заслуживает резкого слова, не буду притворяться, что нет... Но ты вернулся и извинился, а это что-то значит, или значит, что тебе что-то надо, в любом случае мы квиты, ты и я, волна совпадает, в другой раз захочешь перекусить, я угощаю.",
          "tribe": "Большое было племя, давно, так старые зарубки говорят, читаю я не очень, зато считать умею, а там внизу целая куча пятёрок нацарапана, перечёркнутых, больше, чем одна рука могла бы наделать, с этой математикой не поспоришь... Долго держали его огонь, пока не остался я один. Куда все делись, не знаю, друг, реально не знаю, иногда что-то чувствую на этой волне, но чувство само своё предложение не заканчивает, вот и я тоже не заканчиваю... Но фитиль не погаснет, пока я на страже. Это я знаю точно.",
          "confide": "...Это ты по-доброму сказал, друг, реально по-доброму... Слушай, я говорю с тобой наполовину потому, что сосуд не отвечает, а наполовину потому, что боюсь, некоторыми ночами, что никто больше не поднимется по этой тропе, и останемся только я, он и тишина... Так что. Спасибо, что поднялся. Вот это, по-моему, и есть святое. ...Кстати. Перекусить есть с собой? Спрашиваю за сосуд. Волна тоже проголодалась."
        },
        "dialogChoice": {
          "kind": "Это место начинает мне нравиться, Зеленолап. Серьёзно, реально серьёзно.",
          "ask": "Ну а что там сосуд говорил в последнее время?",
          "blunt": "Это погост с талисманом, Зеленолап. Вот и всё.",
          "tribe": "Расскажи мне про то племя, которое было до тебя.",
          "warm_bye": "Ладно, возвращайся к нему.",
          "vase_more": "И ты реально думаешь, что он слушает?",
          "vase_bye": "Ну тогда побудь с ним.",
          "faith_bye": "Что ж, справедливо, Зеленолап.",
          "sorry": "Вышло злее, чем я хотел. Прости, Зеленолап.",
          "cold_bye": "Верь во что хочешь.",
          "mended_bye": "Мы квиты. Ещё увидимся, Зеленолап.",
          "confide": "Тебе не обязательно нести это в одиночку, брат.",
          "tribe_bye": "Ну, кто-то же всё ещё ухаживает за ним.",
          "confide_bye": "Я буду и дальше подниматься по этой тропе, Зеленолап."
        }
      },
      "verger_zebediah": {
        "name": "Пономарь Зеведей",
        "title": "Страж Корневой Лощины",
        "greeting": "Пономарь Зеведей. Я держу Окраины по календарю, вернее, стараюсь держать. Корневая Лощина была помечена как отдыхающая в этот сезон, да только кабаны объявления не читали. Гляди под ноги, где рыхлая земля, и не трогай журнал.",
        "introLines": {
          "0": "Пономарь Зеведей. Страж Корневой Лощины, по назначению должности, которая в настоящее время тоже я. В большинство дней вы найдёте меня здесь; в остальные дни я нахожу себя здесь же. Окраинам не требуется кворум, требуется лишь запись.",
          "1": "Я веду календарь. Календарь меня не ведёт, хотя в иные сезоны пытается. Корневая Лощина помечена как отдыхающая в этот оборот, нижние же норы того объявления не получили, и цапля уже перестала притворяться удивлённой. Таково положение дел. Это не жалоба: для жалобы нужны свидетели.",
          "2": "В святилище есть журнал. Не трогайте его. Под ногами рыхлая земля, там, где прошли кабаны. О том и о другом помните. Если вы пришли по поводу стражи, я могу предложить два поручения, оба не малых, и одно из них я предпочту не править в третий раз. Вот, собственно, почему я с вами и заговорил."
        },
        "journalLines": {
          "0": "Журнал старше цапли. Первую запись внёс не я, и последнюю внесу не я; в этом утешение должности, которую никто не ждёт, чтобы её унаследовать. Окраины когда-то были проезжей дорогой. Люди поднимались по озёрной тропе с солью и спускались, унося нечто, чему я не давал имени, потому что не мне было спрашивать; как не давали имени и они. Журнал записывает приходы и уходы и один долгий пропуск, когда не было ни тех, ни других. Пропуск я тоже храню.",
          ...
          "2": "Если вы читаете так далеко, то вы либо любопытны, либо спасаетесь от кабанов, и то и другое я уважаю. Короткая версия долгой записи такова: это место помнит, чем оно было, и помнит, чем собирается стать, и разница между тем и другим и есть работа. Помнить, моё дело. Чьё дело, стать, я не знаю. Записываю как «в ожидании» и иду спать. Журнал допускает ожидание. Забвение журнал не допускает.",
          "3": "Путники, что поднимаются по озёрной тропе и слышат про вазу, обычно приходят к одному из двух выводов, и ни один не льстив. Одни называют паству хиппи или чудаками и уходят посмеиваясь. Другие называют её похуже и даже не задерживаются посмеяться. Большинство же вовсе никогда не слышит про вазу, и я всё больше склоняюсь к мысли, что именно так этот порядок вещей и должен работать. Тихое живёт дольше знаменитого."
        }
      },
      "sexton_faddick": {
        "name": "Могильщик Фаддик",
        "title": "Странствующий Хранитель",
        "greeting": "Фаддик. Могильщик, покуда есть святилище, при котором быть могильщиком. Я нигде не задерживаюсь, я лишь храню. Волки каждую ночь кружат вокруг стада на Перелогах, а тот, кто кружит достаточно долго, узнаёт очертания того, вокруг чего кружит. Пусть уж остаётся просто стадом.",
        "introLines": {
          "0": "Фаддик. Могильщик, покуда есть святилище, при котором можно быть могильщиком, а таких святилищ теперь меньше, чем прежде. Я нигде не задерживаюсь, я лишь храню. Хранение и есть почти всё, для чего я теперь ещё нужен.",
          "1": "Тот, кто кружит достаточно долго, узнаёт очертания того, вокруг чего кружит. Волки на Перелогах кружили вокруг стада каждую ночь задолго до того, как я проходил здесь, и очертаний стада они ещё не усвоили, что, впрочем, о чём-то да говорит. Стадо же их усвоило, и это говорит о большем.",
          "2": "Я бы предложил вам чаю, да чайник остался где-то там, где я был вчера. У озера есть тихий клочок земли, что ждёт, когда на нём поставят дом; на земле, где волки работают в темноте, ничего не укореняется. Так вот, два поручения, и одно из них я предпочёл бы не делать в одиночку. Пойдёмте, поговорим на ходу."
        },
        "journalLines": {
          "0": "Список мест, которые я хранил, держу в голове: бумага меняет хозяев быстрее, чем земля. В списке, по большей части, святилища, те, где уже некому служить. Перелоги в этом списке. Пруд к востоку от озера, чьего имени я так и не узнал, тоже. И стоячий камень, который ветер сто лет подряд округляет. Список недолог. В том, что по-настоящему важно, он и есть всё. Место хранишь не тем, что остаёшься, а тем, что остаёшься тем, кто помнит, что оно там было.",
          "1": "Земля помнит лучше нас. В этом и состоит весь торг. Ходящие по верху забывают собственное имя за два поколения, выдумывают новое и зовут его тем же самым; то, что сидит внизу, ничего не забывает и ждёт. Под камнями есть медленное время. Я слышал его однажды, и не ответил: ответ, это способ, которым медленная вещь находит дверь. Ключ от неответа я ношу при себе. Не металлический. Привычка, а она тяжелее.",
      ...
      "shade": {
        "name": "Шейд",
        "title": "Странница",
        "greeting": "О, это ты. Садись, если хочешь, вода никуда не денется. Ты сегодня ела? Тебе надо поесть.",
        "introLines": {
          "0": "Застал меня за хлопотами. Не обращай внимания на лейку, это всего лишь вода. Всегда найдётся что-нибудь, чему не помешает немного воды.",
          "1": "Я? Да не о чем говорить. Шейд. Хожу, помогаю там, где не хватает рук. Ты выглядишь вконец измотанным. Присядь на минутку, если хочешь."
        }
      },
      "gate_bard": {
        "name": "Бард Халден",
        "title": "Певец у ворот",
        "greeting": "Медяк за песню? Нет? Ничего, чаще всего нет. Я играю для ворот, а ворота ни разу не потянулись за кошельком. Проезжие называют это место лагерем хиппи, а то и похуже, но они обычно просто проезжают мимо, так что пусть говорят."
      },
      "goodwife_orla": {
        "name": "Орла",
        "title": "Некогда из Корневой Лощины",
    ...
    "quests": {
      ...
      "q_what_burns": {
        ...
        "completion": "вот ЭТО я понимаю, добрый дымок... чуешь? комната прям гуще становится. он вот-вот наклонится ближе, чую это на волне... точно вам говорю.",
        "objectives": {
          "0": {
      ...
      "q_the_wavelength": {
        ...
        "text": "Черенок теперь твой, дружок, так что поговорим о том, что дальше... два дела, и ни одно не испытание, скорее знакомство. во-первых, перейди через вазу и повидайся со старейшиной Ярроу, она учит второму призванию, совсем другому способу играть во всё это, и каждая душа, что проходит здесь, должна знать: та дверь открыта... во-вторых, вернись и покорми меня чем-нибудь, неважно чем, тлеющей луковицей или пещерной закуской, я вечно на нуле, а ваза вечно жаждет дыма. вот это никогда по-настоящему не кончается, по-зеленолаповски говоря.",
        "completion": "вот оно... почувствовал, как комната на миг сгустилась? это он, заметил. вот и весь фокус, дружок - ты кормишь меня, я курю, а он чуть ближе склоняется, чтобы послушать. ничего сложного. и никогда не перестанет быть правдой. заходи в любое время, если при тебе лишние луковицы или закуски, у очага календаря нет... и вот ещё что. добро пожаловать в приют. только сейчас понял, что не сказал этого раньше.",
        "objectives": {
          "0": {
            "label": "Повидал старейшину Ярроу"
          },
          "1": {
            "label": "Покормил у очага"
          }
        },
        "dialog": {
          "complain": "Опять поручение? Я только что вылез из той дыры.",
          "complainReply": "нет-нет, дослушай, это не пещерная работа... это дело лёгкое, просто прогуляться да разок хорошенько покормить. самое лёгкое, о чём я тебя просил, обещаю, вот те крест, по волне и всё такое.",
          "refuse": "Я сам найду себе обучение, спасибо.",
          "refuseReply": "...ну и ладно. не заставишь душу учиться, пока она не готова. дверь открыта, когда \"ещё не готов\" пройдёт... на вот, возьми всё равно, хоть за то, что вообще пришёл."
        }
      },
      "q_keep_him_lit": {
        "title": "Keep Him Lit",
        "text": "Три раза, дружище, вот и всё число... ничего священного, просто ровно столько, чтобы одолжение превратилось в привычку, а привычки - единственная религия, в которую я и правда верю... возвращайся и покорми очаг три раза, отдельно каждый раз, порядок неважен, неважно чем - тлеющей луковицей или кусочком из пещеры, и я поверю, что ты правда здесь, чтобы остаться, а не просто проходишь мимо по пути к чему-то большему...",
        "completion": "Три из трёх... ты уже не просто гость, дружище, ты поддерживаешь что-то живое, и, по-моему, в этом весь смысл, хоть меня никто и не спрашивал... вот. держи это при себе, толку от него никакого, оно просто помнит, как и все мы тут...",
        "objectives": {
          "0": {
            "label": "Очаг покормлен трижды"
          }
        },
        "dialog": {
          "complain": "Я уже покормил тебя один раз. Разве этого мало?",
          "complainReply": "Один раз - это одолжение, дружище, три раза - привычка, а меня одолжения уже обжигали... дело не в том, что очагу это нужно, с очагом всё в порядке, я о нём забочусь, дело в том, возвращаешься ли ты сюда сам, по своей воле, а не потому что метка задания велела... три раза. Не торопись со счётом.",
          "refuse": "Я не буду делать это три раза по отдельности. Одного раза достаточно.",
      ...
      "q_root_hollow_boars": {
        ...
        "completion": "Пять. Сочтены, датированы и внесены в журнал. Корневая Лощина теперь отстаёт от собственного сезона всего на две недели, что в этой должности мы зовём триумфом. Благодарю тебя от имени ордена, который на сей момент есть я.",
        "objectives": {
          "0": {
      ...
      "q_fallow_acres_wolves": {
        "title": "Волки прочь с борозд",
        "text": "Кто-то надумал строиться на Перелогах. Хорошо. Земля, где живут люди, помнит лучше пустой, а этот край забыл слишком многое. Но пока волки работают в темноте, ничто не приживётся. Прореди стаю до пяти, и я позабочусь, чтобы дорога окупилась. Возвращать долги, вот почти всё, на что я ещё гожусь.",
        "completion": "Потише стало. Хорошо. Я стоял во множестве тихих мест, что некогда были полны голосов целого народа; у этого есть шанс пойти обратным путём. Благодарю, и береги себя в пути.",
        "objectives": {
          "0": {
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "Последняя стая",
        "text": "По краям поредело, а логово нет. Ещё восемь, и Перелоги смогут держать крышу, не теряя ночами тех, кто спит под ней. Я бы приглядел сам, да только дважды в одном месте бываю редко, а земля под святилищем просит присмотра больше, чем эти борозды.",
        "completion": "Вот так. Одна тихая ночь, а за ней, быть может, сотня. Строй хорошо. И если однажды копнёшь так глубоко, что услышишь, как там внизу что-то медленно отбивает время, не отвечай ему. Это моё дело хранить; ключ от него ношу я. Ступай теперь.",
        "objectives": {
          "0": {
            "label": "Лесной волк убит"
          }
      ...
      "q_have_you_eaten": {
        "title": "Ты ела?",
        "text": "У ворот есть бард, что играет за медяки и ест, когда медяки находятся, а находятся они нечасто. У меня есть тёплая миска и ещё одна про запас. Отнеси её ему, ладно? И не говори, что это из жалости. Скажи, что это лишнее.",
        "completion": "Ты вернулся. Он поел? Хорошо. Это хорошо. А ты? ... Нет, я же вижу. Тогда садись. Не нужно быть великим, чтобы быть чем-то хорошим. Величие не есть доброта. Ешь.",
        "objectives": {
          "0": {
            "label": "Тёплая еда отнесена барду"
          }
        }
      },
      "q_someone_your_own_size": {
        "title": "Кого-нибудь себе под стать",
        "text": "Возле Корневой Лощины есть женщина, с которой мир обошёлся жестоко. Её имя вычеркнули из журнала, а с вычеркнутым именем обходятся так, будто оно не слышит. Пойди и посиди с ней немного. Ничего не нужно исправлять. Просто будь кем-то ей под стать.",
        "completion": "Ты остался. Она не скажет, что это было важно, но это было важно, уверяю тебя. Вот, это тебе. Прутик с ивы, которую я люблю. Он не делает ничего. Он лишь помнит, что ты был добр, когда ничто тебя к этому не принуждало.",
        "objectives": {
          "0": {
            "label": "Немного посидел с Орлой"
          }
        }
      },
    ...
    "zones": {
      "the_hollow_reaches": {
        "name": "Окраины Пустоши",
        "welcome": "Врата ведут на открытую местность. Перелоги, к западу от дороги, выглядят пригодными для застройки.",
        "pois": {
          "0": {
            "label": "Врата Пустоши"
          },
    ...
    "dungeons": {
      ...
      "under_shrine": {
        "name": "Подсвятилище",
        "enterText": "Ты спускаешься под святилище, в прохладную, неподвижную тьму.",
        "leaveText": "Ты поднимаешься обратно в тёплый воздух наверху."
      }
    },
    "delves": {
      "collapsed_reliquary": {
    ...
    "readables": {
      "torn_ledger_page": {
        "title": "Порванный гроссбух",
        "pages": {
          "0": "Корневая Лощина, помечена на отдых. Перелоги, помечены на отдых. Озеро у Мшистого Берега, что отдыхает, впишем мы его или нет. Подписано и датировано, как того требует журнал.",
          "1": "Подсчёт за сезон на нынешний день: три ростка пробились сквозь дорожные камни, чего нет ни в одном моём календаре. Я перестал их вычёркивать. Они возвращаются быстрее, чем сохнут чернила, а чернила были недёшевы.",
          "2": "Записка тому, кто примет это после меня. Считай кабанов, считай волков, считай дни. Зелень не считай. Она считает в ответ и не останавливается там, где остановишься ты."
        }
      },
      "keepers_marginalia": {
        "title": "Заметки хранителя на полях",
        "pages": {
          "0": "Оставлено на полях сборника гимнов, в котором сами гимны стёрлись. Рука быстрая, так бывает быстра рука, когда пишет на ходу.",
          "1": "Волки кружат Перелоги от кромки леса, всегда одним и тем же кольцом, всегда посолонь. Тот, кто кружит достаточно долго, узнаёт очертания того, вокруг чего кружит. Так и я. И земля, думается мне, тоже.",
          "2": "Если ты это читаешь, значит, ты перестал идти, а это единственное, чему я так и не научился. Передохни. Окраины никуда не денутся. В том-то и вся с ними морока."
        }
      }
    }
  },
