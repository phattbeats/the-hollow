  ...
  "entities": {
    ...
    "npcs": {
      ...
      "old_badger_thistlewick": {
        "name": "Старый барсук Тислвик",
        "title": "Фермер с Перелогов",
        "greeting": "Земля тут хорошая, были бы только изгороди целы. Волки каждую ночь кружат вокруг стада, ничего не построишь."
      }
    },
    "quests": {
      "q_wolves": {
