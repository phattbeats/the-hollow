    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "introLines": {
          ...
          "1": "звать зеленолап. брат зеленолап, первый пророк, самозваный, ваза тебе скажет, что это ровным счётом ничего не значит, и она права, да только кому-то надо о ней заботиться...",
          "2": "а это вот и есть пустошь. когда-то тут было целое племя, большие дела творились, так мне сказывали, а теперь по большей части только я, ваза да то, что дышит там внизу, в пещере... ну да ладно. она голодная, я голодный, на одной волне. подь сюда, есть парочка святых дел, требующих заботы."
        }
      },
      "verger_zebediah": {
