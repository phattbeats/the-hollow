  ...
  "entities": {
    ...
    "npcs": {
      ...
      "verger_zebediah": {
        ...
        "greeting": "В этот сезон в Корневой Лощине развелось кабанов, роют корни в поисках личинок. Гляди под ноги, если не собираешься с ними драться."
      },
      "sexton_faddick": {
        "name": "Могильщик Фаддик",
        "title": "Странствующий Хранитель",
        "greeting": "Земля тут хорошая, только я больше прохожу мимо, чем задерживаюсь. Волки каждую ночь кружат вокруг стада, ничего не построишь."
      }
    },
    "quests": {
      "q_wolves": {
      ...
      "q_root_hollow_boars": {
        ...
        "text": "Кабаны перерыли половину Корневой Лощины в поисках личинок и уже почти не боятся людей. Убей пятерых, и корни, может, отдохнут сезон.",
        "completion": "На пять рыл меньше в грязи. Корневая Лощина благодарна, хоть и не умеет сказать об этом.",
        "objectives": {
          "0": {
      ...
      "q_root_hollow_boars_ii": {
        ...
        "text": "Пятеро были только началом, из нижних нор лезут еще. Доведи дело до конца: еще восемь, и Корневая Лощина правда отдохнет.",
        "completion": "Считай, последних землероев прикончили. Корни могут вздохнуть.",
        "objectives": {
          "0": {
            "label": "Дикий кабан убит"
          }
      ...
      "q_fallow_acres_wolves": {
        ...
        "text": "Волки кружат каждую ночь, участок не удержать. Проредите стаю на Перелогах, и прогулка того стоит.",
        "completion": "Вот теперь можно пару ночей поспать спокойно. Благодарен.",
        "objectives": {
          "0": {
      ...
      "q_fallow_acres_wolves_ii": {
        ...
        "text": "С краю проредили, а логово все еще полное. Еще восемь, и на Перелогах, может, будет тихая ночь.",
        "completion": "Наконец-то тихо. Теперь можно взяться за изгороди.",
        "objectives": {
          "0": {
            "label": "Лесной волк убит"
          }
