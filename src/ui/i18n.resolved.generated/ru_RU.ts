  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "dialogNode": {
          "hearth": "Хауди, друг, снова у сосуда, значит, он сегодня тихий, то ли слушает изо всех сил, то ли просто меня игнорит, с ним никогда не поймёшь, честно... Ну а как тебе Лощина, хорошо, плохо, перекусить с собой есть, нет? Ладно, просто спросил, спрашиваю для друга, а этот друг, это я...",
