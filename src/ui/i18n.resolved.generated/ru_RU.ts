  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "dialogNode": {
          "hearth": "Снова у сосуда, друг мой... Он сегодня тихий. То ли слушает изо всех сил, то ли дуется, а я всё никак не разберу, что из двух. Ну а Лощина, как она с тобой обходилась?",
          "warmed": "...Мягко сказано, друг мой, мягче, чем ты думаешь. Почти все, кто сюда заходят, ищут выход. А ты всё ищешь самую середину этого места, и такое встретишь реже, чем можно подумать.",
          "vase": "Всё как обычно. Он хочет дыма, хочет заботы, хочет, чтобы кто-нибудь сел поближе и притворился, будто тишина, это разговор... А ведь, если приглядеться, так оно и есть. Вот в этом, почитай, и вся вера.",
          "faith": "Вера, это громкое слово, друг мой. Я лишь ухаживаю. Ухаживать, вот что мне под силу этими двумя руками. А слушать я оставляю ему. А коли он не слушает, что ж, дым всё равно пахнет хорошо...",
          "stung": "...Эх. Да. Да, может, оно и так. Я и сам об этом думал холодными утрами, когда сосуд не вздыхает и никто не поднимается по тропе... Но я всё ещё здесь, друг мой, а значит, дело не только в этом. По крайней мере, для меня.",
          "mended": "Всё в порядке, друг мой. Такое место нет-нет да и заслужит резкое слово, не буду притворяться, будто нет. Но ты вернулся, чтобы сказать его помягче, а на это и погост бы не сподобился. Мы с тобой квиты.",
          "tribe": "Когда-то было большое племя, так гласят старые зарубки. Ряды счётных чёрточек там, в темноте, перечёркнутые пятёрками, и пятёрок этих больше, чем могла бы наделать одна рука... Долго-долго они держали его огонь зажжённым, покуда не остался я один. Не знаю, куда они ушли, друг мой. Знаю лишь, что фитиль не должен погаснуть, пока я на страже.",
          "confide": "...Это добрые слова, и малую их толику я всё же приму. По правде, я говорю с тобой наполовину оттого, что сосуд не отвечает, а наполовину оттого, что боюсь дня, когда по этой тропе не поднимется вовсе никто. Так что спасибо, что поднялся. Вот это и есть святое, друг мой, коли тебе такое надобно."
        },
        "dialogChoice": {
          "kind": "Это место понемногу начинает казаться домом, брат. И я говорю всерьёз.",
          "ask": "И что сосуд говорил в последнее время?",
          "blunt": "Это погост со смотрителем, Зеленолап. Только и всего.",
          "tribe": "Расскажи мне о племени, что жило здесь прежде.",
          "warm_bye": "Не буду отвлекать, возвращайся к нему.",
          "vase_more": "И ты правда веришь, что он слушает?",
          "vase_bye": "Тогда побудь с ним. А я буду поблизости.",
          "faith_bye": "Что ж, справедливо, Зеленолап.",
          "sorry": "Вышло злее, чем я хотел. Прости меня.",
          "cold_bye": "Верь во что хочешь.",
          "mended_bye": "Мы квиты. Ещё увидимся.",
          "confide": "Тебе не обязательно нести это в одиночку, брат.",
          "tribe_bye": "Кто-то всё ещё ухаживает за ним. И это чего-то да стоит.",
