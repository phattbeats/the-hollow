  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_nythraxis_scourges_end": {
        "title": "Конец Плети",
        "text": "Перстень открыл путь, $N, но открытая гробница еще не победа. Нитраксис когда-то был королем, и руины под Торнпиком все еще связаны его волей. Войдите в крипту с союзниками, которым доверяете. Сломайте бессмертную корону, пока ее приказ не достиг поля битвы наверху.",
