...
export const en: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorial": {
      ...
      "talkBodyTouch": "Stand close to Brother Greenpaw and tap the Use button to speak, then accept his errand.",
      "returnBodyTouch": "You carry the thing that burns. Return to Brother Greenpaw and tap the Use button to turn it in.",
      "doneBodyTouch": "You have the basics, {name}. The Hollow is yours to wander, and Greenpaw always has one more errand. Tap More, then Quests, to review your quest log anytime."
    },
    "widgets": {
  ...
  "guide": {
    ...
    "questsPage": {
      ...
      "typeSlayTitle": "Slay",
      "typeSlayBody": "Thin out a pack of beasts or break a cult's hold by defeating a set number of a marked enemy. An early one, thinning the wolves at Fallow Acres in the Hollow Reaches, is one of these.",
      "typeGatherTitle": "Gather",
      "typeGatherBody": "Collect items from the world or from what enemies drop: herbs, ore, lost letters, a cult's grim reagents. Your very first quest, a handful of emberbulbs for Brother Greenpaw at the vase, is one of these. Some pieces only fall from a particular foe, so the hunt and the haul go together.",
    ...
    "progression": {
      ...
      "journeyBody": "You start in the Hollow Reaches, quiet ground below the shrine gate. Three more zones lie north of it, each a step higher in level, from a green valley through a marsh to the cold high peaks. Follow the quest trail and the land carries you onward.",
  ...
  "seo": {
    "title": "The Hollow: Classic-Style Web MMO",
    "description": "Embark on an epic adventure in The Hollow, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!",
    "genre": "MMORPG",
  ...
  "a11y": {
    ...
    "githubProject": "Open The Hollow GitHub project",
    "discordCommunity": "Join The Hollow Discord community",
    "donateProject": "Donate to support The Hollow"
  },
  "loading": {
    "world": "Loading world...",
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Open The Hollow from the new Home Screen icon.",
    ...
    "androidOpenStep": "Open The Hollow from the new icon.",
  ...
  "serverUnavailable": {
    "title": "The Hollow - Realm Unavailable",
    "logoAlt": "The Hollow",
  ...
  "hud": {
    ...
    "tutorial": {
      ...
      "doneBody": "You have the basics, {name}. The Hollow is yours to wander, and Greenpaw always has one more errand. Press {questKey} anytime to review your quests.",
      ...
      "seekBody": "Brother Greenpaw waits at the foot of the vase, out of everything and hungry. Follow the marker to reach him.",
      "talkTitle": "Hear the Errand",
      "talkBody": "Stand close to Brother Greenpaw and press {interactKey} to speak, then accept his errand.",
      "gatherTitle": "The Thing That Burns",
      "gatherBody": "Emberbulbs grow where the light does not reach. Descend into the Under-Shrine and take them from the palefeeders. They come at your lantern, not at you.",
      "gatherProgress": "Emberbulbs gathered: {current} / {needed}",
      "returnTitle": "Feed the Furnace",
      "returnBody": "You carry the thing that burns. Return to Brother Greenpaw and press {interactKey} to turn it in."
    },
    "markers": {
      "names": {
        "star": "Star",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "greeting": "you're back, that's a blessin'... the vase has been sighin' all mornin', got a couple sacred matters queued up, same wavelength as last time. c'mere a minute...",
        "introLines": {
        ...
        "dialogNode": {
          "hearth": "hey now, friend, back at the vase huh, he's quiet today which means he's either listenin' real hard or straight up ignorin' me, can never tell with him, honestly... anyway how's the hollow been treatin' you, good, bad, you got a snack on you, no? okay just checkin', askin' for a friend, the friend is me...",
          "warmed": "...whoa, okay, that's real nice of you to say, friend, real nice, didn't expect it, most folks just b-line for the gate soon as they can... you're alright, you know that, you're alright to a greenpaw degree even, and i don't hand that out for free...",
          ...
          "faith": "believe's a big word, friend, i just tend, tendin' i can do, got two hands and a lighter and that's about the whole résumé... whether he's listenin' or not i couldn't tell ya, but the smoke smells good regardless so, wavelength's covered either way. indeed.",
          ...
          "mended": "s'all good, friend, honestly, place like this earns a hard word now'n then, i ain't gonna pretend it don't... you came back and said sorry though, and that means somethin', or it means you want somethin', either way we're square, you and me, same wavelength, snack's on me later if you want one.",
    ...
    "quests": {
      ...
      "q_what_burns": {
        ...
        "completion": "now THAT'S the good smoke... you feel that? room's gettin' thick. he's gonna lean in any minute now, i can feel it on the wavelength... indeed.",
        "objectives": {
          "0": {
