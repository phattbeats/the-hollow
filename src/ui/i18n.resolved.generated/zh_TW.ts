...
export const zh_TW: EnTranslations = {
  ...
  "coldOpen": {
    ...
    "orientBody": "神龕一片寂靜，煙火的氣味久久不散。花點時間站穩腳跟。準備好後，循著綠光前行：前方有人守著火焰，或許知道你失去了什麼。",
    "continue": "繼續",
    "begin": "開始",
    "skip": "跳過"
  },
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "dialogNode": {
          "hearth": "嘿，朋友，又回瓶子這兒了啊，他今天挺安靜的，要嘛是聽得特別入神，要嘛就是乾脆不理我了，跟他處久了也說不准，說真的……對了空谷這陣子待你怎樣，好還是不好，你帶零食了沒，沒有？行吧就隨口一問，替朋友問問，那朋友就是我……",
          "warmed": "……哇喔，好吧，你這麼說真的挺好聽的，朋友，是真挺好聽，沒想到耶，大多數人一有機會就直奔大門口了……你還挺不錯的，知道嗎，綠掌級別的不錯，這稱號我可不是隨便給的……",
          "vase": "老樣子啦，他要煙，要人照顧，要有人坐得近近的，讓這份安靜看起來像聊天，嘿，反正對我來說挺管用，我天天跟他唸叨，他一句都沒回過，呃，從來沒有，不過沒事，反正就這麼回事，綠掌級別的沒事……",
          "faith": "信不信是個大詞兒，朋友，我就是照顧照顧，照顧這事我這兩隻手能幹，還帶個打火機，履歷表上就這麼點東西……他到底聽沒聽我說不準，不過反正煙聞著挺香，波長這塊算是穩了。的確如此。",
          "stung": "……哎喲，好吧，疼啊朋友，我的天……我是說也許吧，我也說不準，那種大冷天的早上我自己也這麼想過，沒人上這條路來，瓶子連嘆口氣都懶得嘆……不過我還在這兒呢，所以，這總該算點什麼吧？對吧。對。對了你要不要零食，我有零食，換個話題。F。",
          "mended": "沒事沒事，朋友，說真的，這種地方三不五時挨句重話也正常，我不裝作沒這回事……不過你回來道歉了，這就說明點什麼，或者說明你想要點什麼，反正咱倆兩清了，你我，波長一致，改天你想要零食我請。",
    ...
    "quests": {
      ...
      "q_root_hollow_boars": {
        ...
        "completion": "五頭。清點、記日、錄入登記簿。根穴如今只落後自己這一季兩週，在本職上，這已算大捷。謹代表一個眼下只剩我一人的教團，向你道謝。",
        "objectives": {
          "0": {
            "label": "野豬已殺"
          }
      ...
      "q_fallow_acres_wolves": {
        "title": "趕走田壟上的狼",
        "text": "有人打算在閒田莊蓋房。好事。有人住過的地比沒人住過的地記性好，而這一帶已經忘了太多。可只要狼群還在夜裡活動，什麼都安定不下來。把狼群清到剩五頭，我定叫你這趟不白走。償還，幾乎是我如今僅存的用處了。",
        "completion": "安靜些了。好。我在許多安靜的地方站過，那些地方從前滿是人聲；這一處，還有機會往相反的方向走。謝你，路上當心。",
        "objectives": {
          "0": {
            "label": "森林狼已殺"
          }
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "最後的狼群",
        "text": "邊上是稀疏了，窩卻沒有。再殺八頭，閒田莊便能撐起一片屋頂，而不必在夜裡失去屋下安睡之人。我本想親自照看，可我極少在一處停留兩回，何況神龕底下的地，比這些田壟更需要看顧。",
        "completion": "好了。一個安靜的夜，興許後頭還有一百個。好好建吧。還有，你若哪天挖得夠深，聽見底下有什麼在緩緩打著節拍，千萬別應它。那一樣，歸我看守；開它的鑰匙在我身上。去吧，走吧。",
        "objectives": {
          "0": {
            "label": "森林狼已殺"
          }
    ...
    "zones": {
      "the_hollow_reaches": {
        "name": "空穴外域",
        "welcome": "大門外是一片開闊之地，道路以西的閒田莊看起來很適合安家。",
        "pois": {
          "0": {
            "label": "空穴之門"
          },
