  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "最后的狼群",
        "text": "边上是稀疏了，窝却没有。再杀八头，闲田庄便能撑起一片屋顶，而不必在夜里失去屋下安睡之人。我本想亲自照看，可我极少在一处停留两回，何况外域底下的地，比这些田垄更需要看顾。",
    ...
    "dungeons": {
      ...
      "under_shrine": {
        "name": "地下圣龛",
        "enterText": "你潜入神龛之下。空气变得静止而压抑，前方的黑暗似乎并不空无一物。这下面的什么东西，在无人聆听许久之后，仍自顾自地计着时间。",
        "leaveText": "你爬回温暖之处。头顶上方，隐约有烟。而在下方，黑暗仍在缓缓计数。"
      }
    },
    "delves": {
      "collapsed_reliquary": {
