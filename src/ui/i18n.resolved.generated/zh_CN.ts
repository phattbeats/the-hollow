...
export const zh_CN: EnTranslations = {
  ...
  "coldOpen": {
    ...
    "orientBody": "神龛一片寂静，烟火的气味久久不散。花点时间站稳脚跟。准备好后，循着绿光前行：前方有人守着火焰，或许知道你失去了什么。",
    "continue": "继续",
    "begin": "开始",
    "skip": "跳过"
  },
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_greenpaw": {
        ...
        "dialogNode": {
          "hearth": "又回到瓶子这儿了，朋友……他今天很安静，要么是听得入神，要么是在闹别扭，我从来分不清是哪一种。空谷这阵子待你可还好？",
          "warmed": "……这话落得轻柔，朋友，比你想的还要轻柔。大多数人打这儿路过，都在找出口。可你却总在寻这地方的中间，那可比你以为的要难得多。",
          "vase": "跟往常一样。他想要香烟，想要人照料，想要有人坐得近近的，把这份寂静当成一场交谈来陪着他……嘿，要是你换个眼光去看，那还真就是一场交谈。这差不多就是全部的信仰了。",
          "faith": "信仰这词儿太重了，朋友。我只是照料。照料是我这双手能做的事。倾听我留给他，就算他没在听，嗯，那香烟闻着终归还是香的……",
          "stung": "……唉。是啊。是啊，也许就是这样。在那些冷清的早晨，瓶子不叹气，也没人走上这条小路的时候，我自己也这么想过……可我还在这儿呢，朋友，所以它不只是这样。至少对我来说不是。",
          "mended": "没事的，朋友。这样的地方，时不时招来一句重话也是应该的，我不装作不是这样。可你还是回来把话说软了，这比乱葬岗肯做的要多得多。咱俩两清了，你和我。",
          "tribe": "从前是个大部族，那些古老的刻痕是这么说的。黑暗里刻着一排排计数的划痕，五道五道地划掉，比任何一双手能划出的都多……他们让他亮了好长好长一段日子，才轮到只剩我一个。我不知道他们去了哪儿，朋友。我只知道，这灯芯不能在我看守的时候熄灭。",
          "confide": "……你这份好意难得，我就领它薄薄的一片吧。说实话，我跟你聊，一半是因为瓶子不答话，一半是因为我怕有那么一天，再没人走上这条小路了。所以，谢谢你走上来。要说什么是神圣的，朋友，那就是它了。"
        },
        "dialogChoice": {
          "kind": "这地方开始有点像个归处了，师兄。我是真心这么觉得。",
          "ask": "瓶子最近都说了些什么？",
          "blunt": "这就是个有看守人的乱葬岗，绿掌。仅此而已。",
          "tribe": "跟我说说从前住在这儿的那个部族吧。",
          "warm_bye": "我就不打扰你陪他了。",
          "vase_more": "你真的相信他在听吗？",
          "vase_bye": "那就好好陪着他吧。我就在附近。",
          "faith_bye": "说得也是，绿掌。",
          "sorry": "那话说得比我本意要刻薄。对不起。",
          "cold_bye": "你爱信什么就信什么吧。",
          "mended_bye": "咱俩两清了。回头见。",
          "confide": "你不必独自扛着这一切，师兄。",
          "tribe_bye": "还有人在照料着它。这总归有点分量。",
          "confide_bye": "我会一直走上这条小路来的，绿掌。"
        }
      },
      "verger_zebediah": {
        "name": "司事泽比迪亚",
    ...
    "quests": {
      ...
      "q_root_hollow_boars": {
        ...
        "completion": "五头。清点、记日、录入登记簿。根穴如今只落后自己这一季两周，在本职上，这已算大捷。谨代表一个眼下只剩我一人的教团，向你道谢。",
        "objectives": {
          "0": {
            "label": "野猪已杀"
          }
      ...
      "q_fallow_acres_wolves": {
        "title": "赶走田垄上的狼",
        "text": "有人打算在闲田庄盖房。好事。有人住过的地比没人住过的地记性好，而这一带已经忘了太多。可只要狼群还在夜里活动，什么都安定不下来。把狼群清到剩五头，我定叫你这趟不白走。偿还，几乎是我如今仅存的用处了。",
        "completion": "安静些了。好。我在许多安静的地方站过，那些地方从前满是人声；这一处，还有机会往相反的方向走。谢你，路上当心。",
        "objectives": {
          "0": {
            "label": "森林狼已杀"
          }
      ...
      "q_fallow_acres_wolves_ii": {
        "title": "最后的狼群",
        "text": "边上是稀疏了，窝却没有。再杀八头，闲田庄便能撑起一片屋顶，而不必在夜里失去屋下安睡之人。我本想亲自照看，可我极少在一处停留两回，何况神龛底下的地，比这些田垄更需要看顾。",
        "completion": "好了。一个安静的夜，兴许后头还有一百个。好好建吧。还有，你若哪天挖得够深，听见底下有什么在缓缓打着节拍，千万别应它。那一样，归我看守；开它的钥匙在我身上。去吧，走吧。",
        "objectives": {
          "0": {
            "label": "森林狼已杀"
          }
    ...
    "dungeons": {
      ...
      "under_shrine": {
        "name": "地下圣龛",
        "enterText": "你走下神龛，进入清冷寂静的黑暗。",
        "leaveText": "你爬回上方温暖的空气中。"
      }
    },
    "delves": {
      "collapsed_reliquary": {
