...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.tutorial.talkBodyTouch': '靠近綠掌修士並點按「使用」按鈕與他交談，然後接受他的差事。',
  'hudChrome.tutorial.returnBodyTouch': '你帶著會燃燒之物。返回綠掌修士處，點按「使用」按鈕交付。',
  'hudChrome.tutorial.doneBodyTouch':
    '你已掌握基礎，{name}。空穴任你遊歷，綠掌修士總有下一樁差事。點按「更多」再選「任務日誌」即可隨時查看任務。',
  ...
  'errors.api.tooManyOnline': '同一時間只能有一個角色在世界中。',
  'errors.api.takenOver': '你的角色已被另一個工作階段接管。',
  'errors.api.realmFull': '此伺服器目前已滿，請稍後再試。',
  ...
  'questUi.dialog.trainSecondary': '訓練我一項副職業。',
  'questUi.dialog.trainSecondaryAria': '向 {name} 學習一項副職業',
  'questUi.dialog.trainerTitle': '副職業',
  'questUi.dialog.trainerLevelLocked': '{level} 級解鎖。',
  'questUi.dialog.trainerCurrent': '目前',
  'questUi.dialog.trainerFree': '免費',
  'questUi.dialog.trainerPickAria': '將 {cls} 訓練為副職業：{cost}',
  ...
  'itemUi.error.requiresLevelToEquip': '需要等級 {level} 才能裝備。',
  ...
  'entities.abilities.sunder_armor.description':
    '撕裂目標的護甲，每次使其降低 2%。最多疊加 5 次。產生大量威脅值。',
  ...
  'entities.mobs.boarball_ball.name': '野豬球',
  ...
  // the intro, longer arc: the "簿記得住行人所忘" throughline plus the heron
  // and the room beneath the shrine.
  'entities.npcs.verger_zebediah.journalLines.0':
    '這本登記簿比蒼鷺更老。第一筆並非我所書，最後一筆也並非我所能書；這便是一樁無人等候承繼的職務，所能給我的慰藉。外域曾是一條通衢。有人沿湖道攜鹽而上，歸時攜一樁無以名狀之物而去，我既不便過問，便也未曾過問。簿中記其來、記其去，亦記一段長久無人來往的空白。那段空白，我也一併看顧。',
  ...
  // longer arc. The "地比我們記得更牢" throughline and the slow time under
  // the stones.
  'entities.npcs.sexton_faddick.journalLines.0':
    '我所看顧的地方，記在腦中便好，因紙易主比地易主來得快。神龕居多，皆是已無人奉祀之神龕。閒田莊在冊。湖東那無名池塘亦在冊。還有一柱立石，風花了一百年才把它磨圓。冊子不長，在要緊處，冊子便是全部。一地之留存，不在久留，而在仍是那個記得它曾在此的人。',
  'entities.npcs.sexton_faddick.journalLines.1':
    '地比我們記得更牢。這便是全部的交換。地上之人走不過兩代，便忘了自己本來的名，又起個新的，照舊叫它；地下之物一無所忘，只管等。石頭底下有一種慢時辰。我聽過一次，沒答，因為一答，那慢東西便尋到了門。我攜著不答的鑰匙，非金屬之鑰，是習慣，習比金屬重一些。',
  'entities.npcs.sexton_faddick.journalLines.2':
    '狼並非問題，狼只是症候；問題在於那樁使地靜到狼都以為是自己的事。這樣的事我見過，一處之地朝錯的方向靜下去，修法向來只有一種：以對的噪聲再把它弄響，而這噪聲便是人，這便是為何有人去建。你或要問，我何德何能，擔得這些。我是那仍走著的人，這便是全部的資格。夠也不夠，夠與不夠之間的那段空隙，我已同它講和。',
  ...
  'entities.dungeons.under_shrine.enterText': '你走下神龕，進入清冷寂靜的黑暗。',
  'entities.dungeons.under_shrine.leaveText': '你爬回上方溫暖的空氣中。',
  ...
  'entities.items.flint_amber_pick.name': '燧石琥珀鎬',
  'entities.items.bonewood_amber_pick.name': '骨木琥珀鎬',
  'entities.items.starleaf_amber_pick.name': '星葉琥珀鎬',
  'entities.items.flint_bark_axe.name': '燧石樹皮斧',
  'entities.items.bonewood_bark_axe.name': '骨木樹皮斧',
  'entities.items.starleaf_bark_axe.name': '星葉樹皮斧',
  'entities.items.flint_spore_sickle.name': '燧石孢子鐮刀',
  'entities.items.bonewood_spore_sickle.name': '骨木孢子鐮刀',
  'entities.items.starleaf_spore_sickle.name': '星葉孢子鐮刀',
  ...
  'hud.tutorial.seekTitle': '尋找綠掌修士',
  'hud.tutorial.seekBody': '綠掌修士在甕的腳邊等候，缺東少西，飢腸轆轆。跟隨標記前往找他。',
  'hud.tutorial.talkTitle': '聽差事',
  'hud.tutorial.talkBody': '靠近綠掌修士並按 {interactKey} 與他交談，然後接受他的差事。',
  'hud.tutorial.gatherTitle': '會燃燒之物',
  'hud.tutorial.gatherBody':
    '餘燼球莖生長在光照不到的地方。深入地下聖龕，從蒼白噬光者手中奪取它們。牠們撲向你的燈籠，而非你本人。',
  'hud.tutorial.gatherProgress': '已收集餘燼球莖：{current} / {needed}',
  ...
  'entities.items.bramblewar_warhelm.name': '荊棘戰頭部',
  'entities.items.bramblewar_warspaulders.name': '荊棘戰肩部',
  'entities.items.bramblewar_warplate.name': '荊棘戰胸部',
  'entities.items.bramblewar_girdle.name': '荊棘戰腰部',
  'entities.items.bramblewar_legguards.name': '荊棘戰腿部',
  'entities.items.bramblewar_gauntlets.name': '荊棘戰手部',
  'entities.items.bramblewar_sabatons.name': '荊棘戰腳部',
  'entities.items.thornbound_crown.name': '荊棘縛頭部',
  'entities.items.thornbound_spaulders.name': '荊棘縛肩部',
  'entities.items.thornbound_hauberk.name': '荊棘縛胸部',
  'entities.items.thornbound_waistguard.name': '荊棘縛腰部',
  'entities.items.thornbound_legmail.name': '荊棘縛腿部',
  'entities.items.thornbound_handguards.name': '荊棘縛手部',
  'entities.items.thornbound_greaves.name': '荊棘縛腳部',
  'entities.items.nettlestalker_cowl.name': '蕁麻潛者頭部',
  'entities.items.nettlestalker_shoulderguards.name': '蕁麻潛者肩部',
  'entities.items.nettlestalker_harness.name': '蕁麻潛者胸部',
  'entities.items.nettlestalker_waistband.name': '蕁麻潛者腰部',
  'entities.items.nettlestalker_legguards.name': '蕁麻潛者腿部',
  'entities.items.nettlestalker_grips.name': '蕁麻潛者手部',
  'entities.items.nettlestalker_treads.name': '蕁麻潛者腳部',
  'entities.items.mossweave_cowl.name': '苔蘚織頭部',
  'entities.items.mossweave_mantle.name': '苔蘚織肩部',
  'entities.items.mossweave_raiment.name': '苔蘚織胸部',
  'entities.items.mossweave_cord.name': '苔蘚織腰部',
  'entities.items.mossweave_legwraps.name': '苔蘚織腿部',
  'entities.items.mossweave_handwraps.name': '苔蘚織手部',
  'entities.items.mossweave_slippers.name': '苔蘚織腳部',
  'entities.items.last_bloom_greatblade.name': '末花巨刃',
  'entities.items.thornbite_razor.name': '棘咬剃刃',
  'entities.items.heartwood_warstaff.name': '心木戰杖',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    '好迪，朋友，又回瓶子這兒了啊，他今天挺安靜的，要嘛是聽得特別入神，要嘛就是乾脆不理我了，說真的這兩樣我都佩服，因為我也就這兩個檔……對了空谷這陣子待你怎樣，好還是不好，你帶零食了沒，沒有？行吧就隨口一問，替朋友問問，那朋友就是我……',
  'entities.npcs.brother_greenpaw.dialogNode.warmed':
    '……哇喔，好吧，你這麼說真的挺好聽的，朋友，是真挺好聽，沒想到耶，大多數人一有機會就直奔大門口了……你還挺不錯的，知道嗎，綠掌級別的不錯，這稱號我可不是隨便給的……要是我手裡有股票，我就買你的股，買進新朋友，賣出舊兆頭，這就叫經濟……',
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    '老樣子啦，他要煙，要人照顧，要有人坐得近近的，讓這份安靜看起來像聊天……欸。這不就是大多數聊天嘛。哇喔。行吧，反正，我天天跟他唸叨，他一句都沒回過，呃，從來沒有，不過沒事，反正就這麼回事，綠掌級別的沒事……等等，咱們剛才聊到哪兒了……喔。對。說他呢。他挺好的。大概是餓了。同感。',
  'entities.npcs.brother_greenpaw.dialogNode.faith':
    '信不信是個大詞兒，朋友，我就是照顧照顧，照顧這事我這兩隻手能幹，還帶個打火機，履歷表上就這麼點東西……他到底聽沒聽我說不準，不過煙聞著挺香，還不會對我評頭論足，比大多數長耳朵的強多了，所以波長這塊算是穩了。的確如此。',
  'entities.npcs.brother_greenpaw.dialogNode.stung':
    '……哎喲，好吧，疼啊朋友，我的天……我是說也許吧，我也說不準，那種大冷天的早上我自己也這麼想過，沒人上這條路來，瓶子連嘆口氣都懶得嘆……不過我還在這兒呢，所以，這總該算點什麼吧？對吧。對。對了你要不要零食，我有零食，換個話題。F。',
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    '沒事沒事，朋友，全都是賭局，從來都是，這是我心裡那個牛仔在說話，別問他賭局什麼意思，他也不知道，就是說得特別有底氣……這種地方三不五時挨句重話也正常，我不裝作沒這回事……不過你回來道歉了，這就說明點什麼，或者說明你想要點什麼，反正咱倆兩清了，你我，波長一致，改天你想要零食我請。',
  'entities.npcs.brother_greenpaw.dialogNode.tribe':
    '以前是個大部族，反正老刻痕是這麼說的，我認字不太行，不過我會數數，那底下刻了老多老多的五道槓，劃掉的，比一隻手能劃出來的都多，這數學我繞不過去……讓他亮了老長老長一段時間，才輪到只剩我一個。我不知道大夥都去哪兒了，朋友，是真不知道，我有時候在波長上能感覺到點什麼，可那感覺自己都說不完一句話，所以我也說不完……不過這燈芯不能在我看著的時候滅了。這個我是真知道。',
  'entities.npcs.brother_greenpaw.dialogNode.confide':
    '……你這麼說真挺好的，朋友，是真挺好……聽著，我跟你唸叨一半是因為瓶子不搭理我，一半是因為我怕，有那麼些晚上，我怕再也沒人上這條路來了，就剩我跟他，還有這份安靜……所以。謝謝你上來了。要說啥算神聖，朋友，那就是這個。……對了。你帶零食了沒？替瓶子問的。波長也餓了。',
  'entities.npcs.brother_greenpaw.dialogChoice.kind': '越來越喜歡這兒了，綠掌。是真的，真的。',
  'entities.npcs.brother_greenpaw.dialogChoice.ask': '那瓶子這幾天都說了啥？',
  'entities.npcs.brother_greenpaw.dialogChoice.blunt': '就是個帶吉祥物的亂葬崗，綠掌。僅此而已。',
  'entities.npcs.brother_greenpaw.dialogChoice.tribe': '跟我說說那個部族吧，你之前那個。',
  'entities.npcs.brother_greenpaw.dialogChoice.warm_bye': '那我不打擾你陪他了。',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_more': '你是真覺得他在聽？',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_bye': '那好，陪著他吧。',
  'entities.npcs.brother_greenpaw.dialogChoice.faith_bye': '說得也是，綠掌。',
  'entities.npcs.brother_greenpaw.dialogChoice.sorry': '那話說重了，不是故意的。對不起，綠掌。',
  'entities.npcs.brother_greenpaw.dialogChoice.cold_bye': '你愛信什麼就信什麼吧。',
  'entities.npcs.brother_greenpaw.dialogChoice.mended_bye': '咱倆兩清了。回頭見，綠掌。',
  'entities.npcs.brother_greenpaw.dialogChoice.confide': '你不必獨自扛著這一切，師兄。',
  'entities.npcs.brother_greenpaw.dialogChoice.tribe_bye': '反正還有人照料著呢。',
  'entities.npcs.brother_greenpaw.dialogChoice.confide_bye': '我會一直上這條路來的，綠掌。',
  ...
  'sim.hearth.helpLine': '綠掌：/feed（從甕邊帶上能燒的或能填飽肚子的東西）。',
  'sim.hearth.morsel1': '……哦，願神保佑你，夥計。保佑你腳下的這片土地。',
  'sim.hearth.morsel2': '肚子總算不咕咕叫了，消停一會兒。多謝了……',
  'sim.hearth.morsel3': '一口好乾糧，就像一個好朋友……難得，也值得一路尋來。',
  ...
  'sim.house.helpLine':
    '宅邸：/house、/house claim、/house place <槽位> <種類>、/house remove <槽位>。',
  'sim.house.mustBeInHollow': '你必須在空穴裡才能打理你的宅邸。',
  'sim.house.mustStandToClaim': '你必須站在空穴中的宅地上才能認領。',
  'sim.house.noFreePlot': '這裡沒有空閒的宅地。站到一塊地上再認領。',
  'sim.house.noHomestead': '你還沒有宅邸。用 /house claim 認領一處。',
  'sim.house.placed': '在槽位 {slot} 放置了 {kind}。',
  'sim.house.plotTaken': '那塊宅地已經有主人了。',
  'sim.house.readoutMine': '你的宅邸：{plotId}。裝飾：{decor}。',
  'sim.house.readoutNone': '你沒有宅邸。站到空穴裡的空閒地塊上，輸入 /house claim。',
  'sim.house.readoutUsage': '/house place <1-{count}> <{kinds}>，/house remove <槽位>。',
  'sim.house.slotEmpty': '那個槽位本來就是空的。',
  'sim.house.slotRange': '槽位編號為 1 到 {count}。',
  'sim.house.unknownKind': '未知的裝飾種類。可選種類：{kinds}。',
  ...
  'hudChrome.npcJournal.readLabel': '跟我說說你的日記吧。',
  'hudChrome.npcJournal.readAria': '閱讀{name}的日記',
  'hudChrome.npcJournal.back': '上一頁',
  ...
  'housingUi.prompt.manage': '管理你的家園',
  'housingUi.prompt.visit': '拜訪{name}的家',
  'housingUi.window.title': '你的家園',
  'housingUi.window.close': '關閉家園',
  'housingUi.window.slotEmpty': '空',
  'housingUi.window.clear': '清除',
  'housingUi.window.clearAria': '清除欄位 {slot}',
  'housingUi.window.placeAria': '將{decor}放置在欄位{slot}',
  'housingUi.window.hint': '為每個欄位選擇一個裝飾。',
  'housingUi.decor.planter': '花盆',
  'housingUi.decor.lantern': '燈籠',
  ...
  'coldOpen.begin': '開始',
  'coldOpen.skip': '跳過',
  'apiError.crossSiteRejected': '跨站請求已被拒絕。',
  'apiError.notAuthenticated': '尚未驗證。',
  'apiError.readOnlyToken': '此權杖為唯讀。',
  'apiError.characterNotFound': '找不到角色。',
  'apiError.rateLimited': '嘗試次數過多。請等待一分鐘後再試。',
  'mailUi.title': '渡鴉驛站',
  ...
  'hudChrome.calendar.events.raidCall.note': '守衛吹響號角：組隊前往團隊副本。',
  ...
  'hudChrome.calendar.events.delveDay.note': '與同伴一起挑戰坍塌聖物窖的好日子。',
  'hudChrome.calendar.events.moongateCommunion.title': '月門共禱',
  'hudChrome.calendar.events.moongateCommunion.note': '朝聖者在月中之月下聚於月之聖所。',
  ...
  'hudChrome.warfare.honorGain': '+{amount} 榮譽（{reason}）',
  ...
  'hudChrome.book.titleClear': '無稱號',
  'hudChrome.book.titleDisplay': '{display}',
  'hudChrome.book.titleActiveTag': '已裝備',
  'hudChrome.book.titlePickAria': '裝備稱號 {display}',
  'hudChrome.book.titleRewardHint': '完成此事蹟可獲得稱號。',
  'hudChrome.book.categoryEmpty': '此分類下尚無內容。',
  'hudChrome.book.category.chronicle': '編年史',
  'hudChrome.book.category.collection': '收集',
  'hudChrome.book.category.combat': '戰鬥',
  'hudChrome.book.category.delve': '秘境',
  'hudChrome.book.category.dungeon': '地下城',
  'hudChrome.book.category.exploration': '探索',
  'hudChrome.book.category.feat': '壯舉',
  'hudChrome.book.category.progression': '進程',
  'hudChrome.book.category.pvp': '玩家對決',
  'hudChrome.book.category.social': '社交',
  'hudChrome.book.category.hidden': '隱藏',
  'hudChrome.titleTracker.unspent': '+{count} 項待選',
  'hudChrome.titleTracker.ariaLabel': '目前稱號：{display}',
  'hudChrome.hitRating.ratingLabel': '命中等級',
  'hudChrome.dungeonFinder.title': '地下城搜尋器',
  'hudChrome.dungeonFinder.close': '關閉',
  'hudChrome.dungeonFinder.offlineNote': '地下城搜尋器在離線模式下不可用。',
  'hudChrome.dungeonFinder.roleTank': '坦克',
  'hudChrome.dungeonFinder.roleHealer': '治療',
  'hudChrome.dungeonFinder.roleDps': '輸出',
  'hudChrome.dungeonFinder.queueButton': '排隊',
  'hudChrome.dungeonFinder.leaveButton': '離開隊列',
  'hudChrome.dungeonFinder.idleHint': '選擇一個角色以排隊進入{dungeon}。',
  'hudChrome.dungeonFinder.queuedStatus': '已排隊：{role}，目標{dungeon}（第{position}位）',
  'sim.dungeonFinder.cannotQueueDead': '你死亡時無法加入地下城搜尋器隊列。',
  'sim.dungeonFinder.dungeonUnavailable': '該地下城尚未開放地下城搜尋器功能。',
  'sim.dungeonFinder.roleUnavailable': '你的職業無法以該角色排隊。',
  'sim.dungeonFinder.leaveParty': '請先離開隊伍，才能加入地下城搜尋器排隊。',
  'sim.dungeonFinder.cannotQueueDueling': '決鬥時無法加入地下城搜尋器排隊。',
  'sim.dungeonFinder.finishTrade': '請先完成交易，才能加入地下城搜尋器排隊。',
  'sim.dungeonFinder.cannotQueueInstance': '在副本內無法加入地下城搜尋器排隊。',
  'sim.dungeonFinder.joined': '你以{role}身分加入地下城搜尋器隊列，等待組隊...',
  'sim.dungeonFinder.left': '你已離開地下城搜尋器隊列。',
  'sim.dungeonFinder.ready': '你的地下城搜尋器隊伍已就緒：{dungeon}！',
  'sim.dungeonFinder.removed': '你已被移出地下城搜尋器隊列。',
  'entities.npcs.bramble.name': '布蘭博',
  'entities.npcs.bramble.title': '榮譽軍需官',
  'entities.npcs.bramble.greeting': '沙場記得每一場勝利。好好花你的榮譽吧。',
  'editor.viewport.assetsFailed': '無法載入 3D 檢視：{error}',
  'editor.appTitle': '地圖編輯器',
  'editor.docTitle': '地圖編輯器 - World of ClaudeCraft',
  'editor.untitledMap': '未命名地圖',
  'editor.playtestPlayerName': '地圖作者',
  ...
  'editor.topbar.newTitle': '從內建世界開始新地圖',
  'editor.topbar.openTitle': '開啟已儲存的地圖（瀏覽器或伺服器）',
  'editor.topbar.saveTitle': '儲存到此瀏覽器；登入後同時儲存到伺服器（Ctrl+S）',
  'editor.topbar.saveAsTitle': '另存為新名稱的副本',
  'editor.topbar.forkTitle': '建立此地圖的伺服器端個人副本',
  'editor.topbar.forkDisabledTitle': '請先開啟一個伺服器地圖再復刻',
  ...
  'editor.topbar.uploadAsset': '上傳素材',
  'editor.topbar.uploadAssetTitle': '上傳 GLB 模型（最大 8 MiB）以放置到你的地圖中',
  'editor.topbar.uploadAssetDisabledTitle': '請在遊戲中登入後再上傳素材',
  'editor.topbar.playtest': '試玩',
  'editor.topbar.playtestTitle': '在此地圖上啟動遊戲（離線，包含目前編輯）',
  'editor.topbar.viewLabel': '檢視模式',
  'editor.topbar.view3dTitle': '在渲染世界中編輯',
  'editor.topbar.view2dTitle': '在符號化俯視地圖上編輯',
  'editor.topbar.undoCountTitle': '{count} 步可復原（Ctrl+Z 復原，Ctrl+Y 重做）',
  'editor.topbar.autosave': '自動儲存',
  'editor.topbar.autosaveTitle': '在有未儲存變更時自動儲存地圖。儲存失敗時會自動關閉。',
  'editor.topbar.undoTitle': '復原上一次變更（Ctrl+Z）',
  'editor.topbar.redoTitle': '重做上一次復原的變更（Ctrl+Y）',
  'editor.topbar.offline': '離線',
  'editor.topbar.offlineTitle': '未登入：地圖僅儲存到此瀏覽器。請在遊戲中登入以線上儲存。',
  'editor.topbar.signInTitle': '在新分頁中開啟遊戲登入畫面',
  'editor.topbar.helpTitle': '編輯器指南：工具、快捷鍵與教學',
  'editor.tool.listLabel': '編輯器工具',
  'editor.tool.select': '選擇',
  'editor.tool.raise': '抬高',
  'editor.tool.lower': '降低',
  'editor.tool.smooth': '平滑',
  'editor.tool.flatten': '剷平',
  'editor.tool.paint': '繪製生態群落',
  'editor.tool.water': '水域',
  'editor.tool.place': '放置素材',
  'editor.tool.blocker': '阻擋牆',
  'editor.tool.spawn': '重生點',
  'editor.tool.region': '區域',
  'editor.tool.erase': '擦除',
  'editor.topbar.savedLocal': '已儲存到此瀏覽器',
  'editor.topbar.savedServer': '已儲存（版本 {version}）',
  'editor.a11y.stage': '地圖檢視區',
  'editor.a11y.toasts': '編輯器通知',
  'editor.confirm.cancel': '取消',
  'editor.confirm.conflictTitle': '其他人已儲存此地圖',
  'editor.confirm.conflictBody':
    '伺服器上的副本現在是版本 {version}，比你載入的版本更新。請將你的變更另存為新地圖，以免覆蓋對方的變更。',
  'editor.confirm.discardTitle': '放棄未儲存的變更？',
  'editor.confirm.discardBody': '「{name}」有未儲存的變更，這些變更將會遺失。',
  'editor.confirm.discard': '放棄',
  'editor.prompt.nameLabel': '地圖名稱',
  'editor.status.saveFailedLocal': '無法儲存到此瀏覽器（儲存空間可能已滿）。',
  'editor.status.savedLocalOnly': '「{name}」已儲存到此瀏覽器。登入後即可同時儲存到伺服器。',
  'editor.status.savedServer': '「{name}」已儲存（版本 {version}）。',
  'editor.status.autosaveOff': '自動儲存已關閉：{reason}',
  'editor.status.autosaveFailed': '無法寫入自動儲存草稿（儲存空間可能已滿）。',
  'editor.status.forked': '已建立你自己的副本：「{name}」。',
  'editor.status.opened': '「{name}」已開啟。',
  'editor.status.newMap': '已開始新地圖。',
  'editor.status.imported': '「{name}」已匯入。',
  'editor.status.importFailed': '無法匯入該檔案。',
  'editor.status.exported': '地圖已匯出。',
  'editor.status.playtestLaunch': '正在啟動試玩……',
  'editor.status.playtestFailed': '無法啟動試玩（儲存空間可能已被封鎖）。',
  'editor.upload.notGlb': '只能上傳 .glb 檔案。',
  'editor.upload.tooLarge': '該檔案大於 8 MiB。',
  'editor.upload.uploading': '正在上傳……',
  'editor.upload.uploaded': '「{name}」已上傳。',
  'editor.upload.uploadedExisting': '你已上傳過此檔案；將重複使用它。',
  'editor.serverError.invalid_map_name': '該地圖名稱無效。',
  'editor.serverError.map_name_not_allowed': '不允許使用該地圖名稱。',
  'editor.serverError.invalid_map_doc': '此地圖文件無效。',
  'editor.serverError.invalid_version': '該儲存已過期。請重新開啟地圖並再試一次。',
  'editor.serverError.map_limit_reached': '你的帳號已達到已儲存地圖數量上限。',
  'editor.serverError.map_not_found': '該地圖已不存在。',
  'editor.serverError.version_conflict': '其他人已先儲存了此地圖。',
  'editor.serverError.slug_unavailable': '該地圖名稱已被使用，請換一個。',
  'editor.serverError.map_too_large': '此地圖過大，無法儲存。',
  'editor.serverError.invalid_glb': '該檔案不是有效的 GLB 模型。',
  'editor.serverError.asset_blocked': '該素材已被管理員移除。',
  'editor.serverError.asset_limit_reached': '你的帳號已達到已上傳素材數量上限。',
  'editor.serverError.asset_storage_limit_reached': '你已達到上傳素材的儲存空間上限。',
  'editor.serverError.asset_too_large': '該素材大於 8 MiB。',
  'editor.serverError.asset_not_found': '該素材已不存在。',
  'editor.serverError.rate_limited': '請求過於頻繁，請稍候再試。',
  'editor.serverError.unauthorized': '請在遊戲中登入後再執行此操作。',
  'editor.serverError.network': '無法連線到伺服器，請檢查你的網路連線。',
  'editor.serverError.timeout': '伺服器回應逾時。',
  'editor.serverError.unknown': '發生錯誤，請再試一次。',
  'editor.assets.label': '素材瀏覽器',
  'editor.assets.title': '素材',
  'editor.assets.search': '搜尋素材',
  'editor.assets.searchPlaceholder': '搜尋……',
  'editor.assets.uploadedTab': '已上傳',
  'editor.assets.uploadedSignIn': '請在遊戲中登入以檢視和上傳你自己的素材。',
  'editor.assets.uploadedLoadFailed': '無法載入你上傳的素材。',
  'editor.assets.uploadedEmpty': '你還沒有上傳過任何素材。',
  'editor.assets.loading': '載入中……',
  'editor.assets.empty': '沒有符合的素材。',
  'editor.assets.pick': '放置 {name}',
  'editor.assets.deleteAsset': '刪除素材',
  'editor.assets.deleteAssetConfirm': '刪除「{name}」？使用該素材的地圖放置項將無法顯示。',
  'editor.assets.category.biome': '生態群落',
  ...
  'editor.help.mouseTitle': '滑鼠',
  'editor.help.flowTitle': '儲存與草稿',
  'editor.help.beginTutorial': '開始教學',
  'editor.help.close': '關閉',
  'editor.help.mouse.orbit3d': '3D 檢視：左鍵拖曳以環繞，右鍵拖曳以平移',
  'editor.help.mouse.fly3d': '3D 檢視：捲動以縮放，使用 WASD 飛行',
  'editor.help.mouse.pan2d': '2D 檢視：拖曳空白處以平移，捲動以縮放',
  'editor.help.flow.save': '儲存會寫入此瀏覽器；登入後還會寫入伺服器',
  'editor.help.flow.draft': '自動儲存草稿可在分頁意外關閉時保護未儲存的編輯',
  'editor.tutorial.title': '編輯器教學',
  'editor.tutorial.finish': '完成',
  'editor.tutorial.steps.toolbar.title': '工具',
  'editor.tutorial.steps.toolbar.body': '在這裡選擇工具。放置功能現已可用；更多工具即將推出。',
  'editor.tutorial.steps.stage.title': '檢視區',
  'editor.tutorial.steps.stage.body': '這是你的地圖。可隨時在 3D 與 2D 檢視之間切換。',
  'editor.tutorial.steps.viewToggle.title': '3D / 2D 切換',
  'editor.tutorial.steps.viewToggle.body': '切換到 2D 俯視圖以精確放置，或切換到 3D 檢視結果。',
  'editor.tutorial.steps.save.body': '儲存會在此瀏覽器中留存副本，登入後還會儲存到伺服器。',
  'editor.tutorial.steps.help.body': '你可以隨時回到這裡查看本教學。',
  'sim.delve.litany.cantorsHoldNote': '頌詠者，穩住音！',
  'sim.delve.litany.blackwaterMark': '{boss} 以黑水標記了 {target}！',
  'sim.delve.litany.finalBell': '{boss} 敲響終末之鐘！',
  'sim.delve.litany.tollingBells': '{boss} 鳴響群鐘！',
  'sim.delve.litany.bellRopeSnaps': '鐘繩驟然繃緊。溺亡頌詠者被震得踉蹌。',
  'sim.delve.litany.eggSacBursts': '卵囊爆裂。蛛群沿著洗禮池邊緣四散爬開。',
  'sim.delve.litany.baptistryQuiet': '洗禮池歸於寂靜。蜘蛛卵囊濕黏地附在池緣上。',
  'sim.delve.litany.baptistryStirs': '漆黑的洗禮池水中有什麼在攪動。',
  'entities.mobs.deepfen_spearjaw.name': '深沼矛顎',
  'entities.mobs.mirefen_widowling.name': '泥沼寡婦幼蛛',
  'entities.mobs.reedbound_acolyte.name': '葦縛侍僧',
  'entities.mobs.drowned_cantor.name': '溺亡頌詠者',
  ...
  'entities.mobs.sister_nhalia_drowned_canticle.name': '娜莉婭修女',
  'entities.mobs.tolling_bell.name': '鳴響之鐘',
  'entities.delves.drowned_litany.name': '溺亡禱文',
  'entities.delves.drowned_litany.enterText': '你向下深入沼澤邊緣那座沉沒的神龕。',
  'entities.delves.drowned_litany.leaveText': '你爬回沼澤邊緣的哈爾文修士身邊。',
};
