...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    '好迪，朋友，又回瓶子這兒了啊，他今天挺安靜的，要嘛是聽得特別入神，要嘛就是乾脆不理我了，跟他處久了也說不准，說真的……對了空谷這陣子待你怎樣，好還是不好，你帶零食了沒，沒有？行吧就隨口一問，替朋友問問，那朋友就是我……',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    '老樣子啦，他要煙，要人照顧，要有人坐得近近的，讓這份安靜看起來像聊天，嘿，反正對我來說挺管用，我天天跟他唸叨，他一句都沒回過，呃，從來沒有，不過沒事，反正就這麼回事，綠掌級別的沒事……等等，咱們剛才聊到哪兒了……喔。對。說他呢。他挺好的。大概是餓了。同感。',
  'entities.npcs.brother_greenpaw.dialogNode.faith':
    '信不信是個大詞兒，朋友，我就是照顧照顧，照顧這事我這兩隻手能幹，還帶個打火機，履歷表上就這麼點東西……他到底聽沒聽我說不準，不過反正煙聞著挺香，波長這塊算是穩了。的確如此。',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    '沒事沒事，朋友，全都是賭局，從來都是，這是我心裡那個牛仔在說話……這種地方三不五時挨句重話也正常，我不裝作沒這回事……不過你回來道歉了，這就說明點什麼，或者說明你想要點什麼，反正咱倆兩清了，你我，波長一致，改天你想要零食我請。',
