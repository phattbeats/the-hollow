...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "wallet.holderTiers.tidelord.flavor": "潮水回應你的號令：供應量的 2%。",
  "wallet.holderTiers.stormcaller.name": "喚雷者",
  "wallet.holderTiers.stormcaller.flavor": "風暴因你的名字聚集：供應量的 3%。",
  ...
  "wallet.holderTiers.titanforged.flavor": "於泰坦之間鍛成：供應量的 5%。",
  "wallet.holderTiers.starhoard.name": "星藏者",
  "wallet.holderTiers.starhoard.flavor": "寶藏連星光也為之彎折：供應量的 6%。",
