...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.tutorial.doneBody": "你已掌握基礎，{name}。山谷任你探索——隨時按 {questKey} 查看任務。祝你狩獵順利！",
  "hud.tutorial.moveTitle": "邁出第一步",
  "hud.tutorial.moveBody": "使用 {moveKeys} 移動，用滑鼠環顧四周。先走幾步開始吧。",
  "hud.tutorial.seekTitle": "尋找鎮長",
  "hud.tutorial.seekBody": "雷德布魯克鎮長在鎮上等候，他有任務交給新人。跟隨指引前往找他。",
  "hud.tutorial.talkTitle": "接受任務",
  "hud.tutorial.talkBody": "靠近雷德布魯克鎮長並按 {interactKey} 與他交談，然後接受他的任務。",
  "hud.tutorial.slayTitle": "狼群來襲",
  "hud.tutorial.slayBody": "前往北路獵殺森林狼。選中一隻並發動攻擊，削減狼群。",
  "hud.tutorial.slayProgress": "已擊殺森林狼：{current} / {needed}",
  "hud.tutorial.returnTitle": "領取獎勵",
  "hud.tutorial.returnBody": "任務已完成。返回雷德布魯克鎮長處並按 {interactKey} 繳交任務。",
  "nav.account": "帳號",
