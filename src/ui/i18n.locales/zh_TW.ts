...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.statInfo.desc.int": "擴大施法者的法力池，並提升其造成法術爆擊的機率。",
  ...
  "hudChrome.statInfo.desc.critChance": "你的攻擊造成爆擊並施加雙倍傷害的機率。",
  ...
  "hudChrome.statInfo.effects.critPct": "+{value}% 爆擊",
  ...
  "hudChrome.statInfo.effects.spellCritPct": "+{value}% 法術爆擊",
  ...
  "hudChrome.statInfo.notes.dpsApprox": "此為估計值，不計入爆擊與技能傷害。",
