...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    'ハウディ、友よ、また壺のとこに戻ってきたか、あいつ今日は静かでな、めっちゃ真剣に聴いてるのか、それとも完全に無視されてるのか、わしにもさっぱりわからんのだよ、正直な話……そんでホロウの暮らしはどうだ、良かったか悪かったか、なんか食い物持ってないか、ないのか？まあいいさ、ただ聞いてみただけ、友のために聞いてる、その友ってのはわしなんだけどな……',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    'いつもどおりさ、あいつは煙が欲しい、世話が欲しい、そばに座って静けさを会話みたいに付き合ってくれる誰かが欲しい、ってことでな、まあ、それってわしにとっちゃ都合いいんだよ、わしはいつもあいつに話しかけてるし、あいつは一言も返してこないけどな、えーと、一回も、まあでもそれでいいのさ、だいたいそういうもんだ、グリーンポー基準でな……待て、何の話だったか……ああ。そうだ。あいつのことだ。あいつは元気さ。たぶん腹減ってる。同じく。',
  'entities.npcs.brother_greenpaw.dialogNode.faith':
    '信じるってのは大げさな言葉だぜ、友よ、わしはただ世話するだけさ、世話ならこの両手でできる、あとライターも一個、それがわしの経歴の全部だ……あいつが聴いてるかどうかなんてわしにゃわからんが、煙はどのみちいい匂いがするからな、波長は保ててるってことにしとこう。まったくだ。',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    'いいんだよ、友よ、全部は賭けさ、昔からずっとな、これはわしの中のカウボーイが言ってるんだが……こういう場所じゃたまにきつい言葉も飛ぶもんさ、それは否定せんよ……でもお前は戻ってきて謝ってくれた、それは何かの意味があるさ、それか何か欲しいものがあるかだな、どっちにしろこれでおあいこだ、お前とわし、波長も合ってるし、今度食い物欲しけりゃ奢るぜ。',
