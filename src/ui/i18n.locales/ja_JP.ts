...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'questUi.dialog.trainSecondary': '二手の職業を教えてください。',
  'questUi.dialog.trainSecondaryAria': '{name} に二手の職業を学ぶ',
  'questUi.dialog.trainerTitle': '副次職業',
  'questUi.dialog.trainerLevelLocked': 'レベル {level} で解放されます。',
  'questUi.dialog.trainerCurrent': '現在',
  'questUi.dialog.trainerFree': '無料',
  'questUi.dialog.trainerPickAria': '{cls} を副次に訓練する: {cost}',
  ...
  'entities.npcs.verger_zebediah.journalLines.3':
    '湖道を上ってきて花瓶の噂を耳にした旅人は、たいてい二つの結論のどちらかに行き着きますが、どちらもあまり褒めたものではございません。この一団をヒッピーだの変わり者だのと呼んで笑いながら去る者もあれば、もっと辛辣な言葉を残して立ち止まりもしない者もございます。ほとんどの者は花瓶のことなど耳にすらしませぬ。それこそがこの取り決めの本来の姿であろうと、近ごろは思うようになりました。静かなものは、名高いものより長く生き延びるものでございます。',
  ...
  'entities.npcs.gate_bard.greeting':
    '一曲、銅貨一枚でどう？いらない？いいのよ、たいていの日はいらないと言われる。私はこの門のために弾くけれど、門は一度も財布に手を伸ばしてくれたことがない。通りすがりの連中はここをヒッピーの溜まり場だの、もっとひどいことだの言うけれど、大抵はただの通りすがりだから、好きに言わせているわ。',
  ...
  'guide.hollowPage.outsiderHeading': '外の世界からはどう見られているか',
  'guide.hollowPage.outsiderBody':
    '聖域の門を出れば、花瓶のことを知る者などほとんどいない。知っている数少ない者たちも、その番人たちをヒッピーだの変わり者だの、もっと言えば壺に話しかける変人だのと片付けてしまう。それ以外に伝わる話といえば、もっと奇妙な目撃談ばかりだ。空き地から遠く離れてしまった信者や、いるはずのない場所で見つかった小さな緑の生き物の噂だ。',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    'ハウディ、友よ、また壺のとこに戻ってきたか、あいつ今日は静かでな、めっちゃ真剣に聴いてるのか、それとも完全に無視されてるのか、正直どっちも尊敬するぜ、わしの設定もその二つしかないからな……そんでホロウの暮らしはどうだ、良かったか悪かったか、なんか食い物持ってないか、ないのか？まあいいさ、ただ聞いてみただけ、友のために聞いてる、その友ってのはわしなんだけどな……',
  'entities.npcs.brother_greenpaw.dialogNode.warmed':
    '……うおっ、おお、それは言ってくれて嬉しいぜ、友よ、マジで嬉しい、予想外だったな、大抵の奴はさっさと門に向かうもんだからな……お前、なかなかやるじゃないか、知ってたか、グリーンポー基準でなかなかってやつだ、これはそう簡単にくれてやらんぞ……株ってもんを持ってたらお前の株を買うんだがな、新しい友を買って古い凶兆を売る、ただの経済ってやつさ……',
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    'いつもどおりさ、あいつは煙が欲しい、世話が欲しい、そばに座って静けさを会話みたいに付き合ってくれる誰かが欲しい、ってことでな……ん。それってだいたいの会話がそうじゃないか。うおっ。まあいい、とにかく、わしはいつもあいつに話しかけてるし、あいつは一言も返してこないけどな、えーと、一回も、まあでもそれでいいのさ、だいたいそういうもんだ、グリーンポー基準でな……待て、何の話だったか……ああ。そうだ。あいつのことだ。あいつは元気さ。たぶん腹減ってる。同じく。',
  'entities.npcs.brother_greenpaw.dialogNode.faith':
    '信じるってのは大げさな言葉だぜ、友よ、わしはただ世話するだけさ、世話ならこの両手でできる、あとライターも一個、それがわしの経歴の全部だ……あいつが聴いてるかどうかなんてわしにゃわからんが、煙はいい匂いがするし、わしを裁いたりもせん、耳の付いてる連中の大半より上等ってことさ、だから波長は保ててるってことにしとこう。まったくだ。',
  'entities.npcs.brother_greenpaw.dialogNode.stung':
    '……うっ、ああ、いてえな友よ、まったく……いや、まあそうかもな、わからんけど、寒い朝には自分でもそう思ったことあるさ、誰も小道を上ってこなくて、壺もため息すらつかん朝にな……でもわしはまだここにいるし、それって何かの証にはなるだろ？だろ。だな。ところで食い物いるか、わしは持ってるぞ、話題変えるぞ。F。',
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    'いいんだよ、友よ、全部は賭けさ、昔からずっとな、これはわしの中のカウボーイが言ってるんだが、賭けの意味はあいつに聞くなよ、あいつも知らん、ただ自信満々に言うだけだからな……こういう場所じゃたまにきつい言葉も飛ぶもんさ、それは否定せんよ……でもお前は戻ってきて謝ってくれた、それは何かの意味があるさ、それか何か欲しいものがあるかだな、どっちにしろこれでおあいこだ、お前とわし、波長も合ってるし、今度食い物欲しけりゃ奢るぜ。',
  'entities.npcs.brother_greenpaw.dialogNode.tribe':
    '昔はでっかい部族だったのさ、古い刻み跡がそう言ってる、まあわし字はあんまり読めんけど数は数えられるからな、あそこにゃ五つ刻みの跡がめっちゃたくさんあってな、消された跡が、片手で刻めるより絶対多いんだよ、この計算は無視できねえ……あいつの灯りを長いこと保ってたのさ、最後にはわし一人になるまでな。みんなどこ行ったかは知らん、友よ、マジで知らんのだ、波長で時々なんか感じることはあるけど、その感じが自分の話を最後まで言い終わらんのよ、だからわしも言い終わらん……でもこの灯芯はわしの見張り中は消えさせん。それだけは確かだぜ。',
  'entities.npcs.brother_greenpaw.dialogNode.confide':
    '……それは優しいこと言ってくれるな、友よ、マジで優しい……なあ、わしがお前に話すのは半分は壺が答えてくれんからで、もう半分は、怖いからさ、いつかこの小道を誰も上ってこなくなる夜が来るんじゃないかってな、そしたらわしとあいつと、この静けさだけになっちまう……だから。上ってきてくれてありがとうな。それが神聖ってやつさ、わしに言わせりゃな。……ところで。食い物持ってないか？壺のために聞いてるんだぜ。波長も腹減ってるからな。',
  'entities.npcs.brother_greenpaw.dialogChoice.kind':
    'だんだん気に入ってきたよ、緑掌。マジで、マジでそう思う。',
  'entities.npcs.brother_greenpaw.dialogChoice.ask': 'で、壺は最近何て言ってるんだ？',
  'entities.npcs.brother_greenpaw.dialogChoice.blunt':
    '番人つきの墓場ってだけさ、緑掌。それだけだ。',
  'entities.npcs.brother_greenpaw.dialogChoice.tribe':
    'その部族の話を聞かせてくれ、お前より前にいたっていう。',
  'entities.npcs.brother_greenpaw.dialogChoice.warm_bye':
    'じゃあ、あいつのとこに戻ってやってくれ。',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_more':
    'で、マジであいつが聴いてると思ってるのか？',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_bye': 'じゃあ、あいつに付き合ってやってくれ。',
  'entities.npcs.brother_greenpaw.dialogChoice.faith_bye': 'なるほどな、緑掌。',
  'entities.npcs.brother_greenpaw.dialogChoice.sorry':
    '思ってたよりきつい言い方になっちまった。ごめん、緑掌。',
  'entities.npcs.brother_greenpaw.dialogChoice.cold_bye': '好きに信じてればいいさ。',
  'entities.npcs.brother_greenpaw.dialogChoice.mended_bye': 'これでおあいこだ。またな、緑掌。',
  'entities.npcs.brother_greenpaw.dialogChoice.confide':
    'それを一人で背負う必要はないんだよ、兄者。',
  'entities.npcs.brother_greenpaw.dialogChoice.tribe_bye': 'まあ、まだ誰かが世話してるからな。',
  ...
  'sim.hearth.helpLine': '緑掌：/feed（甕のそばで、燃えるものか腹の足しになるものを持ってこい）。',
  'sim.hearth.morsel1': '……ああ、ありがとうよ。お前さんとその足で歩く大地に、恵みあれ。',
  'sim.hearth.morsel2': '腹の虫がしばし静かになったわ。えらい世話になったな……',
  'sim.hearth.morsel3': '良い糧は、良い友のようなもんじゃ……めったにない、探す価値のあるもんよ。',
  'sim.hearth.noItems1':
  ...
  'sim.house.helpLine':
    '住居：/house、/house claim、/house place <スロット> <種類>、/house remove <スロット>。',
  'sim.house.mustBeInHollow': '住居の手入れをするには空洞にいなければならない。',
  'sim.house.mustStandToClaim': '空洞の宅地に立たなければ、権利を主張できない。',
  'sim.house.noFreePlot': 'ここには空いている宅地がない。空き地の上に立ってから権利を主張せよ。',
  'sim.house.noHomestead': 'あなたは住居を持っていない。/house claim で一つ手に入れよう。',
  'sim.house.placed': 'スロット{slot}に{kind}を置いた。',
  'sim.house.plotTaken': 'その宅地には既に持ち主がいる。',
  'sim.house.readoutMine': 'あなたの住居：{plotId}。装飾：{decor}。',
  'sim.house.readoutNone':
    'あなたは住居を持っていない。空洞の空いている区画に立ち、/house claim と入力しよう。',
  'sim.house.readoutUsage': '/house place <1-{count}> <{kinds}>、/house remove <スロット>。',
  'sim.house.slotEmpty': 'そのスロットは既に空だ。',
  'sim.house.slotRange': 'スロットは1から{count}まで番号が振られている。',
  'sim.house.unknownKind': '不明な装飾の種類。種類：{kinds}。',
  ...
  'housingUi.prompt.manage': '住居を管理する',
  'housingUi.prompt.visit': '{name}の家を訪れる',
  'housingUi.window.title': 'あなたの住居',
  'housingUi.window.close': '住居を閉じる',
  'housingUi.window.slotEmpty': '空き',
  'housingUi.window.clear': 'クリア',
  'housingUi.window.clearAria': 'スロット{slot}をクリア',
  'housingUi.window.placeAria': 'スロット{slot}に{decor}を配置',
  'housingUi.window.hint': '各スロットに装飾を選んでください。',
  'housingUi.decor.planter': 'プランター',
  'housingUi.decor.lantern': 'ランタン',
  ...
  'coldOpen.begin': 'はじめる',
  'coldOpen.skip': 'スキップ',
  'apiError.crossSiteRejected': 'クロスサイトリクエストは拒否されました。',
  'apiError.notAuthenticated': '認証されていません。',
  'apiError.readOnlyToken': 'このトークンは読み取り専用です。',
  'apiError.characterNotFound': 'キャラクターが見つかりません。',
  'apiError.rateLimited': '試行回数が多すぎます。1分待ってから再試行してください。',
  ...
  'hudChrome.calendar.events.raidCall.note': '守人が角笛を鳴らす。パーティーを集め、レイドへ。',
  ...
  'hudChrome.calendar.events.delveDay.note': '仲間を連れて、崩落した聖遺物庫に挑む好日。',
  'hudChrome.calendar.events.moongateCommunion.title': '月門の集い',
  'hudChrome.calendar.events.moongateCommunion.note': '月半ばの月の下、巡礼者が月の聖域に集う。',
  ...
  'hudChrome.book.titleClear': '称号なし',
  'hudChrome.book.titleDisplay': '{display}',
  'hudChrome.book.titleActiveTag': '装備中',
  'hudChrome.book.titlePickAria': '称号 {display} を装備する',
  'hudChrome.book.titleRewardHint': 'この実績を達成すると称号を獲得できます。',
  'hudChrome.book.categoryEmpty': 'この分類にはまだ項目がありません。',
  'hudChrome.book.category.chronicle': '年代記',
  'hudChrome.book.category.collection': 'コレクション',
  'hudChrome.book.category.combat': '戦闘',
  'hudChrome.book.category.delve': '秘境',
  'hudChrome.book.category.dungeon': 'ダンジョン',
  'hudChrome.book.category.exploration': '探索',
  'hudChrome.book.category.feat': '偉業',
  'hudChrome.book.category.progression': '成長',
  'hudChrome.book.category.pvp': '対人戦',
  'hudChrome.book.category.social': '社交',
  'hudChrome.book.category.hidden': '隠し',
  ...
  'sim.delve.litany.cantorsHoldNote': '聖歌隊よ、音を保て！',
  'sim.delve.litany.blackwaterMark': '{boss}は{target}にブラックウォーターの印を刻んだ！',
  'sim.delve.litany.finalBell': '{boss}が終焉の鐘を放つ！',
  'sim.delve.litany.tollingBells': '{boss}が鐘を鳴らす！',
  'sim.delve.litany.bellRopeSnaps': '鐘の綱がぴんと張り詰める。溺れた聖歌者たちが衝撃によろめく。',
  'sim.delve.litany.eggSacBursts': '卵嚢が破裂した。子蜘蛛が洗礼堂の縁へ散っていく。',
  'sim.delve.litany.baptistryQuiet': '洗礼堂が静まり返る。蜘蛛の卵嚢が縁に湿ってへばりついている。',
  'sim.delve.litany.baptistryStirs': '黒い洗礼盤の水の中で何かが蠢いている。',
  'entities.mobs.deepfen_spearjaw.name': 'ディープフェンの槍顎',
  'entities.mobs.mirefen_widowling.name': 'マイアフェンの子ウィドウ',
  'entities.mobs.reedbound_acolyte.name': '葦縛りの侍祭',
  'entities.mobs.drowned_cantor.name': '溺れた聖歌者',
  'entities.mobs.grave_silt_bulwark.name': '墓泥の防壁',
  'entities.mobs.choir_thrall.name': '聖歌隊の下僕',
  'entities.mobs.sump_troll_devourer.name': '汚水トロルの喰らい手',
  'entities.mobs.spider_egg_sac.name': '蜘蛛の卵嚢',
  'entities.mobs.sister_nhalia_drowned_canticle.name': 'ナリア修道女',
  'entities.mobs.tolling_bell.name': '鳴り響く鐘',
  'entities.delves.drowned_litany.name': '溺れた連祷',
  'entities.delves.drowned_litany.enterText': 'あなたは湿地の縁にある水没した聖堂へと降りていく。',
  'entities.delves.drowned_litany.leaveText':
    'あなたは湿地の縁にいるハルヴェン修道士のもとへ登り返す。',
};
