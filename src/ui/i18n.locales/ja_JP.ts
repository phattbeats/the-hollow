...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    'よお、友よ、また壺のとこに戻ってきたか、あいつ今日は静かでな、めっちゃ真剣に聴いてるのか、それとも完全に無視されてるのか、わしにもさっぱりわからんのだよ、正直な話……そんでホロウの暮らしはどうだ、良かったか悪かったか、なんか食い物持ってないか、ないのか？まあいいさ、ただ聞いてみただけ、友のために聞いてる、その友ってのはわしなんだけどな……',
  'entities.npcs.brother_greenpaw.dialogNode.warmed':
    '……うおっ、おお、それは言ってくれて嬉しいぜ、友よ、マジで嬉しい、予想外だったな、大抵の奴はさっさと門に向かうもんだからな……お前、なかなかやるじゃないか、知ってたか、グリーンポー基準でなかなかってやつだ、これはそう簡単にくれてやらんぞ……',
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    'いつもどおりさ、あいつは煙が欲しい、世話が欲しい、そばに座って静けさを会話みたいに付き合ってくれる誰かが欲しい、ってことでな、まあ、それってわしにとっちゃ都合いいんだよ、わしはいつもあいつに話しかけてるし、あいつは一言も返してこないけどな、えーと、一回も、まあでもそれでいいのさ、だいたいそういうもんだ、グリーンポー基準でな……',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    'いいんだよ、友よ、マジで、こういう場所じゃたまにきつい言葉も飛ぶもんさ、それは否定せんよ……でもお前は戻ってきて謝ってくれた、それは何かの意味があるさ、それか何か欲しいものがあるかだな、どっちにしろこれでおあいこだ、お前とわし、波長も合ってるし、今度食い物欲しけりゃ奢るぜ。',
