...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.flint_amber_pick.name': 'Feuerstein-Bernsteinspitzhacke',
  'entities.items.bonewood_amber_pick.name': 'Knochenholz-Bernsteinspitzhacke',
  'entities.items.starleaf_amber_pick.name': 'Sternblatt-Bernsteinspitzhacke',
  'entities.items.flint_bark_axe.name': 'Feuerstein-Rindenaxt',
  'entities.items.bonewood_bark_axe.name': 'Knochenholz-Rindenaxt',
  'entities.items.starleaf_bark_axe.name': 'Sternblatt-Rindenaxt',
  'entities.items.flint_spore_sickle.name': 'Feuerstein-Sporensichel',
  'entities.items.bonewood_spore_sickle.name': 'Knochenholz-Sporensichel',
  'entities.items.starleaf_spore_sickle.name': 'Sternblatt-Sporensichel',
