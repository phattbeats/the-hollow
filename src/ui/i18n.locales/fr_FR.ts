...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.flint_amber_pick.name': 'Pic à ambre en silex',
  'entities.items.bonewood_amber_pick.name': "Pic à ambre en bois d'os",
  'entities.items.starleaf_amber_pick.name': "Pic à ambre en feuille d'étoile",
  'entities.items.flint_bark_axe.name': 'Hache à écorce en silex',
  'entities.items.bonewood_bark_axe.name': "Hache à écorce en bois d'os",
  'entities.items.starleaf_bark_axe.name': "Hache à écorce en feuille d'étoile",
  'entities.items.flint_spore_sickle.name': 'Faucille à spores en silex',
  'entities.items.bonewood_spore_sickle.name': "Faucille à spores en bois d'os",
  'entities.items.starleaf_spore_sickle.name': "Faucille à spores en feuille d'étoile",
