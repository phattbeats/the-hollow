...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    '어이, 친구, 또 항아리 곁으로 왔구먼, 오늘은 그 녀석이 조용해, 진짜 열심히 듣고 있는 건지 아니면 그냥 무시하는 건지, 도무지 모르겠단 말이지, 솔직히 말해서… 그나저나 할로우는 자네한테 어땠나, 좋았나 나빴나, 간식 좀 있나, 없어? 알았어 그냥 물어본 거야, 친구를 위해 물어보는 거지, 그 친구가 바로 나야…',
  'entities.npcs.brother_greenpaw.dialogNode.warmed':
    '…우와, 그거 진짜 좋은 말이네, 친구, 진짜 좋은 말이야, 예상 못 했는데, 대부분은 기회만 되면 바로 문 쪽으로 튀거든… 자네 꽤 괜찮은 사람이야, 알고 있나, 그린포 기준으로 괜찮은 거라고, 이거 아무한테나 그냥 주는 말 아니거든…',
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    '늘 똑같지, 그 녀석은 연기를 원하고, 보살핌을 원하고, 곁에 앉아서 이 고요를 대화처럼 느끼게 해줄 누군가를 원해, 뭐, 나한테는 그게 잘 통하거든, 나는 맨날 그 녀석한테 말 걸고 있고 그 녀석은 한 번도 대답 안 했지, 어, 한 번도, 근데 뭐 괜찮아, 대충 그런 거야, 그린포 기준으로 괜찮은 거지…',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    '괜찮아, 친구, 진짜로, 이런 곳은 가끔 모진 말 한마디쯤 나올 만하지, 아니라고는 안 할게… 근데 자네는 돌아와서 미안하다고 했잖아, 그건 뭔가 의미가 있는 거야, 아니면 뭔가 원하는 게 있다는 거고, 어느 쪽이든 우리 이제 셈은 끝났어, 자네랑 나 말이야, 파장도 맞고, 나중에 간식 필요하면 내가 살게.',
