...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_brightwood_monarch.completion':
    '그래, 늙은 왕이 쓰러졌군. 무거운 일이지 - 허나 늑대들의 손에 죽는 것보다는 자비로운 최후였네. 그의 뿔로 만든 이 왕관을 경의를 담아 쓰게, {playerName}.',
  'entities.quests.q_brightwood_monarch.objectives.0.label': '군주의 심장',
  'entities.quests.q_brightwood_monarch.text':
    '나 홀로 화살을 겨누지 않을 짐승이 하나 있네. 바로 브라이트우드의 군주, 깊은 숲을 다스리는 거대한 수사슴이지. 그는 늙고 사나워져, 자기 둥지에 다가오는 자는 누구든 뿔로 들이받는다네. 사냥꾼 하나로는 감당하기 벅차니 - 친구를 한둘 데려가게. 그를 잠재우고 심장을 가져오게, {playerName}.',
  'entities.quests.q_brightwood_monarch.title': '브라이트우드의 군주',
  'entities.quests.q_brightwood_thinning.completion':
    '좋아. 무리가 솎아졌고 이 가죽들도 멀쩡하군 - 숲은 한 철 더 버틸 걸세.',
  ...
  'entities.quests.q_brightwood_thinning.text':
    '브라이트우드 숲이 들끓고 있네, {playerName}. 가시덤불 살쾡이는 내가 솎아내는 속도보다 빨리 번식하고, 무리는 얼마 남지 않은 풀밭마저 짓밟고 있어. 가시덤불 살쾡이 8마리를 처치하고 숲속 가죽 6장을 가져오게. 나머지 무리의 상태를 가늠해 보겠네.',
  'entities.quests.q_brightwood_thinning.title': '숲 솎아내기',
  'entities.quests.q_ledger_brood.completion':
    '둥지를 물에 잠기게 하는 건 참혹한 일이지. 허나 지금의 자비가 훗날 백 번의 장례를 면하게 하네. 장부는 청산되었네.',
  'entities.quests.q_ledger_brood.objectives.0.label': '짓밟은 검은그물 새끼',
  'entities.quests.q_ledger_brood.text':
    '잠복자들을 처치한 것이 오히려 새끼들에게 자리를 내주었군. 검은그물 새끼들이 깊은 둥지에서 쏟아져 나오고 있어, 작은 송곳니 백 개도 큰 것 하나만큼이나 여행자의 목숨을 앗아간다네. 검은그물 새끼 8마리를 다 자라기 전에 짓밟게.',
  'entities.quests.q_ledger_brood.title': '들끓는 어둠',
  'entities.quests.q_ledger_deepvermin.completion':
    '촛불머리 해충 열두 마리가 사라졌군! 좋아, 친구들 - 갱도로 돌아가지. 자네가 보안관께 좋은 평을 얻게 했네, {playerName}.',
  'entities.quests.q_ledger_deepvermin.objectives.0.label': '처치한 굴쥐 채굴꾼',
  'entities.quests.q_ledger_deepvermin.text':
    '보안관 장부에 자네가 해충을 처리한다고 적혀 있더군. 그래, 내 갱도에 가장 지독한 놈들이 있네. 굴쥐들이 내 인부들이 곡괭이를 휘두르는 속도보다 빨리 번식하니 - 굴쥐 채굴꾼 12마리를 잡아주게. 그러면 겨울이 오기 전에 구리를 캘 수 있을지도 모르지.',
  'entities.quests.q_ledger_deepvermin.title': '깊은 곳의 해충',
  'entities.quests.q_ledger_first_duty.completion':
    '굴 여덟 개를 비우고 숲 바닥도 다시 가라앉았군. 좋아. 이 장부에 적힌 모든 이름이 바로 지금 자네가 선 자리에서 시작했다네.',
  'entities.quests.q_ledger_first_duty.objectives.0.label': '솎아낸 가시털 오소리',
  'entities.quests.q_ledger_first_duty.text':
    '이스트브룩에서 밥값을 하고 싶은가, {playerName}? 그렇다면 모든 수호인이 시작하는 곳에서 시작하게. 가시털 오소리들이 늑대길을 지나 저 북쪽 끝, 브라이트우드 숲 한복판까지 굴을 파 놓아서, 숲 바닥이 그 굴 속으로 내려앉고 있네. 가시털 오소리 8마리를 솎아내면 장부가 자네의 이름을 기억할 걸세.',
  'entities.quests.q_ledger_first_duty.title': '수호인의 첫 임무',
  'entities.quests.q_ledger_great_boar.completion':
    '늙은 뻣센등뼈가 자네 손에 죽다니! 그 가죽 하나만으로도 한 철 장사 거리는 되지. 자네는 장부를 자랑스럽게 했네, {playerName}.',
  ...
  'entities.quests.q_ledger_great_boar.text':
    '서쪽 덤불에 늙은 황소 멧돼지가 한 마리 있네 - 늙은 뻣센등뼈라고, 가죽은 나무껍질 같고 성질도 그에 못지않지. 내 가죽 사냥꾼 둘을 뿔로 들이받았네. 그놈을 쓰러뜨리고 그 뒤에 숨은 하급 야생 멧돼지 6마리를 처리하면, 자네 이름을 장부 높은 곳에 새겨주겠네.',
  'entities.quests.q_ledger_great_boar.title': '거대한 뻣센등뼈',
  'entities.quests.q_ledger_outlaw_captain.completion':
    '베를란 대장이 죽고, 그의 외투가 내 문 앞에 당도했군. 장부가 닫혔네, {playerName} - 그리고 골짜기는 그것을 닫은 자의 이름을 앞으로 올 수호인들에게 전할 걸세.',
  ...
  'entities.quests.q_ledger_outlaw_captain.text':
    '장부의 마지막 이름은 내가 일 년 동안 지우고 싶었던 자라네. 골짜기의 절반을 산적질로 몰아넣은 베를란 대장이지. 그는 남동쪽 야영지에서 부관들 뒤에 숨어 있네. 계곡 도적 6명을 베고 그에게 다가가, 베를란을 끝장내게. 혼자 가지는 말게.',
  'entities.quests.q_ledger_outlaw_captain.title': '무법자 대장',
  'entities.quests.q_ledger_reedwater.completion':
    '그 정도면 한 철은 그 긴 다리 도둑들을 내 그물에서 떼어놓겠지. 보안관께 얕은 물이 다시 내 것이 됐다고 전하게.',
  'entities.quests.q_ledger_reedwater.objectives.0.label': '쫓아낸 초원 두루미',
  'entities.quests.q_ledger_reedwater.text':
    '레드브룩이 자네를 보냈나? 좋아 - 이 늙은 뼈로는 더 이상 얕은 물을 헤칠 수가 없네. 초원 두루미들이 내 그물을 발견하고는, 진흙지느러미가 그랬던 것보다도 더 많이 내 어획물을 부리로 꿰어가고 있어. 그놈들의 수를 줄여주게. 초원 두루미 8마리를, 그리고 깊은 물을 조심하게.',
  'entities.quests.q_ledger_reedwater.title': '갈대 물가 순찰',
  'entities.quests.q_ledger_silk.completion':
    '자네 덕분에 밭이 아직은 회복할 수 있겠군. 모진 자비지 - 허나 열에 시달리는 아이에게는 사슴이 숲을 필요로 하는 것보다 약초가 더 절실하다네. 장부가 정리됐네.',
  'entities.quests.q_ledger_silk.objectives.0.label': '솎아낸 점박이 새끼사슴',
  'entities.quests.q_ledger_silk.text':
    '장부는 동쪽 숲도 수호인의 땅으로 표시해 두었네 - 내 약초밭도 그 일부지. 점박이 새끼사슴들이 내 은빛잎과 핏빛엉겅퀴를 뿌리째 뜯어먹어버렸어. 그 약초들이 없으면 이스트브룩 절반이 약을 구하지 못한다네. 마음이 편치는 않지만, 가을 약초를 완전히 잃기 전에 점박이 새끼사슴 8마리를 솎아내게.',
  'entities.quests.q_ledger_silk.title': '풀과 가시덤불',
  'entities.quests.q_ledger_teeth.completion':
    '여우 열 마리라, 황혼이 와도 닭장이 다시 조용하군. 장부가 자네에게 더 너그러워지네.',
  'entities.quests.q_ledger_teeth.objectives.0.label': '처치한 숲속 빈터 여우',
  'entities.quests.q_ledger_teeth.text':
    '숲속 빈터의 여우들이 늑대만큼이나 대담해졌네 - 황혼이면 닭장에 슬그머니 들어왔다가 등불을 켜기도 전에 사라지지. 굶주린 암여우는 닭은 물론이고 새끼 양까지 물어간다네. 그놈들의 수를 줄여주게, {playerName}. 숲속 빈터 여우 10마리를 처치해 나머지가 다시 빛을 두려워하도록 만들게.',
  'entities.quests.q_ledger_teeth.title': '어둠 속의 송곳니',
  'entities.quests.q_ledger_toll.completion':
    '짐승 여덟이 길에서 사라지니 수레가 다시 굴러가는군. 교역로에 새 파수꾼이 생겼다는 소문이 벌써 퍼지고 있네. 장부가 자네에게 유리하게 올라가는군.',
  'entities.quests.q_ledger_toll.objectives.0.label': '처치한 숲엄니 멧돼지',
  'entities.quests.q_ledger_toll.text':
    '숲엄니 멧돼지들이 빛숲에서 내려와 남동쪽 교역로로 몰려들었네 - 엄니로 짐 끄는 황소를 들이받고, 쏟아진 곡식을 노리고 수레를 뒤엎는 거대한 짐승들이지. 장부에는 그놈들 하나하나에 현상금이 걸려 있네. 길을 다시 여게. 숲엄니 멧돼지 8마리를 쓰러뜨리게.',
  'entities.quests.q_ledger_toll.title': '엄니의 길',
  'entities.quests.q_ledger_vigil.completion':
    '열 영혼이 대지로 돌아가고, 예배당에 하룻밤의 평안을 사들였군. 장부가 잊더라도, 빛은 이런 불침번을 기억한다네.',
  'entities.quests.q_ledger_vigil.objectives.0.label': '잠재운 불안한 뼈무더기',
  'entities.quests.q_ledger_vigil.text':
    '보안관은 칼만으로는 닿지 못하는 곤경이 생기면 수호인들을 내게 보내네. 예배당의 죽은 자들이 가만히 누워 있지 않는데, 나는 너무 늙어 밤샘 불침번을 설 수가 없어. 나를 위해 그것을 지켜주게, {playerName} - 불안한 뼈무더기 10구를 다시 안식으로 돌려보내게.',
