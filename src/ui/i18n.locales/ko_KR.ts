...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'questUi.dialog.trainSecondary': '보조 직업 하나를 가르쳐 주세요.',
  'questUi.dialog.trainSecondaryAria': '{name}에게 보조 직업을 배웁니다',
  'questUi.dialog.trainerTitle': '보조 직업',
  'questUi.dialog.trainerLevelLocked': '레벨 {level}에 해제됩니다.',
  'questUi.dialog.trainerCurrent': '현재',
  'questUi.dialog.trainerFree': '무료',
  'questUi.dialog.trainerPickAria': '{cls} 보조 직업 훈련: {cost}',
  ...
  'entities.npcs.verger_zebediah.journalLines.3':
    '호숫가 길을 따라 올라와 화병에 대해 듣게 되는 여행자들은 대개 두 가지 결론 중 하나에 다다르는데, 둘 다 그다지 좋은 말은 아니오. 어떤 이들은 이 신도들을 히피니 괴짜니 부르며 웃고 지나가고, 또 어떤 이들은 더 심한 말을 남기고 웃지도 않고 떠나오. 대부분은 화병에 대해 아예 들어 본 적조차 없는데, 그것이야말로 이 안배가 제대로 작동하고 있다는 뜻이라고 나는 점점 생각하게 되었소. 조용한 것이 유명한 것보다 오래 살아남는 법이오.',
  ...
  'entities.npcs.gate_bard.greeting':
    '노래 한 곡에 동전 한 닢? 싫다고요? 괜찮아요, 대개는 싫다고들 하죠. 나는 이 문을 위해 연주하지만, 문은 단 한 번도 지갑에 손을 댄 적이 없어요. 지나가는 사람들은 여기를 히피 캠프라고, 심지어 더 심하게 부르기도 하지만, 어차피 대부분 그냥 지나가는 사람들이니 그냥 그러라고 둬요.',
  ...
  'entities.quests.q_root_hollow_boars.completion':
    '다섯. 세고, 날짜를 매기고, 장부에 적었소. 뿌리굴은 이제 제 철에서 겨우 두 주 뒤처졌을 뿐, 이 직분에선 이걸 대승이라 부르오. 지금으로선 나 하나 남은 교단을 대신해, 감사드리오.',
  'entities.quests.q_root_hollow_boars.objectives.0.label': '야생 멧돼지 처치',
  'entities.quests.q_root_hollow_boars_ii.title': '뿌리굴의 결산',
  ...
  'entities.quests.q_fallow_acres_wolves.text':
    '누군가 묵정밭에 집을 지으려는 모양이오. 좋은 일이지. 사람이 산 땅은 그렇지 않은 땅보다 기억을 잘하는 법인데, 이 언저리는 너무 많은 걸 잊었소. 허나 늑대가 밤을 부리는 한 무엇도 자리 잡지 못하오. 무리를 다섯 마리까지 솎아주면, 그 걸음값은 반드시 치르리다. 갚는 것, 그게 이제 내게 남은 쓸모의 거의 전부요.',
  'entities.quests.q_fallow_acres_wolves.completion':
    '조용해졌군. 좋소. 나는 한때 사람들로 떠들썩했던 조용한 곳에 숱하게 서 있어 봤소. 이곳은 그 반대의 길을 갈 여지가 있소. 고맙소, 가는 길 조심하시오.',
  'entities.quests.q_fallow_acres_wolves.objectives.0.label': '숲늑대 처치',
  'entities.quests.q_fallow_acres_wolves_ii.title': '마지막 무리',
  'entities.quests.q_fallow_acres_wolves_ii.text':
    '가장자리는 성겨졌지만 굴은 아니오. 여덟만 더 잡으면, 묵정밭은 밤사이 지붕 아래 잠든 이를 잃지 않고도 집을 이고 살 수 있소. 내가 직접 돌보고 싶다만, 나는 한자리에 두 번 있는 일이 드물고, 게다가 사당 아래의 땅이 이 이랑보다 더 지킴을 필요로 하오.',
  'entities.quests.q_fallow_acres_wolves_ii.completion':
    '됐소. 조용한 밤 하나, 그 뒤로 아마 백 개의 밤이 이어지겠지. 잘 지으시오. 그리고 혹여 언젠가 깊이 파 내려가 저 아래에서 무언가 느릿느릿 박자를 맞추는 소리를 듣더라도, 답하지 마시오. 그건 내가 지킬 몫이고, 그 열쇠는 내가 지녔소. 자, 이만 가보시오.',
  'entities.quests.q_fallow_acres_wolves_ii.objectives.0.label': '숲늑대 처치',
  ...
  'entities.items.flint_amber_pick.name': '부싯돌 호박 곡괭이',
  'entities.items.bonewood_amber_pick.name': '뼈나무 호박 곡괭이',
  'entities.items.starleaf_amber_pick.name': '별잎 호박 곡괭이',
  'entities.items.flint_bark_axe.name': '부싯돌 나무껍질 도끼',
  'entities.items.bonewood_bark_axe.name': '뼈나무 나무껍질 도끼',
  'entities.items.starleaf_bark_axe.name': '별잎 나무껍질 도끼',
  'entities.items.flint_spore_sickle.name': '부싯돌 포자 낫',
  'entities.items.bonewood_spore_sickle.name': '뼈나무 포자 낫',
  'entities.items.starleaf_spore_sickle.name': '별잎 포자 낫',
  ...
  'yumi.queue.join':
    '프로텍트 유미 대기열에 참가했습니다. 당신의 사역마를 지키고 적의 사역마를 사냥하세요…',
  'yumi.log.welcome': '프로텍트 유미! 당신의 사역마를 지키고 적의 사역마를 사냥하세요.',
  ...
  'guide.hollowPage.outsiderHeading': '바깥세상이 이곳을 보는 시선',
  'guide.hollowPage.outsiderBody':
    '성역의 문 너머에서는 대부분의 사람들이 화병의 존재조차 들어본 적이 없다. 들어본 소수도 그 수호자들을 히피니, 괴짜니, 심하면 항아리에게 말을 거는 별종이니 하며 치부해 버린다. 그 밖에 흘러나오는 이야기는 더 기이한 목격담뿐이다. 공터에서 너무 멀리 벗어난 신도, 혹은 있어서는 안 될 곳에서 발견된 작은 초록빛 생물에 관한 소문이다.',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    '하우디, 친구, 또 항아리 곁으로 왔구먼, 오늘은 그 녀석이 조용해, 진짜 열심히 듣고 있는 건지 아니면 그냥 무시하는 건지, 솔직히 둘 다 존경해, 나도 설정이 그 두 개뿐이거든… 그나저나 할로우는 자네한테 어땠나, 좋았나 나빴나, 간식 좀 있나, 없어? 알았어 그냥 물어본 거야, 친구를 위해 물어보는 거지, 그 친구가 바로 나야…',
  'entities.npcs.brother_greenpaw.dialogNode.warmed':
    '…우와, 그거 진짜 좋은 말이네, 친구, 진짜 좋은 말이야, 예상 못 했는데, 대부분은 기회만 되면 바로 문 쪽으로 튀거든… 자네 꽤 괜찮은 사람이야, 알고 있나, 그린포 기준으로 괜찮은 거라고, 이거 아무한테나 그냥 주는 말 아니거든… 주식이란 게 있었으면 자네 주식을 샀을 텐데, 새 친구는 사고 오래된 징조는 팔고, 그게 그냥 경제라는 거지…',
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    '늘 똑같지, 그 녀석은 연기를 원하고, 보살핌을 원하고, 곁에 앉아서 이 고요를 대화처럼 느끼게 해줄 누군가를 원해… 어. 그거 대부분의 대화가 그렇잖아. 우와. 그래, 아무튼, 나는 맨날 그 녀석한테 말 걸고 있고 그 녀석은 한 번도 대답 안 했지, 어, 한 번도, 근데 뭐 괜찮아, 대충 그런 거야, 그린포 기준으로 괜찮은 거지… 잠깐, 우리 무슨 얘기 하고 있었지… 아. 맞다. 그 녀석 얘기. 걘 괜찮아. 아마 배고플 거야. 동감.',
  'entities.npcs.brother_greenpaw.dialogNode.faith':
    '믿는다는 건 거창한 말이야, 친구, 난 그냥 돌보는 거야, 돌보는 건 이 두 손으로 할 수 있는 일이니까, 라이터 하나 있고, 이력서에 그게 다야… 그 녀석이 듣고 있는지 아닌지는 나도 몰라, 근데 연기는 향기롭고 나를 판단하지도 않으니까, 귀 달린 것들 대부분보다 낫지, 그러니 파장은 어떻게든 맞춰지는 거지. 그렇고말고.',
  'entities.npcs.brother_greenpaw.dialogNode.stung':
    '…아야, 그래 알았어, 아프네 친구, 이런… 그럴 수도 있지, 나도 모르겠어, 진짜 추운 아침이면 나도 그런 생각 든다고, 아무도 이 길을 안 올라오고 항아리는 한숨도 안 쉴 때 말이야… 근데 나는 여전히 여기 있잖아, 그럼 그게 뭔가 의미가 있는 거 아니겠어? 맞지? 맞아. 아 그건 그렇고 간식 줄까, 나 간식 있어, 화제 전환. F.',
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    '괜찮아, 친구, 다 도박이야, 원래부터 그랬어, 내 안의 카우보이가 하는 말인데, 걔한테 도박이 무슨 뜻이냐고 묻지는 마, 걔도 몰라, 그냥 엄청 자신 있게 말할 뿐이야… 이런 곳은 가끔 모진 말 한마디쯤 나올 만하지, 아니라고는 안 할게… 근데 자네는 돌아와서 미안하다고 했잖아, 그건 뭔가 의미가 있는 거야, 아니면 뭔가 원하는 게 있다는 거고, 어느 쪽이든 우리 이제 셈은 끝났어, 자네랑 나 말이야, 파장도 맞고, 나중에 간식 필요하면 내가 살게.',
  'entities.npcs.brother_greenpaw.dialogNode.tribe':
    '옛날엔 큰 부족이었대, 오래된 표식들이 그렇게 말하더라고, 뭐 나는 글은 잘 못 읽지만 숫자는 셀 줄 알거든, 저 밑에 다섯씩 그은 눈금이 엄청 많이 새겨져 있어, 지운 자국들이, 한 사람 손으로 만들 수 있는 것보다 훨씬 많아, 그 계산은 나도 피할 수가 없다고… 오랫동안 그 녀석 불을 밝혀뒀지, 결국 나 혼자 남을 때까지 말이야. 다들 어디로 갔는지는 몰라, 친구, 진짜 몰라, 가끔 파장으로 뭔가 느껴지긴 하는데, 그 느낌이 자기 말을 끝까지 못 맺어, 그래서 나도 못 맺겠어… 근데 이 심지는 내가 지키는 동안엔 못 꺼져. 그건 확실히 알아.',
  'entities.npcs.brother_greenpaw.dialogNode.confide':
    '…그거 참 친절한 말이네, 친구, 진짜 친절해… 있잖아, 내가 자네한테 말하는 건 절반은 항아리가 대답을 안 해서고, 절반은 무섭기 때문이야, 어떤 밤엔, 아무도 다시는 이 길을 안 올라올까 봐, 그럼 나랑 그 녀석이랑 이 고요만 남을까 봐… 그러니까. 올라와 줘서 고마워. 그게 바로 신성한 부분이야, 내가 보기엔 말이지. …아 그건 그렇고. 간식 좀 있나? 항아리 대신 물어보는 거야. 파장도 배고프거든.',
  'entities.npcs.brother_greenpaw.dialogChoice.kind':
    '여기가 점점 마음에 들어요, 그린포. 진짜로, 진짜 진심이에요.',
  'entities.npcs.brother_greenpaw.dialogChoice.ask': '그래서 요즘 항아리가 뭐라고 하던가요?',
  'entities.npcs.brother_greenpaw.dialogChoice.blunt':
    '마스코트 딸린 무덤가일 뿐이잖아요, 그린포. 그게 다예요.',
  'entities.npcs.brother_greenpaw.dialogChoice.tribe':
    '그 부족 이야기 좀 들려주세요, 당신 전에 있었다는 그 부족이요.',
  'entities.npcs.brother_greenpaw.dialogChoice.warm_bye': '그럼 그 녀석 곁으로 돌아가시게 둘게요.',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_more':
    '그래서 진짜로 그가 듣고 있다고 믿으세요?',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_bye': '그럼 그 녀석 곁을 지켜 주세요.',
  'entities.npcs.brother_greenpaw.dialogChoice.faith_bye': '그럴 만하네요, 그린포.',
  'entities.npcs.brother_greenpaw.dialogChoice.sorry':
    '본심보다 심하게 말이 나왔어요. 미안해요, 그린포.',
  'entities.npcs.brother_greenpaw.dialogChoice.cold_bye': '믿고 싶은 대로 믿으세요.',
  'entities.npcs.brother_greenpaw.dialogChoice.mended_bye': '우리 셈은 끝났어요. 또 봬요, 그린포.',
  'entities.npcs.brother_greenpaw.dialogChoice.confide': '그걸 혼자 짊어질 필요는 없어요, 형님.',
  'entities.npcs.brother_greenpaw.dialogChoice.tribe_bye': '그래도 아직 누군가 돌보고 있잖아요.',
  'entities.npcs.brother_greenpaw.dialogChoice.confide_bye':
    '앞으로도 이 길을 계속 올라올게요, 그린포.',
  ...
  'sim.hearth.helpLine': '그린포우: /feed (항아리 근처에서 태울 것이나 배 채울 것을 가져오라).',
  'sim.hearth.morsel1': '……오, 고맙네, 친구. 자네와 자네가 딛고 선 이 땅에 축복이 있기를.',
  'sim.hearth.morsel2': '배 속이 잠시 노래를 그치는군. 참으로 고맙네…',
  'sim.hearth.morsel3': '좋은 한입은 좋은 친구와 같지… 귀하고, 먼 길을 올 가치가 있다네.',
  'sim.hearth.noItems1':
    '……친구, 빈손이구먼. 태울 것이든 배 채울 것이든 좀 가져오게, 그럼 얘기해보세.',
  'sim.hearth.noItems2':
  ...
  'sim.house.helpLine':
    '주택: /house, /house claim, /house place <슬롯> <종류>, /house remove <슬롯>.',
  'sim.house.mustBeInHollow': '주택을 관리하려면 공동에 있어야 한다.',
  'sim.house.mustStandToClaim': '공동의 주택지에 서 있어야 소유권을 주장할 수 있다.',
  'sim.house.noFreePlot': '여기에는 빈 주택지가 없다. 빈 땅 위에 서서 소유권을 주장하라.',
  'sim.house.noHomestead': '당신은 주택이 없다. /house claim으로 하나 얻으라.',
  'sim.house.placed': '슬롯 {slot}에 {kind}을(를) 배치했다.',
  'sim.house.plotTaken': '그 주택지에는 이미 주인이 있다.',
  'sim.house.readoutMine': '당신의 주택: {plotId}. 장식: {decor}.',
  'sim.house.readoutNone': '당신은 주택이 없다. 공동의 빈 구역에 서서 /house claim을 입력하라.',
  'sim.house.readoutUsage': '/house place <1-{count}> <{kinds}>, /house remove <슬롯>.',
  'sim.house.slotEmpty': '그 슬롯은 이미 비어 있다.',
  'sim.house.slotRange': '슬롯 번호는 1부터 {count}까지다.',
  'sim.house.unknownKind': '알 수 없는 장식 종류. 종류: {kinds}.',
  ...
  'housingUi.prompt.manage': '보금자리 관리하기',
  'housingUi.prompt.visit': '{name}의 집 방문하기',
  'housingUi.window.title': '나의 보금자리',
  'housingUi.window.close': '보금자리 닫기',
  'housingUi.window.slotEmpty': '비어 있음',
  'housingUi.window.clear': '비우기',
  'housingUi.window.clearAria': '슬롯 {slot} 비우기',
  'housingUi.window.placeAria': '슬롯 {slot}에 {decor} 배치',
  'housingUi.window.hint': '각 슬롯에 배치할 장식을 선택하세요.',
  'housingUi.decor.planter': '화분',
  'housingUi.decor.lantern': '랜턴',
  ...
  'coldOpen.begin': '시작',
  'coldOpen.skip': '건너뛰기',
  'apiError.crossSiteRejected': '교차 사이트 요청이 거부되었습니다.',
  'apiError.notAuthenticated': '인증되지 않았습니다.',
  'apiError.readOnlyToken': '이 토큰은 읽기 전용입니다.',
  'apiError.characterNotFound': '캐릭터를 찾을 수 없습니다.',
  'apiError.rateLimited': '시도가 너무 많습니다. 1분 후 다시 시도하세요.',
  'mailUi.title': '레이븐포스트',
  ...
  'hudChrome.calendar.events.raidCall.note': '수비대가 뿔피리를 붑니다. 파티를 모아 공격대로.',
  ...
  'hudChrome.gathering.amber': '호박',
  'hudChrome.gathering.heartwood': '심재',
  ...
  'hudChrome.book.titleClear': '칭호 없음',
  'hudChrome.book.titleDisplay': '{display}',
  'hudChrome.book.titleActiveTag': '장착 중',
  'hudChrome.book.titlePickAria': '칭호 {display} 장착',
  'hudChrome.book.titleRewardHint': '이 업적을 완료하면 칭호를 받습니다.',
  'hudChrome.book.categoryEmpty': '이 분류에는 아직 항목이 없습니다.',
  'hudChrome.book.category.chronicle': '연대기',
  'hudChrome.book.category.collection': '수집',
  'hudChrome.book.category.combat': '전투',
  'hudChrome.book.category.delve': '비경',
  'hudChrome.book.category.dungeon': '던전',
  'hudChrome.book.category.exploration': '탐험',
  'hudChrome.book.category.feat': '위업',
  'hudChrome.book.category.progression': '성장',
  'hudChrome.book.category.pvp': 'PvP',
  'hudChrome.book.category.social': '사회',
  'hudChrome.book.category.hidden': '숨겨진',
  'hudChrome.titleTracker.unspent': '신규 +{count}',
  'hudChrome.titleTracker.ariaLabel': '현재 칭호: {display}',
  'hudChrome.hitRating.ratingLabel': '적중 레이팅',
  'hudChrome.dungeonFinder.title': '던전 찾기',
  'hudChrome.dungeonFinder.close': '닫기',
  'hudChrome.dungeonFinder.offlineNote': '던전 찾기는 오프라인에서 사용할 수 없습니다.',
  'hudChrome.dungeonFinder.roleTank': '탱커',
  'hudChrome.dungeonFinder.roleHealer': '힐러',
  'hudChrome.dungeonFinder.roleDps': '딜러',
  'hudChrome.dungeonFinder.queueButton': '대기열 등록',
  'hudChrome.dungeonFinder.leaveButton': '대기열 나가기',
  'hudChrome.dungeonFinder.idleHint': '{dungeon}에 참가할 역할을 선택하세요.',
  'hudChrome.dungeonFinder.queuedStatus': '{role}로 {dungeon} 대기 중 ({position}번째)',
  'sim.dungeonFinder.cannotQueueDead': '사망 상태에서는 던전 찾기에 등록할 수 없습니다.',
  'sim.dungeonFinder.dungeonUnavailable': '해당 던전은 아직 던전 찾기에서 이용할 수 없습니다.',
  'sim.dungeonFinder.roleUnavailable': '당신의 직업은 해당 역할로 등록할 수 없습니다.',
  'sim.dungeonFinder.leaveParty': '던전 찾기에 등록하려면 먼저 파티에서 나가세요.',
  'sim.dungeonFinder.cannotQueueDueling': '결투 중에는 던전 찾기에 등록할 수 없습니다.',
  'sim.dungeonFinder.finishTrade': '던전 찾기에 등록하려면 먼저 거래를 마치세요.',
  'sim.dungeonFinder.cannotQueueInstance': '인스턴스 안에서는 던전 찾기에 등록할 수 없습니다.',
  'sim.dungeonFinder.joined':
    '{role} 역할로 던전 찾기에 등록했습니다. 그룹 결성을 기다려 주세요...',
  'sim.dungeonFinder.left': '던전 찾기 대기열에서 나갔습니다.',
  'sim.dungeonFinder.ready': '던전 찾기 그룹이 준비되었습니다: {dungeon}!',
  'sim.dungeonFinder.removed': '던전 찾기 대기열에서 제외되었습니다.',
  ...
  'editor.viewport.assetsFailed': '3D 뷰포트를 불러올 수 없습니다: {error}',
  'editor.appTitle': '맵 에디터',
  'editor.docTitle': '맵 에디터 - World of ClaudeCraft',
  'editor.untitledMap': '제목 없는 맵',
  'editor.playtestPlayerName': '맵 제작자',
  'editor.topbar.label': '에디터 작업',
  ...
  'editor.topbar.saveTitle': '이 브라우저에 저장하고, 로그인 시 서버에도 저장(Ctrl+S)',
  'editor.topbar.saveAsTitle': '새 이름으로 사본 저장',
  'editor.topbar.forkTitle': '이 맵의 서버 측 개인 사본 만들기',
  ...
  'editor.topbar.uploadAssetTitle': 'GLB 모델(최대 8MiB)을 업로드하여 맵에 배치',
  'editor.topbar.uploadAssetDisabledTitle': '에셋을 업로드하려면 게임에서 로그인하세요',
  'editor.topbar.playtest': '플레이테스트',
  'editor.topbar.playtestTitle': '이 맵으로 게임 실행(오프라인, 현재 편집 내용 포함)',
  'editor.topbar.viewLabel': '보기 모드',
  'editor.topbar.view3dTitle': '렌더링된 월드에서 편집',
  'editor.topbar.view2dTitle': '기호화된 상공 맵에서 편집',
  'editor.topbar.undoCountTitle':
    '실행 취소 가능한 단계 {count}개(Ctrl+Z로 실행 취소, Ctrl+Y로 다시 실행)',
  'editor.topbar.autosave': '자동 저장',
  'editor.topbar.autosaveTitle':
    '저장하지 않은 변경 사항이 있는 동안 맵을 자동으로 저장합니다. 저장에 실패하면 자동으로 꺼집니다.',
  'editor.topbar.undoTitle': '마지막 변경 실행 취소(Ctrl+Z)',
  'editor.topbar.redoTitle': '실행 취소한 마지막 변경 다시 실행(Ctrl+Y)',
  'editor.topbar.offline': '오프라인',
  'editor.topbar.offlineTitle':
    '로그인하지 않음: 맵은 이 브라우저에만 저장됩니다. 온라인으로 저장하려면 게임에서 로그인하세요.',
  'editor.topbar.signInTitle': '새 탭에서 게임 로그인 화면 열기',
  'editor.topbar.helpTitle': '에디터 가이드: 도구, 단축키, 튜토리얼',
  'editor.tool.listLabel': '에디터 도구',
  'editor.tool.select': '선택',
  'editor.tool.raise': '높이기',
  'editor.tool.lower': '낮추기',
  'editor.tool.smooth': '매끄럽게',
  'editor.tool.flatten': '평탄화',
  'editor.tool.paint': '바이옴 칠하기',
  'editor.tool.water': '물',
  'editor.tool.place': '에셋 배치',
  'editor.tool.blocker': '차단벽',
  'editor.tool.spawn': '스폰 지점',
  'editor.tool.region': '영역',
  'editor.tool.erase': '지우기',
  'editor.topbar.savedLocal': '이 브라우저에 저장됨',
  'editor.topbar.savedServer': '저장됨(버전 {version})',
  'editor.a11y.stage': '맵 뷰포트',
  'editor.a11y.toasts': '에디터 알림',
  'editor.confirm.cancel': '취소',
  'editor.confirm.conflictTitle': '다른 사람이 이 맵을 저장했습니다',
  'editor.confirm.conflictBody':
    '서버 사본이 이제 버전 {version}이며, 회원님이 불러온 버전보다 최신입니다. 상대방의 변경 사항을 덮어쓰지 않도록 회원님의 변경 사항을 새 맵으로 저장하세요.',
  'editor.confirm.discardTitle': '저장하지 않은 변경 사항을 폐기하시겠습니까?',
  'editor.confirm.discardBody': '"{name}"에 저장하지 않은 변경 사항이 있으며, 폐기하면 사라집니다.',
  'editor.confirm.discard': '폐기',
  'editor.prompt.nameLabel': '맵 이름',
  'editor.status.saveFailedLocal':
    '이 브라우저에 저장할 수 없습니다(저장 공간이 가득 찼을 수 있습니다).',
  'editor.status.savedLocalOnly':
    '"{name}"이(가) 이 브라우저에 저장되었습니다. 로그인하면 서버에도 저장할 수 있습니다.',
  'editor.status.savedServer': '"{name}"이(가) 저장되었습니다(버전 {version}).',
  'editor.status.autosaveOff': '자동 저장이 꺼졌습니다: {reason}',
  'editor.status.autosaveFailed':
    '자동 저장 초안을 기록할 수 없습니다(저장 공간이 가득 찼을 수 있습니다).',
  'editor.status.forked': '나만의 사본을 만들었습니다: "{name}".',
  'editor.status.opened': '"{name}"이(가) 열렸습니다.',
  'editor.status.newMap': '새 맵을 시작했습니다.',
  ...
  'editor.upload.uploaded': '"{name}"이(가) 업로드되었습니다.',
  'editor.upload.uploadedExisting': '이미 이 파일을 업로드했습니다. 기존 파일을 재사용합니다.',
  'editor.serverError.invalid_map_name': '해당 맵 이름은 유효하지 않습니다.',
  'editor.serverError.map_name_not_allowed': '해당 맵 이름은 허용되지 않습니다.',
  'editor.serverError.invalid_map_doc': '이 맵 문서는 유효하지 않습니다.',
  'editor.serverError.invalid_version':
    '해당 저장이 오래되었습니다. 맵을 다시 열고 다시 시도하세요.',
  'editor.serverError.map_limit_reached': '계정의 저장된 맵 한도에 도달했습니다.',
  'editor.serverError.map_not_found': '해당 맵이 더 이상 존재하지 않습니다.',
  'editor.serverError.version_conflict': '다른 사람이 먼저 이 맵을 저장했습니다.',
  'editor.serverError.slug_unavailable':
    '해당 맵 이름은 이미 사용 중입니다. 다른 이름을 시도하세요.',
  'editor.serverError.map_too_large': '이 맵은 너무 커서 저장할 수 없습니다.',
  'editor.serverError.invalid_glb': '해당 파일은 유효한 GLB 모델이 아닙니다.',
  'editor.serverError.asset_blocked': '해당 에셋은 모더레이터에 의해 제거되었습니다.',
  'editor.serverError.asset_limit_reached': '계정의 업로드된 에셋 한도에 도달했습니다.',
  'editor.serverError.asset_storage_limit_reached':
    '업로드된 에셋의 저장 공간 한도에 도달했습니다.',
  'editor.serverError.asset_too_large': '해당 에셋이 8MiB보다 큽니다.',
  'editor.serverError.asset_not_found': '해당 에셋이 더 이상 존재하지 않습니다.',
  'editor.serverError.rate_limited': '요청이 너무 많습니다. 잠시 후 다시 시도하세요.',
  'editor.serverError.unauthorized': '이 작업을 하려면 게임에서 로그인하세요.',
  'editor.serverError.network': '서버에 연결할 수 없습니다. 연결 상태를 확인하세요.',
  'editor.serverError.timeout': '서버 응답 시간이 너무 오래 걸렸습니다.',
  'editor.serverError.unknown': '문제가 발생했습니다. 다시 시도하세요.',
  'editor.assets.label': '에셋 브라우저',
  'editor.assets.title': '에셋',
  'editor.assets.search': '에셋 검색',
  'editor.assets.searchPlaceholder': '검색...',
  'editor.assets.uploadedTab': '업로드됨',
  'editor.assets.uploadedSignIn': '자신의 에셋을 보고 업로드하려면 게임에서 로그인하세요.',
  'editor.assets.uploadedLoadFailed': '업로드한 에셋을 불러올 수 없습니다.',
  'editor.assets.uploadedEmpty': '아직 업로드한 에셋이 없습니다.',
  'editor.assets.loading': '불러오는 중...',
  'editor.assets.empty': '일치하는 에셋이 없습니다.',
  'editor.assets.pick': '{name} 배치',
  'editor.assets.deleteAsset': '에셋 삭제',
  'editor.assets.deleteAssetConfirm':
    '"{name}"을(를) 삭제하시겠습니까? 이 에셋을 사용하는 맵의 배치는 렌더링되지 않습니다.',
  'editor.assets.category.biome': '바이옴',
  'editor.assets.category.chars': '캐릭터',
  'editor.assets.category.creatures': '크리처',
  'editor.assets.category.dungeon': '던전',
  'editor.assets.category.foliage': '식물',
  ...
  'editor.help.title': '에디터 도움말',
  'editor.help.mouseTitle': '마우스',
  'editor.help.flowTitle': '저장 및 초안',
  'editor.help.beginTutorial': '튜토리얼 시작',
  'editor.help.close': '닫기',
  'editor.help.mouse.orbit3d': '3D 뷰: 왼쪽 드래그로 회전, 오른쪽 드래그로 이동',
  'editor.help.mouse.fly3d': '3D 뷰: 스크롤로 확대/축소, WASD로 비행',
  'editor.help.mouse.pan2d': '2D 뷰: 빈 공간을 드래그하여 이동, 스크롤로 확대/축소',
  'editor.help.flow.save': '저장은 이 브라우저에 기록되며, 로그인하면 서버에도 기록됩니다',
  'editor.help.flow.draft':
    '자동 저장 초안은 탭이 예기치 않게 닫혀도 저장하지 않은 편집 내용을 보호합니다',
  'editor.tutorial.title': '에디터 튜토리얼',
  'editor.tutorial.finish': '완료',
  'editor.tutorial.steps.toolbar.title': '도구',
  'editor.tutorial.steps.toolbar.body':
    '여기서 도구를 선택하세요. 배치는 지금 바로 사용할 수 있으며, 더 많은 도구가 곧 추가됩니다.',
  'editor.tutorial.steps.stage.title': '뷰포트',
  'editor.tutorial.steps.stage.body':
    '이것이 회원님의 맵입니다. 언제든지 3D 뷰와 2D 뷰를 전환할 수 있습니다.',
  'editor.tutorial.steps.viewToggle.title': '3D / 2D 전환',
  'editor.tutorial.steps.viewToggle.body':
    '정확한 배치를 위해 2D 상공 뷰로 전환하거나, 결과를 보려면 3D로 전환하세요.',
