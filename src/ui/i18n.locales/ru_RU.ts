...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    'Хауди, друг, снова у сосуда, значит, он сегодня тихий, то ли слушает изо всех сил, то ли просто меня игнорит, с ним никогда не поймёшь, честно... Ну а как тебе Лощина, хорошо, плохо, перекусить с собой есть, нет? Ладно, просто спросил, спрашиваю для друга, а этот друг, это я...',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    'Всё как всегда, он хочет дыма, хочет заботы, хочет, чтобы кто-то сел рядом и притворился, будто тишина, это разговор, ну, мне так вообще нормально, я с ним постоянно болтаю, а он ни разу ничего не ответил, ну, вообще ни разу, но да ладно, так оно и есть, в общем-то, по меркам Зеленолапа нормально... Погоди, о чём мы... А. Точно. О нём. Он в порядке. Наверное, голодный. Аналогично.',
  'entities.npcs.brother_greenpaw.dialogNode.faith':
    'Верить, это громкое слово, друг, я просто ухаживаю, ухаживать я умею, две руки есть и зажигалка, вот и всё резюме... Слушает он там или нет, я не знаю, но дым всё равно приятно пахнет, так что с волной как-то разбираемся. Точно так.',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    'Всё нормально, друг, всё это гамбит, всегда им было, это во мне ковбой говорит... Такое место иногда заслуживает резкого слова, не буду притворяться, что нет... Но ты вернулся и извинился, а это что-то значит, или значит, что тебе что-то надо, в любом случае мы квиты, ты и я, волна совпадает, в другой раз захочешь перекусить, я угощаю.',
