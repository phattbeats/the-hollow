...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_fallow_acres_wolves_ii.text':
    'По краям поредело, а логово нет. Ещё восемь, и Перелоги смогут держать крышу, не теряя ночами тех, кто спит под ней. Я бы приглядел сам, да только дважды в одном месте бываю редко, а земля под Окраинами просит присмотра больше, чем эти борозды.',
