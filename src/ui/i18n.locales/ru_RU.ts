...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.tutorial.talkBodyTouch':
    'Подойдите к Брату Зеленолапу и нажмите кнопку «Использовать», чтобы заговорить, затем примите его поручение.',
  'hudChrome.tutorial.returnBodyTouch':
    'Вы несете то, что горит. Вернитесь к Брату Зеленолапу и нажмите кнопку «Использовать», чтобы сдать его.',
  'hudChrome.tutorial.doneBodyTouch':
    'Основы освоены, {name}. Пустошь в вашем распоряжении, а у Зеленолапа всегда найдется еще одно поручение. Нажмите «Еще», затем «Журнал заданий», чтобы просмотреть свои задания в любой момент.',
  ...
  // existing Russian register (ecclesiastical present tense), keeping the
  // "sole surviving keeper of a register" throughline.
  'entities.npcs.verger_zebediah.introLines.0':
    'Пономарь Зеведей. Страж Корневой Лощины, по назначению должности, которая в настоящее время тоже я. В большинство дней вы найдёте меня здесь; в остальные дни я нахожу себя здесь же. Окраинам не требуется кворум, требуется лишь запись.',
  'entities.npcs.verger_zebediah.introLines.1':
    'Я веду календарь. Календарь меня не ведёт, хотя в иные сезоны пытается. Корневая Лощина помечена как отдыхающая в этот оборот, нижние же норы того объявления не получили, и цапля уже перестала притворяться удивлённой. Таково положение дел. Это не жалоба: для жалобы нужны свидетели.',
  'entities.npcs.verger_zebediah.introLines.2':
    'В святилище есть журнал. Не трогайте его. Под ногами рыхлая земля, там, где прошли кабаны. О том и о другом помните. Если вы пришли по поводу стражи, я могу предложить два поручения, оба не малых, и одно из них я предпочту не править в третий раз. Вот, собственно, почему я с вами и заговорил.',
  // Persistent journal/lore (PHAA-480). Same ecclesiastical present tense as
  // the intro, longer arc: the "журнал помнит то, что забывают ходящие"
  // throughline plus the heron and the room beneath the shrine.
  'entities.npcs.verger_zebediah.journalLines.0':
    'Журнал старше цапли. Первую запись внёс не я, и последнюю внесу не я; в этом утешение должности, которую никто не ждёт, чтобы её унаследовать. Окраины когда-то были проезжей дорогой. Люди поднимались по озёрной тропе с солью и спускались, унося нечто, чему я не давал имени, потому что не мне было спрашивать; как не давали имени и они. Журнал записывает приходы и уходы и один долгий пропуск, когда не было ни тех, ни других. Пропуск я тоже храню.',
  'entities.npcs.verger_zebediah.journalLines.1':
    'Цапля старше журнала, и журнал на это в обиде. Вслух не говорит. И незачем. Я видел, как она простояла на одной ноге целый сезон, погубивший груши, и не моргнула, и считаю это позицией по какому-то вопросу, хотя мне никогда не докладывали, по какому именно. Под святилищем есть комната, в которую я не вхожу. Цапля входит. Я не спрашиваю, что она там делает; она не спрашивает, что я делаю наверху. Это соглашение длится дольше, чем любой из нас.',
  'entities.npcs.verger_zebediah.journalLines.2':
    'Если вы читаете так далеко, то вы либо любопытны, либо спасаетесь от кабанов, и то и другое я уважаю. Короткая версия долгой записи такова: это место помнит, чем оно было, и помнит, чем собирается стать, и разница между тем и другим и есть работа. Помнить, моё дело. Чьё дело, стать, я не знаю. Записываю как «в ожидании» и иду спать. Журнал допускает ожидание. Забвение журнал не допускает.',
  'entities.npcs.verger_zebediah.journalLines.3':
    'Путники, что поднимаются по озёрной тропе и слышат про вазу, обычно приходят к одному из двух выводов, и ни один не льстив. Одни называют паству хиппи или чудаками и уходят посмеиваясь. Другие называют её похуже и даже не задерживаются посмеяться. Большинство же вовсе никогда не слышит про вазу, и я всё больше склоняюсь к мысли, что именно так этот порядок вещей и должен работать. Тихое живёт дольше знаменитого.',
  ...
  'entities.npcs.gate_bard.greeting':
    'Медяк за песню? Нет? Ничего, чаще всего нет. Я играю для ворот, а ворота ни разу не потянулись за кошельком. Проезжие называют это место лагерем хиппи, а то и похуже, но они обычно просто проезжают мимо, так что пусть говорят.',
  ...
  'entities.npcs.withered_planting.name': 'Засохший саженец',
  'entities.npcs.withered_planting.title': 'Старая ива племени',
  'entities.npcs.withered_planting.greeting':
    'Сухие корни, сухие листья. Чем бы это ни должно было стать, оно ещё не стало этим, и ждёт уже очень долго.',
  'entities.npcs.buried_root.name': 'Погребённый корень',
  'entities.npcs.buried_root.title': 'Под святилищем',
  'entities.npcs.buried_root.greeting': 'Сухо. Суше, чем что-либо здесь, внизу, вообще бывает.',
  'entities.quests.q_the_long_way_around.title': 'Долгий обходной путь',
  'entities.quests.q_the_long_way_around.text':
    'Там, у старой ивы, племя оставило саженец, недосаженный до конца, и он погибает - ему нужен всего один хороший полив. Мне туда больше не взобраться, а вот у тебя ноги ещё крепкие. Возьми лейку. Осторожнее с ветками - они выдержат, если быть с ними честным.',
  'entities.quests.q_the_long_way_around.completion':
    'Теперь он будет жить. Не скажешь, что один подъём и один полив значат много - на фоне всего остального, что творится вокруг. Это и правда немного. Но для того единственного, что ты полил, это - всё.',
  'entities.quests.q_the_long_way_around.objectives.0.label': 'Вода принесена на тропу к иве',
  'entities.quests.q_the_watering_can.title': 'Та самая лейка',
  'entities.quests.q_the_watering_can.text':
    'Я просила тебя о мелочах, и ты делал их все, ни разу не спросив зачем. Вот последняя просьба, и она вовсе не мелкая, хоть и выглядит так. Возьми мою лейку, спустись под святилище, к тому, что там погребено, и дай ему воды. Оно долго ждало, чтобы ему что-то дали, а не что-то у него просили.',
  'entities.quests.q_the_watering_can.completion':
    'Ты сделал это. Конечно сделал. Это была та самая вода, понимаешь. Вся она, до самого того дня, когда ты нашёл меня у озера и не придал этому значения. Тот же полив, то же обещание, исполненное ещё раз. Спасибо. Теперь иди и будь мягок с этим миром. Это единственное, что когда-либо по-настоящему его меняло.',
  'entities.quests.q_the_watering_can.objectives.0.label': 'Вода дана погребённому корню',
  ...
  'entities.npcs.sexton_faddick.introLines.0':
    'Фаддик. Могильщик, покуда есть святилище, при котором можно быть могильщиком, а таких святилищ теперь меньше, чем прежде. Я нигде не задерживаюсь, я лишь храню. Хранение и есть почти всё, для чего я теперь ещё нужен.',
  'entities.npcs.sexton_faddick.introLines.1':
    'Тот, кто кружит достаточно долго, узнаёт очертания того, вокруг чего кружит. Волки на Перелогах кружили вокруг стада каждую ночь задолго до того, как я проходил здесь, и очертаний стада они ещё не усвоили, что, впрочем, о чём-то да говорит. Стадо же их усвоило, и это говорит о большем.',
  'entities.npcs.sexton_faddick.introLines.2':
    'Я бы предложил вам чаю, да чайник остался где-то там, где я был вчера. У озера есть тихий клочок земли, что ждёт, когда на нём поставят дом; на земле, где волки работают в темноте, ничего не укореняется. Так вот, два поручения, и одно из них я предпочёл бы не делать в одиночку. Пойдёмте, поговорим на ходу.',
  // Persistent journal/lore (PHAA-480). Wandering-keeper voice, aphoristic,
  // longer arc. The "земля помнит лучше нас" throughline and the slow time
  // under the stones.
  'entities.npcs.sexton_faddick.journalLines.0':
    'Список мест, которые я хранил, держу в голове: бумага меняет хозяев быстрее, чем земля. В списке, по большей части, святилища, те, где уже некому служить. Перелоги в этом списке. Пруд к востоку от озера, чьего имени я так и не узнал, тоже. И стоячий камень, который ветер сто лет подряд округляет. Список недолог. В том, что по-настоящему важно, он и есть всё. Место хранишь не тем, что остаёшься, а тем, что остаёшься тем, кто помнит, что оно там было.',
  'entities.npcs.sexton_faddick.journalLines.1':
    'Земля помнит лучше нас. В этом и состоит весь торг. Ходящие по верху забывают собственное имя за два поколения, выдумывают новое и зовут его тем же самым; то, что сидит внизу, ничего не забывает и ждёт. Под камнями есть медленное время. Я слышал его однажды, и не ответил: ответ, это способ, которым медленная вещь находит дверь. Ключ от неответа я ношу при себе. Не металлический. Привычка, а она тяжелее.',
  'entities.npcs.sexton_faddick.journalLines.2':
    'Волки, не проблема. Волки, симптом; проблема в том, что сделало землю настолько тихой, что волки решили, будто она их. Я такое уже видывал: место затихает не в ту сторону, и починка всегда одна, снова сделать его шумным, шумом правильного рода, а этот шум, люди, потому-то кто-то и строится. Можете спросить, кто я такой, чтобы всё это нести. Я, тот, кто всё ещё идёт. Это и есть всё моё право на это. Его хватает и не хватает, и с разрывом между тем и другим я давно помирился.',
  'entities.quests.q_root_hollow_boars.title': 'Кабаны Корневой Лощины',
  'entities.quests.q_root_hollow_boars.text':
    'По календарю Корневая Лощина в этот сезон отдыхает. Кабанов об этом не уведомили. Они перерыли половину её в поисках личинок и больше не разбегаются, когда на них машет крыльями цапля, что я принимаю на свой счёт. Убей пятерых, и я смогу занести сезон как положено.',
  'entities.quests.q_root_hollow_boars.completion':
    'Пять. Сочтены, датированы и внесены в журнал. Корневая Лощина теперь отстаёт от собственного сезона всего на две недели, что в этой должности мы зовём триумфом. Благодарю тебя от имени ордена, который на сей момент есть я.',
  ...
  'entities.quests.q_fallow_acres_wolves.text':
    'Кто-то надумал строиться на Перелогах. Хорошо. Земля, где живут люди, помнит лучше пустой, а этот край забыл слишком многое. Но пока волки работают в темноте, ничто не приживётся. Прореди стаю до пяти, и я позабочусь, чтобы дорога окупилась. Возвращать долги, вот почти всё, на что я ещё гожусь.',
  'entities.quests.q_fallow_acres_wolves.completion':
    'Потише стало. Хорошо. Я стоял во множестве тихих мест, что некогда были полны голосов целого народа; у этого есть шанс пойти обратным путём. Благодарю, и береги себя в пути.',
  ...
  'entities.quests.q_fallow_acres_wolves_ii.text':
    'По краям поредело, а логово нет. Ещё восемь, и Перелоги смогут держать крышу, не теряя ночами тех, кто спит под ней. Я бы приглядел сам, да только дважды в одном месте бываю редко, а земля под святилищем просит присмотра больше, чем эти борозды.',
  'entities.quests.q_fallow_acres_wolves_ii.completion':
    'Вот так. Одна тихая ночь, а за ней, быть может, сотня. Строй хорошо. И если однажды копнёшь так глубоко, что услышишь, как там внизу что-то медленно отбивает время, не отвечай ему. Это моё дело хранить; ключ от него ношу я. Ступай теперь.',
  ...
  'entities.items.flint_amber_pick.name': 'Кремнёвая кирка янтаря',
  'entities.items.bonewood_amber_pick.name': 'Костяная кирка янтаря',
  'entities.items.starleaf_amber_pick.name': 'Звёздная кирка янтаря',
  'entities.items.flint_bark_axe.name': 'Кремнёвый топор коры',
  'entities.items.bonewood_bark_axe.name': 'Костяной топор коры',
  'entities.items.starleaf_bark_axe.name': 'Звёздный топор коры',
  'entities.items.flint_spore_sickle.name': 'Кремнёвый серп спор',
  'entities.items.bonewood_spore_sickle.name': 'Костяной серп спор',
  'entities.items.starleaf_spore_sickle.name': 'Звёздный серп спор',
  ...
  'hud.tutorial.seekTitle': 'Найдите Брата Зеленолапа',
  ...
  'hud.tutorial.gatherProgress': 'Собрано тлеющих луковиц: {current} / {needed}',
  'hud.tutorial.returnTitle': 'Накормите Печь',
  ...
  'guide.hollowPage.outsiderHeading': 'Как на это смотрит остальной мир',
  'guide.hollowPage.outsiderBody':
    'За воротами святилища почти никто и не слышал о вазе. Те немногие, кто слышал, обычно списывают ее хранителей на хиппи, чудаков, а то и вовсе на странных людей, разговаривающих с кувшином. Остальное, что доходит до посторонних, приходит из еще более странных слухов: то последователь забредет слишком далеко от поляны, то одно из маленьких зеленых существ объявится там, где ему быть совсем не полагалось.',
  ...
  'entities.npcs.brother_greenpaw.dialogNode.hearth':
    'Хауди, друг, снова у сосуда, значит, он сегодня тихий, то ли слушает изо всех сил, то ли просто меня игнорит, и честно, я уважаю оба варианта, у меня самого только эти два режима... Ну а как тебе Лощина, хорошо, плохо, перекусить с собой есть, нет? Ладно, просто спросил, спрашиваю для друга, а этот друг, это я...',
  'entities.npcs.brother_greenpaw.dialogNode.warmed':
    '...Ого, ладно, это ты приятно сказал, друг, реально приятно, не ожидал, большинство народу сваливает к воротам при первой возможности... А ты ничего так, знаешь, ничего так по меркам Зеленолапа, а это я просто так не раздаю... Будь у меня акции, купил бы твоих, покупай новых друзей, продавай старые знамения, это ж просто экономика...',
  'entities.npcs.brother_greenpaw.dialogNode.vase':
    'Всё как всегда, он хочет дыма, хочет заботы, хочет, чтобы кто-то сел рядом и притворился, будто тишина, это разговор... хм. так это же почти любой разговор. ого. ладно, короче, я с ним постоянно болтаю, а он ни разу ничего не ответил, ну, вообще ни разу, но да ладно, так оно и есть, в общем-то, по меркам Зеленолапа нормально... Погоди, о чём мы... А. Точно. О нём. Он в порядке. Наверное, голодный. Аналогично.',
  'entities.npcs.brother_greenpaw.dialogNode.faith':
    'Верить, это громкое слово, друг, я просто ухаживаю, ухаживать я умею, две руки есть и зажигалка, вот и всё резюме... Слушает он там или нет, я не знаю, но дым приятно пахнет и меня не осуждает, а это больше, чем можно сказать про большинство ушастых, так что с волной как-то разбираемся. Точно так.',
  'entities.npcs.brother_greenpaw.dialogNode.stung':
    '...Ай, ну ладно, больно, друг, блин... В смысле, может быть, я не знаю, у меня самого такие мысли бывают холодными утрами, когда никто не поднимается по тропе и сосуд даже не вздыхает... Но я всё ещё здесь, так что это чего-то да стоит, верно? Верно. Точно. Кстати, перекусить хочешь, у меня есть, меняю тему. Всё.',
  'entities.npcs.brother_greenpaw.dialogNode.mended':
    'Всё нормально, друг, всё это гамбит, всегда им было, это во мне ковбой говорит, только не спрашивай его, что такое гамбит, он тоже не знает, просто говорит очень уверенно... Такое место иногда заслуживает резкого слова, не буду притворяться, что нет... Но ты вернулся и извинился, а это что-то значит, или значит, что тебе что-то надо, в любом случае мы квиты, ты и я, волна совпадает, в другой раз захочешь перекусить, я угощаю.',
  'entities.npcs.brother_greenpaw.dialogNode.tribe':
    'Большое было племя, давно, так старые зарубки говорят, читаю я не очень, зато считать умею, а там внизу целая куча пятёрок нацарапана, перечёркнутых, больше, чем одна рука могла бы наделать, с этой математикой не поспоришь... Долго держали его огонь, пока не остался я один. Куда все делись, не знаю, друг, реально не знаю, иногда что-то чувствую на этой волне, но чувство само своё предложение не заканчивает, вот и я тоже не заканчиваю... Но фитиль не погаснет, пока я на страже. Это я знаю точно.',
  'entities.npcs.brother_greenpaw.dialogNode.confide':
    '...Это ты по-доброму сказал, друг, реально по-доброму... Слушай, я говорю с тобой наполовину потому, что сосуд не отвечает, а наполовину потому, что боюсь, некоторыми ночами, что никто больше не поднимется по этой тропе, и останемся только я, он и тишина... Так что. Спасибо, что поднялся. Вот это, по-моему, и есть святое. ...Кстати. Перекусить есть с собой? Спрашиваю за сосуд. Волна тоже проголодалась.',
  'entities.npcs.brother_greenpaw.dialogChoice.kind':
    'Это место начинает мне нравиться, Зеленолап. Серьёзно, реально серьёзно.',
  'entities.npcs.brother_greenpaw.dialogChoice.ask':
    'Ну а что там сосуд говорил в последнее время?',
  'entities.npcs.brother_greenpaw.dialogChoice.blunt':
    'Это погост с талисманом, Зеленолап. Вот и всё.',
  'entities.npcs.brother_greenpaw.dialogChoice.tribe':
    'Расскажи мне про то племя, которое было до тебя.',
  'entities.npcs.brother_greenpaw.dialogChoice.warm_bye': 'Ладно, возвращайся к нему.',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_more': 'И ты реально думаешь, что он слушает?',
  'entities.npcs.brother_greenpaw.dialogChoice.vase_bye': 'Ну тогда побудь с ним.',
  ...
  'entities.npcs.brother_greenpaw.dialogChoice.sorry':
    'Вышло злее, чем я хотел. Прости, Зеленолап.',
  'entities.npcs.brother_greenpaw.dialogChoice.cold_bye': 'Верь во что хочешь.',
  'entities.npcs.brother_greenpaw.dialogChoice.mended_bye': 'Мы квиты. Ещё увидимся, Зеленолап.',
  ...
  'entities.npcs.brother_greenpaw.dialogChoice.tribe_bye':
    'Ну, кто-то же всё ещё ухаживает за ним.',
  ...
  'hudChrome.npcJournal.readLabel': 'Расскажите мне о вашем дневнике.',
  'hudChrome.npcJournal.readAria': 'Прочитать дневник {name}',
  'hudChrome.npcJournal.back': 'Предыдущая страница',
  ...
  'housingUi.window.clear': 'Очистить',
  'housingUi.window.clearAria': 'Очистить слот {slot}',
  'housingUi.window.placeAria': 'Поместить {decor} в слот {slot}',
  'housingUi.window.hint': 'Выберите украшение для каждого слота.',
  'housingUi.decor.planter': 'Кашпо',
  'housingUi.decor.lantern': 'Фонарь',
  'housingUi.decor.crate': 'Ящик',
  'housingUi.decor.bench': 'Скамья',
  'housingUi.decor.stool': 'Табурет',
  'coldOpen.title': 'Пустошь',
  'coldOpen.wakeBody':
    'Ты приходишь в себя на тёплой земле, не помня ни своего имени, ни своего народа, ни того, как здесь оказался. Впереди из огромного сосуда струится зелёный свет, и что-то в нём словно всё это время ждало тебя.',
  'coldOpen.orientBody':
    'В святилище тихо, и запах дыма всё ещё держится в воздухе. Не спеши, найди опору под ногами. Когда будешь готов, иди на зелёный свет: впереди кто-то хранит пламя и, быть может, знает, что ты потерял.',
  'coldOpen.continue': 'Далее',
  'coldOpen.begin': 'Начать',
  'coldOpen.skip': 'Пропустить',
  'apiError.crossSiteRejected': 'Межсайтовый запрос отклонён.',
  'apiError.notAuthenticated': 'Нет авторизации.',
  'apiError.readOnlyToken': 'Этот токен доступен только для чтения.',
  'apiError.characterNotFound': 'Персонаж не найден.',
  'apiError.rateLimited': 'Слишком много попыток. Подождите минуту и попробуйте снова.',
