...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.brother_greenpaw.greeting':
    'э-э... привет. привет. не слыхал, как ты подошел, унесло меня куда-то в зелень... звать Зеленолап. первый пророк, самопровозглашенный, оно и не значит ничего, да только кто-то должен приглядывать за вазой, а из старого племени больше и спорить-то некому, никого не осталось. подь сюда, есть парочка святых дел, требующих заботы. в основном перекусить. оно и то же самое, по-зеленолаповски говоря.',
