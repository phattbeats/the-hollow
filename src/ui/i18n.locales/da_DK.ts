...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.flint_amber_pick.name': 'Flint Ravhakke',
  'entities.items.bonewood_amber_pick.name': 'Beentræ Ravhakke',
  'entities.items.starleaf_amber_pick.name': 'Stjerneblad Ravhakke',
  'entities.items.flint_bark_axe.name': 'Flint Barkøkse',
  'entities.items.bonewood_bark_axe.name': 'Beentræ Barkøkse',
  'entities.items.starleaf_bark_axe.name': 'Stjerneblad Barkøkse',
  'entities.items.flint_spore_sickle.name': 'Flint Sporesegl',
  'entities.items.bonewood_spore_sickle.name': 'Beentræ Sporesegl',
  'entities.items.starleaf_spore_sickle.name': 'Stjerneblad Sporesegl',
  ...
  'entities.items.deathless_greatblade.name': 'Det Udødelige Storsværd',
  'entities.items.scepter_of_the_deathless_court.name': 'Scepter fra Den Udødelige Hof',
  ...
  'entities.mobs.nythraxis_heroic_warrior_add.name': 'Aldrens Ånd',
  'entities.mobs.nythraxis_heroic_priest_add.name': 'Malrics Ånd',
  'entities.mobs.nythraxis_heroic_rogue_add.name': "Voss' Ånd",
  ...
  'entities.items.bramblewar_warhelm.name': 'Tjørnekrig Hoved',
  'entities.items.bramblewar_warspaulders.name': 'Tjørnekrig Skuldre',
  'entities.items.bramblewar_warplate.name': 'Tjørnekrig Bryst',
  'entities.items.bramblewar_girdle.name': 'Tjørnekrig Talje',
  'entities.items.bramblewar_legguards.name': 'Tjørnekrig Ben',
  'entities.items.bramblewar_gauntlets.name': 'Tjørnekrig Hænder',
  'entities.items.bramblewar_sabatons.name': 'Tjørnekrig Fødder',
  'entities.items.thornbound_crown.name': 'Tjørnebundet Hoved',
  'entities.items.thornbound_spaulders.name': 'Tjørnebundet Skuldre',
  'entities.items.thornbound_hauberk.name': 'Tjørnebundet Bryst',
  'entities.items.thornbound_waistguard.name': 'Tjørnebundet Talje',
  'entities.items.thornbound_legmail.name': 'Tjørnebundet Ben',
  'entities.items.thornbound_handguards.name': 'Tjørnebundet Hænder',
  'entities.items.thornbound_greaves.name': 'Tjørnebundet Fødder',
  'entities.items.nettlestalker_cowl.name': 'Brændenældejæger Hoved',
  'entities.items.nettlestalker_shoulderguards.name': 'Brændenældejæger Skuldre',
  'entities.items.nettlestalker_harness.name': 'Brændenældejæger Bryst',
  'entities.items.nettlestalker_waistband.name': 'Brændenældejæger Talje',
  'entities.items.nettlestalker_legguards.name': 'Brændenældejæger Ben',
  'entities.items.nettlestalker_grips.name': 'Brændenældejæger Hænder',
  'entities.items.nettlestalker_treads.name': 'Brændenældejæger Fødder',
  'entities.items.mossweave_cowl.name': 'Mosvævet Hoved',
  'entities.items.mossweave_mantle.name': 'Mosvævet Skuldre',
  'entities.items.mossweave_raiment.name': 'Mosvævet Bryst',
  'entities.items.mossweave_cord.name': 'Mosvævet Talje',
  'entities.items.mossweave_legwraps.name': 'Mosvævet Ben',
  'entities.items.mossweave_handwraps.name': 'Mosvævet Hænder',
  'entities.items.mossweave_slippers.name': 'Mosvævet Fødder',
  'entities.items.last_bloom_greatblade.name': 'Sidste Blomstrings Storsværd',
  'entities.items.thornbite_razor.name': 'Tornebid-Ragekniv',
  'entities.items.heartwood_warstaff.name': 'Kerneved-Krigsstav',
