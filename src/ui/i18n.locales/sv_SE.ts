...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.greenpaw_bead.name': 'En pärla från bandoleret',
  ...
  'entities.items.flint_amber_pick.name': 'Flintbärnstenshacka',
  'entities.items.bonewood_amber_pick.name': 'Benträbärnstenshacka',
  'entities.items.starleaf_amber_pick.name': 'Stjärnbladbärnstenshacka',
  'entities.items.flint_bark_axe.name': 'Flintbarkyxa',
  'entities.items.bonewood_bark_axe.name': 'Benträbarkyxa',
  'entities.items.starleaf_bark_axe.name': 'Stjärnbladbarkyxa',
  'entities.items.flint_spore_sickle.name': 'Flintsporskära',
  'entities.items.bonewood_spore_sickle.name': 'Benträsporskära',
  'entities.items.starleaf_spore_sickle.name': 'Stjärnbladsporskära',
  ...
  'entities.items.bramblewar_warhelm.name': 'Törnkrig Huvud',
  'entities.items.bramblewar_warspaulders.name': 'Törnkrig Axlar',
  'entities.items.bramblewar_warplate.name': 'Törnkrig Bröst',
  'entities.items.bramblewar_girdle.name': 'Törnkrig Midja',
  'entities.items.bramblewar_legguards.name': 'Törnkrig Ben',
  'entities.items.bramblewar_gauntlets.name': 'Törnkrig Händer',
  'entities.items.bramblewar_sabatons.name': 'Törnkrig Fötter',
  'entities.items.thornbound_crown.name': 'Törnbunden Huvud',
  'entities.items.thornbound_spaulders.name': 'Törnbunden Axlar',
  'entities.items.thornbound_hauberk.name': 'Törnbunden Bröst',
  'entities.items.thornbound_waistguard.name': 'Törnbunden Midja',
  'entities.items.thornbound_legmail.name': 'Törnbunden Ben',
  'entities.items.thornbound_handguards.name': 'Törnbunden Händer',
  'entities.items.thornbound_greaves.name': 'Törnbunden Fötter',
  'entities.items.nettlestalker_cowl.name': 'Nässeljägare Huvud',
  'entities.items.nettlestalker_shoulderguards.name': 'Nässeljägare Axlar',
  'entities.items.nettlestalker_harness.name': 'Nässeljägare Bröst',
  'entities.items.nettlestalker_waistband.name': 'Nässeljägare Midja',
  'entities.items.nettlestalker_legguards.name': 'Nässeljägare Ben',
  'entities.items.nettlestalker_grips.name': 'Nässeljägare Händer',
  'entities.items.nettlestalker_treads.name': 'Nässeljägare Fötter',
  'entities.items.mossweave_cowl.name': 'Mossväv Huvud',
  'entities.items.mossweave_mantle.name': 'Mossväv Axlar',
  'entities.items.mossweave_raiment.name': 'Mossväv Bröst',
  'entities.items.mossweave_cord.name': 'Mossväv Midja',
  'entities.items.mossweave_legwraps.name': 'Mossväv Ben',
  'entities.items.mossweave_handwraps.name': 'Mossväv Händer',
  'entities.items.mossweave_slippers.name': 'Mossväv Fötter',
  'entities.items.last_bloom_greatblade.name': 'Sista Blomningens Storsvärd',
  'entities.items.thornbite_razor.name': 'Törnbett-Rakkniv',
  'entities.items.heartwood_warstaff.name': 'Kärnvedens Krigsstav',
