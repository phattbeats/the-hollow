...
const baseEnTable = {
  ...
  "loot.marketSellerBought": "{buyer} bought your {item} for {price} - collect {proceeds} from the Merchant.",
...
const BASE_DICT: Record<SupportedLanguage, Record<BaseSimMessageKey, string>> = {
  ...
  es: {
    ...
    "loot.marketSellerBought": "{buyer} compró tu {item} por {price}; cobra {proceeds} del Mercader.",
    "aura.tamed": "Domado",
  ...
  fr_FR: {
    ...
    "loot.marketSellerBought": "{buyer} a acheté votre {item} pour {price}; récupérez {proceeds} auprès du marchand.",
  ...
  it_IT: {
    ...
    "loot.marketSellerBought": "{buyer} ha comprato il tuo {item} per {price}; ritira {proceeds} dal mercante.",
  ...
  de_DE: {
    ...
    "loot.marketSellerBought": "{buyer} hat dein {item} für {price} gekauft; hol {proceeds} beim Händler ab.",
    "aura.tamed": "Gezähmt",
  ...
  ko_KR: {
    ...
    "loot.marketSellerBought": "{buyer}님이 당신의 {item}을(를) {price}에 샀습니다. 상인에게서 {proceeds}을(를) 수령하세요.",
    "aura.tamed": "길들여짐",
  ...
  ja_JP: {
    ...
    "loot.marketSellerBought": "{buyer}があなたの{item}を{price}で購入しました。商人から{proceeds}を受け取ってください。",
    "aura.tamed": "テイム",
  ...
  pt_BR: {
    ...
    "loot.marketSellerBought": "{buyer} comprou seu {item} por {price}; colete {proceeds} com o comerciante.",
    "aura.tamed": "Domado",
  ...
  ru_RU: {
    ...
    "loot.marketSellerBought": "{buyer} купил ваш предмет {item} за {price}; заберите {proceeds} у торговца.",
    "aura.tamed": "Приручён",
...
const RULES: Rule[] = [
  ...
  { re: /^(.+) bought your (.+) for (.+) [—-] collect (.+) from the Merchant\.$/, build: (m) => tSim('loot.marketSellerBought', { buyer: m[1], item: locItem(m[2]), price: m[3], proceeds: m[4] }) },
