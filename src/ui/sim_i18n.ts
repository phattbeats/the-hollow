...
// tests/localization_fixes.test.ts enumerates the sim emit sites and fails if one
...
export const DICT: Record<SupportedLanguage, Record<SimMessageKey, string>> = {
  ...
  es: {
    ...
    "error.invalidBuild": "Build de talentos no válido.",
    "error.unknownSpec": "Especialización desconocida.",
    "error.maxLoadouts": "Puedes guardar como máximo {count} equipamientos.",
    "error.noLoadout": "Ese equipamiento no existe.",
    "error.loadoutLevel": "Ese equipamiento requiere un nivel más alto.",
    ...
    "log.savedBuild": "Build “{name}” guardado.",
    "log.loadoutApplied": "Equipamiento “{name}” aplicado.",
    "log.deletedBuild": "Build “{name}” eliminado.",
  ...
  fr_CA: {
    ...
    "log.entityDies": "{name} meurt.",
    "log.prestiged": "Vous avez prestigé ! Rang de Prestige {rank}.",
    "log.enraged": "{name} entre en rage !",
    "log.callsForAid": "{name} appelle à l'aide !",
    "log.discarded": "{item} jeté.",
    "log.equipped": "{item} équipé.",
  ...
  it_IT: {
    ...
    "error.noSellQuest": "Non puoi vendere oggetti della missione.",
    ...
    "log.prestiged": "Hai raggiunto il prestigio! Grado di Prestigio {rank}.",
  ...
  de_DE: {
    ...
    "error.nailedShut": "Es ist festgenagelt.",
    ...
    "log.savedBuild": "Build „{name}“ gespeichert.",
    "log.loadoutApplied": "Vorlage „{name}“ angewendet.",
    "log.deletedBuild": "Build „{name}“ gelöscht.",
  ...
  ko_KR: {
    ...
    "error.merchantUnavailable": "그 상인은 이용할 수 없습니다.",
    ...
    "error.enoughOfThose": "그것은 이미 충분히 가지고 있습니다.",
  ...
  ja_JP: {
    ...
    "error.alreadyInParty": "あなたはすでにパーティーに所属しています。",
    "error.notPartyLeader": "あなたはパーティーリーダーではありません。",
    ...
    "log.tamedPet": "{name}があなたの忠実な仲間になりました。",
  ...
  ru_RU: {
    ...
    "error.invalidBuild": "Недопустимая раскладка талантов.",
...
const RULES: Rule[] = [
  ...
  { re: /^You dismiss (.+)\.$/, build: (m) => tSim('log.dismissPet', { name: m[1] }) },
  { re: /^(.+) is now your loyal companion\.$/, build: (m) => tSim('log.tamedPet', { name: m[1] }) },
