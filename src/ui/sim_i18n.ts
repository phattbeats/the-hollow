...
const baseEnTable = {
  ...
  // The Ravenpost (in-game mail, PHAA-495): src/sim/mail/post_office.ts emits these.
  'error.mailNeedRecipient': 'Name a recipient for your letter.',
  'error.mailNoRecipient': 'No adventurer by that name is known.',
  'error.mailTooFarSend': 'You must stand at the Ravenpost to send mail.',
  'error.mailCannotMailSelf': 'You cannot mail yourself.',
  'error.mailEmptyLetter': 'An empty letter carries nothing to send.',
  'error.mailTooManyParcels': 'A letter can carry at most {count} parcels.',
  ...
  'error.mailTooFarManage': 'You must stand at the Ravenpost to manage your mail.',
  'error.mailHasAttachments': 'Collect the attachments before discarding that letter.',
  'log.mailSent': 'Your letter to {name} is on its way.',
  'loot.mailCollectCopper': 'You collect {money} from a letter.',
  'aura.tamed': 'Tamed',
...
const BASE_DICT: Record<SupportedLanguage, Record<BaseSimMessageKey, string>> = {
  ...
  es: {
    ...
    'error.mailNeedRecipient': 'Indica un destinatario para tu carta.',
    'error.mailNoRecipient': 'No se conoce a ningún aventurero con ese nombre.',
    'error.mailTooFarSend': 'Debes estar en la Estafeta del Cuervo para enviar correo.',
    'error.mailCannotMailSelf': 'No puedes enviarte correo a ti mismo.',
    'error.mailEmptyLetter': 'Una carta vacía no lleva nada que enviar.',
    'error.mailTooManyParcels': 'Una carta puede llevar como máximo {count} paquetes.',
    ...
    'error.mailTooFarManage': 'Debes estar en la Estafeta del Cuervo para administrar tu correo.',
    'error.mailHasAttachments': 'Recoge los adjuntos antes de descartar esa carta.',
    'log.mailSent': 'Tu carta para {name} está en camino.',
    'loot.mailCollectCopper': 'Recoges {money} de una carta.',
  ...
  fr_FR: {
    ...
    'error.mailNeedRecipient': 'Indiquez un destinataire pour votre lettre.',
    'error.mailNoRecipient': "Aucun aventurier de ce nom n'est connu.",
    'error.mailTooFarSend':
      'Vous devez vous tenir au Comptoir du Corbeau pour envoyer du courrier.',
    'error.mailCannotMailSelf': 'Vous ne pouvez pas vous envoyer du courrier à vous-même.',
    'error.mailEmptyLetter': "Une lettre vide n'a rien à envoyer.",
    'error.mailTooManyParcels': 'Une lettre peut transporter au maximum {count} colis.',
    ...
    'error.mailTooFarCheck':
      'Vous devez vous tenir au Comptoir du Corbeau pour consulter votre courrier.',
    'error.mailTooFarManage':
      'Vous devez vous tenir au Comptoir du Corbeau pour gérer votre courrier.',
    'error.mailHasAttachments': 'Récupérez les pièces jointes avant de jeter cette lettre.',
    'log.mailSent': 'Votre lettre pour {name} est en chemin.',
    'loot.mailCollectCopper': "Vous récupérez {money} d'une lettre.",
  ...
  it_IT: {
    ...
    'error.mailNeedRecipient': 'Indica un destinatario per la tua lettera.',
    'error.mailNoRecipient': 'Nessun avventuriero con questo nome è conosciuto.',
    'error.mailTooFarSend': "Devi trovarti all'Ufficio del Corvo per spedire posta.",
    'error.mailCannotMailSelf': 'Non puoi spedire posta a te stesso.',
    'error.mailEmptyLetter': 'Una lettera vuota non porta nulla da inviare.',
    'error.mailTooManyParcels': 'Una lettera può trasportare al massimo {count} pacchi.',
    ...
    'error.mailTooFarManage': "Devi trovarti all'Ufficio del Corvo per gestire la tua posta.",
    'error.mailHasAttachments': 'Ritira gli allegati prima di scartare quella lettera.',
    'log.mailSent': 'La tua lettera per {name} è in viaggio.',
    'loot.mailCollectCopper': 'Raccogli {money} da una lettera.',
  ...
  de_DE: {
    ...
    'error.mailNeedRecipient': 'Nennt einen Empfänger für Euren Brief.',
    'error.mailNoRecipient': 'Kein Abenteurer dieses Namens ist bekannt.',
    'error.mailTooFarSend': 'Ihr müsst an der Rabenpost stehen, um Post zu verschicken.',
    'error.mailCannotMailSelf': 'Ihr könnt Euch selbst keine Post schicken.',
    'error.mailEmptyLetter': 'Ein leerer Brief enthält nichts, das man verschicken könnte.',
    'error.mailTooManyParcels': 'Ein Brief kann höchstens {count} Pakete tragen.',
    ...
    'error.mailTooFarManage': 'Ihr müsst an der Rabenpost stehen, um Eure Post zu verwalten.',
    'error.mailHasAttachments': 'Nehmt die Anhänge, bevor Ihr diesen Brief verwerft.',
    'log.mailSent': 'Euer Brief an {name} ist unterwegs.',
    'loot.mailCollectCopper': 'Ihr erhaltet {money} aus einem Brief.',
  ...
  zh_CN: {
    ...
    'error.mailNeedRecipient': '请指定一位收件人。',
    'error.mailNoRecipient': '没有那个名字的冒险者。',
    'error.mailTooFarSend': '你必须站在渡鸦驿站才能寄信。',
    'error.mailCannotMailSelf': '你不能给自己寄信。',
    'error.mailEmptyLetter': '空白的信件没有任何可寄送的内容。',
    'error.mailTooManyParcels': '一封信最多可携带 {count} 个包裹。',
    ...
    'error.mailTooFarManage': '你必须站在渡鸦驿站才能管理邮件。',
    'error.mailHasAttachments': '请先领取附件，再丢弃这封信。',
    'log.mailSent': '你寄给 {name} 的信已经在路上了。',
    'loot.mailCollectCopper': '你从信中取出了 {money}。',
  ...
  zh_TW: {
    ...
    'error.mailNeedRecipient': '請指定一位收件人。',
    'error.mailNoRecipient': '沒有那個名字的冒險者。',
    'error.mailTooFarSend': '你必須站在渡鴉驛站才能寄信。',
    'error.mailCannotMailSelf': '你不能給自己寄信。',
    'error.mailEmptyLetter': '空白的信件沒有任何可寄送的內容。',
    'error.mailTooManyParcels': '一封信最多可攜帶 {count} 個包裹。',
    ...
    'error.mailTooFarManage': '你必須站在渡鴉驛站才能管理郵件。',
    'error.mailHasAttachments': '請先領取附件，再丟棄這封信。',
    'log.mailSent': '你寄給 {name} 的信已經在路上了。',
    'loot.mailCollectCopper': '你從信中取出了 {money}。',
  ...
  ko_KR: {
    ...
    'error.mailNeedRecipient': '편지를 보낼 대상을 지정하세요.',
    'error.mailNoRecipient': '그런 이름의 모험가는 알려져 있지 않습니다.',
    'error.mailTooFarSend': '우편을 보내려면 레이븐포스트에 있어야 합니다.',
    'error.mailCannotMailSelf': '자기 자신에게는 편지를 보낼 수 없습니다.',
    'error.mailEmptyLetter': '빈 편지에는 보낼 내용이 없습니다.',
    'error.mailTooManyParcels': '편지 한 통에는 최대 {count}개의 소포를 넣을 수 있습니다.',
    ...
    'error.mailTooFarManage': '우편을 관리하려면 레이븐포스트에 있어야 합니다.',
    'error.mailHasAttachments': '그 편지를 버리기 전에 첨부물을 받으세요.',
    'log.mailSent': '{name}님에게 보낸 편지가 배달 중입니다.',
    'loot.mailCollectCopper': '편지에서 {money}을(를) 회수합니다.',
  ...
  ja_JP: {
    ...
    'error.mailNeedRecipient': '手紙の宛先を指定してください。',
    'error.mailNoRecipient': 'その名前の冒険者は見つかりません。',
    'error.mailTooFarSend': '郵便を送るにはレイヴンポストにいる必要があります。',
    'error.mailCannotMailSelf': '自分自身に手紙を送ることはできません。',
    'error.mailEmptyLetter': '空の手紙には送るものがありません。',
    'error.mailTooManyParcels': '手紙には最大{count}個の小包しか入れられません。',
    ...
    'error.mailTooFarManage': '郵便を管理するにはレイヴンポストにいる必要があります。',
    'error.mailHasAttachments': 'その手紙を破棄する前に添付物を受け取ってください。',
    'log.mailSent': '{name}宛の手紙が配達中です。',
    'loot.mailCollectCopper': '手紙から{money}を受け取りました。',
  ...
  pt_BR: {
    ...
    'error.mailNeedRecipient': 'Informe um destinatário para sua carta.',
    'error.mailNoRecipient': 'Nenhum aventureiro com esse nome é conhecido.',
    'error.mailTooFarSend': 'Você precisa estar no Correio do Corvo para enviar correspondência.',
    'error.mailCannotMailSelf': 'Você não pode enviar correspondência para si mesmo.',
    'error.mailEmptyLetter': 'Uma carta vazia não tem nada para enviar.',
    'error.mailTooManyParcels': 'Uma carta pode carregar no máximo {count} pacotes.',
    ...
    'error.mailTooFarCheck':
      'Você precisa estar no Correio do Corvo para verificar sua correspondência.',
    'error.mailTooFarManage':
      'Você precisa estar no Correio do Corvo para gerenciar sua correspondência.',
    'error.mailHasAttachments': 'Colete os anexos antes de descartar essa carta.',
    'log.mailSent': 'Sua carta para {name} está a caminho.',
    'loot.mailCollectCopper': 'Você coleta {money} de uma carta.',
  ...
  ru_RU: {
    ...
    'error.mailNeedRecipient': 'Укажите получателя для вашего письма.',
    'error.mailNoRecipient': 'Искатель приключений с таким именем неизвестен.',
    'error.mailTooFarSend': 'Чтобы отправить письмо, вы должны находиться у Вороньей почты.',
    'error.mailCannotMailSelf': 'Вы не можете отправить письмо самому себе.',
    'error.mailEmptyLetter': 'В пустом письме нечего отправлять.',
    'error.mailTooManyParcels': 'Письмо может нести не более {count} свёртков.',
    ...
    'error.mailTooFarManage': 'Чтобы управлять почтой, вы должны находиться у Вороньей почты.',
    'error.mailHasAttachments': 'Заберите вложения, прежде чем выбросить это письмо.',
    'log.mailSent': 'Ваше письмо к {name} уже в пути.',
    'loot.mailCollectCopper': 'Вы забираете {money} из письма.',
...
const RULES: Rule[] = [
  // The Ravenpost (in-game mail, PHAA-495): src/sim/mail/post_office.ts's three
  // templated emits (the rest are EXACT-table matches, no placeholder).
  {
    re: /^A letter can carry at most (\d+) parcels\.$/,
    build: (m) => tSim('error.mailTooManyParcels', { count: m[1] }),
  },
  {
    re: /^Your letter to (.+) is on its way\.$/,
    build: (m) => tSim('log.mailSent', { name: m[1] }),
  },
  {
