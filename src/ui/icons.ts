...
const ABILITY_RECIPES: Record<string, IconRecipe> = {
  ...
  chain_heal: r(
    'nature',
    'sky',
    ['droplet', { p: 'droplet', ...TR, s: 0.6 }, { p: 'droplet', ...BL, s: 0.6 }],
    ['arcs', 'sparkle'],
  ),
  crusader_strike: r('holy', 'gold', ['sword', { p: 'sunburst', ...TL }], ['glow']),
  metamorphosis: r('shadow', 'shadowPurple', ['imp_head'], ['glow', 'arcs']),
  holy_shock: r('holy', 'holyGold', ['bolt', { p: 'sunburst', ...BR }], ['glow']),
  holy_shield: r('holy', 'silverWhite', ['shield', { p: 'sunburst', ...TR }], ['glow']),
  bestial_wrath: r('fury', 'venom', ['paw', { p: 'roar', ...TR, s: 0.6 }], ['arcs']),
  trueshot_aura: r('storm', 'sky', ['bow', { p: 'sunburst', ...TL }], ['glow']),
  wyvern_sting: r('nature', 'venom', ['wing', { p: 'fang', ...BR }], ['drips']),
  arcane_power: r('arcane', 'arcanePink', ['sunburst', { p: 'bolt', s: 0.6 }], ['sparkle', 'glow']),
  combustion: r('fire', 'ember', ['flame', { p: 'sunburst', ...TR }], ['glow', 'sparkle']),
  icy_veins: r('frost', 'ice', ['snowflake', { p: 'droplet', ...BR }], ['glow']),
  cold_blood: r('shadow', 'steel', ['dagger', { p: 'eye', ...TR }], ['glow']),
  blade_flurry: r(
    'steel',
    'steel',
    [{ p: 'dagger', x: -8, s: 0.7, rot: -0.4 }, { p: 'dagger', x: 8, s: 0.7, rot: 0.4 }, 'dagger'],
    ['motion'],
  ),
  hemorrhage: r('blood', 'blood', ['dagger', { p: 'claw_slash', ...BR }], ['drips', 'motion']),
  power_infusion: r('holy', 'holyGold', ['hand', { p: 'sunburst', ...TL }], ['sparkle']),
  holy_nova: r('holy', 'holyGold', [{ p: 'sunburst', ...BIG }, 'cross'], ['glow', 'sparkle']),
  shadowform: r('shadow', 'shadowPurple', ['skull', { p: 'tendrils', ...BR }], ['glow']),
  elemental_mastery: r('storm', 'sky', ['lightning', { p: 'sunburst', ...BIG }], ['arcs', 'glow']),
  siphon_life: r('shadow', 'shadowPurple', ['heart', { p: 'tendrils', ...BR }], ['drips']),
  conflagrate: r('fire', 'ember', ['flame', { p: 'skull', ...BR }], ['glow']),
  moonkin_form: r('nature', 'leafGreen', ['moon', { p: 'wing', ...BR }], ['glow']),
  feral_charge: r('earth', 'leather', ['paw', { p: 'roar', ...TR, s: 0.6 }], ['motion']),
  swiftmend: r('nature', 'leafGreen', ['leaf', { p: 'droplet', ...TR }], ['sparkle']),
  pummel: r('fury', 'steel', ['fist', { p: 'bone', ...BR }], ['crack']),
  kick: r('fury', 'leather', ['boot'], ['motion']),
  counterspell: r('arcane', 'arcanePink', ['hand', { p: 'bolt', ...BR }], ['arcs']),
  counter_shot: r('storm', 'sky', ['arrow', { p: 'crosshair', ...TR }], ['motion']),
  rebuke: r('holy', 'gold', ['mace', { p: 'cross', ...TR }], ['glow']),
  skull_bash: r('earth', 'earthBrown', ['skull', { p: 'claw_slash', ...BR }], ['crack']),
  spell_lock: r('shadow', 'shadowPurple', ['hand', { p: 'tendrils', ...BR }], ['arcs']),
};
