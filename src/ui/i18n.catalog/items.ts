...
const itemNamesEn = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Mistcaller's Duffel",
      'Bramblewar Warhelm',
      'Bramblewar Warspaulders',
      'Bramblewar Warplate',
      'Bramblewar Girdle',
      'Bramblewar Legguards',
      'Bramblewar Gauntlets',
      'Bramblewar Sabatons',
      'Thornbound Crown',
      'Thornbound Spaulders',
      'Thornbound Hauberk',
      'Thornbound Waistguard',
      'Thornbound Legmail',
      'Thornbound Handguards',
      'Thornbound Greaves',
      'Nettlestalker Cowl',
      'Nettlestalker Shoulderguards',
      'Nettlestalker Harness',
      'Nettlestalker Waistband',
      'Nettlestalker Legguards',
      'Nettlestalker Grips',
      'Nettlestalker Treads',
      'Mossweave Cowl',
      'Mossweave Mantle',
      'Mossweave Raiment',
      'Mossweave Cord',
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Bolsa de Lino',
        'Mochila del Viajero',
        'Morral de Piel de Lobo',
        'Bolsa Tejida de Tumba',
        'Petate de Mistcaller',
        'Zarzaguerra Cabeza',
        'Zarzaguerra Hombros',
        'Zarzaguerra Pecho',
        'Zarzaguerra Cintura',
        ...
        'Zarzaguerra Manos',
        'Zarzaguerra Pies',
        'Espinovínculo Cabeza',
        'Espinovínculo Hombros',
        'Espinovínculo Pecho',
        'Espinovínculo Cintura',
        'Espinovínculo Piernas',
        'Espinovínculo Manos',
        'Espinovínculo Pies',
        'Ortiga Sombría Cabeza',
        'Ortiga Sombría Hombros',
        'Ortiga Sombría Pecho',
        'Ortiga Sombría Cintura',
        'Ortiga Sombría Piernas',
        'Ortiga Sombría Manos',
        'Ortiga Sombría Pies',
        'Tejemusgo Cabeza',
        'Tejemusgo Hombros',
        'Tejemusgo Pecho',
        ...
        'Tejemusgo Manos',
        'Tejemusgo Pies',
        'Gran Espada de la Última Flor',
        'Navaja Mordespina',
        'Bastón de Guerra de Duramen',
      ]),
    },
  },
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Bourse en Lin',
        'Havresac du Voyageur',
        'Sacoche en Peau de Loup',
        'Sac Tissé des Tombes',
        'Sac Marin de Mistcaller',
        'Ronceguerre Tête',
        'Ronceguerre Épaules',
        'Ronceguerre Torse',
        'Ronceguerre Taille',
        ...
        'Roncelié Pieds',
        'Ortie Furtive Tête',
        'Ortie Furtive Épaules',
        'Ortie Furtive Torse',
        'Ortie Furtive Taille',
        'Ortie Furtive Jambes',
        'Ortie Furtive Mains',
        'Ortie Furtive Pieds',
        'Moussetissé Tête',
        'Moussetissé Épaules',
        ...
        'Moussetissé Mains',
        'Moussetissé Pieds',
        'Grande Lame de la Dernière Fleur',
        "Rasoir Morsure-d'Épine",
        'Bâton de Guerre de Bois de Cœur',
      ]),
    },
  },
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Sacca di Lino',
        'Zaino del Viandante',
        'Bisaccia in Pelle di Lupo',
        'Sacca Tessuta della Tomba',
        'Sacca da Marinaio di Mistcaller',
        'Rovoguerra Testa',
        'Rovoguerra Spalle',
        'Rovoguerra Torace',
        'Rovoguerra Vita',
        ...
        'Rovolegato Mani',
        'Rovolegato Piedi',
        'Ortica Furtiva Testa',
        'Ortica Furtiva Spalle',
        'Ortica Furtiva Torace',
        'Ortica Furtiva Vita',
        'Ortica Furtiva Gambe',
        'Ortica Furtiva Mani',
        'Ortica Furtiva Piedi',
        'Muschiotessuto Testa',
        'Muschiotessuto Spalle',
        'Muschiotessuto Torace',
        'Muschiotessuto Vita',
        'Muschiotessuto Gambe',
        'Muschiotessuto Mani',
        'Muschiotessuto Piedi',
        "Grande Lama dell'Ultimo Fiore",
        'Rasoio Morsospina',
        'Bastone da Guerra di Duramen',
      ]),
    },
  },
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Dorngebunden-Füße',
        'Nesselpirscher-Kopf',
        'Nesselpirscher-Schultern',
        'Nesselpirscher-Brust',
        'Nesselpirscher-Taille',
        'Nesselpirscher-Beine',
        'Nesselpirscher-Hände',
        'Nesselpirscher-Füße',
        'Moosgewebt-Kopf',
        'Moosgewebt-Schultern',
        'Moosgewebt-Brust',
        'Moosgewebt-Taille',
        'Moosgewebt-Beine',
        'Moosgewebt-Hände',
        'Moosgewebt-Füße',
        'Großschwert der letzten Blüte',
        'Dornbiss-Rasiermesser',
        'Kernholz-Kriegsstab',
      ]),
    },
  },
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Bolsa de Linho',
        'Mochila do Viajante',
        'Bolsa de Pele de Lobo',
        'Bolsa Tecida da Tumba',
        'Mala de Viagem de Mistcaller',
        'Espinhoguerra Cabeça',
        'Espinhoguerra Ombros',
        'Espinhoguerra Peito',
        'Espinhoguerra Cintura',
        'Espinhoguerra Pernas',
        'Espinhoguerra Mãos',
        'Espinhoguerra Pés',
        'Espinholigado Cabeça',
        'Espinholigado Ombros',
        'Espinholigado Peito',
        'Espinholigado Cintura',
        'Espinholigado Pernas',
        'Espinholigado Mãos',
        'Espinholigado Pés',
        'Urtiga Furtiva Cabeça',
        'Urtiga Furtiva Ombros',
        'Urtiga Furtiva Peito',
        'Urtiga Furtiva Cintura',
        'Urtiga Furtiva Pernas',
        'Urtiga Furtiva Mãos',
        'Urtiga Furtiva Pés',
        'Musgotecido Cabeça',
        'Musgotecido Ombros',
        ...
        'Musgotecido Mãos',
        'Musgotecido Pés',
        'Grande Lâmina da Última Flor',
        'Navalha Mordespinho',
        'Cajado de Guerra de Cerne',
      ]),
    },
  },
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Терносвяз: Кисти рук',
        'Терносвяз: Ступни',
        'Крапивный Ловчий: Голова',
        'Крапивный Ловчий: Плечи',
        'Крапивный Ловчий: Грудь',
        'Крапивный Ловчий: Пояс',
        'Крапивный Ловчий: Ноги',
        'Крапивный Ловчий: Кисти рук',
        'Крапивный Ловчий: Ступни',
        'Мохоткань: Голова',
        'Мохоткань: Плечи',
        'Мохоткань: Грудь',
        'Мохоткань: Пояс',
        ...
        'Мохоткань: Кисти рук',
        'Мохоткань: Ступни',
        'Большой клинок последнего цветка',
        'Бритва Шипоукус',
        'Боевой посох сердцевины',
      ]),
    },
  },
};
