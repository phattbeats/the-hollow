...
const ITEM_ENTITY_IDS = [
  ...
  "soft_down", "amber_hide", "stag_antler", "brightwood_venison", "bramblehide_jerkin", "monarch_crown_helm",
] as const;
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Cragwalker Boots", "Windguard Leggings", "Ogre Toe Ring", "Inert Storm Shard", "Frayed Prayer Beads", "Cracked Wyrm Scale",
          ...
          "Soft Down Tuft", "Amber Hide", "Branching Antler", "Brightwood Venison", "Bramblehide Jerkin", "Monarch's Crown",
    ]),
  },
};
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Botas Caminarrocas", "Leotardos Guardavientos", "Anillo de dedo de ogro", "Fragmento de tormenta inerte", "Cuentas de oración deshilachadas", "Escama de wyrm agrietada",
            ...
            "Mechón de plumón suave", "Piel ambarina", "Asta ramificada", "Venado de Brightwood", "Jubón de piel de zarza", "Corona del Monarca",
    ]),
    },
  },
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Bottes Marchecrag", "Jambières Gardevent", "Anneau d'orteil ogre", "Éclat de tempête inerte", "Perles de prière effilochées", "Écaille de wyrm fendue",
            ...
            "Touffe de duvet doux", "Peau d'ambre", "Andouiller ramifié", "Venaison de Brightwood", "Justaucorps en peau de ronces", "Couronne du Monarque",
    ]),
    },
  },
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Stivali Camminarocce", "Gambiere Guardavento", "Anello da dito d'ogre", "Scheggia di tempesta inerte", "Grani di preghiera sfilacciati", "Scaglia di wyrm incrinata",
            ...
            "Ciuffo di piumino morbido", "Pelle d'ambra", "Corno ramificato", "Selvaggina di Brightwood", "Giubbotto di pelle di rovo", "Corona del Monarca",
    ]),
    },
  },
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Felswandererstiefel", "Windwachtgamaschen", "Ogerzehenring", "Träger Sturmsplitter", "Ausgefranste Gebetsperlen", "Gesprungene Wyrmschuppe",
            ...
            "Weicher Daunenbüschel", "Bernsteinhaut", "Verzweigtes Geweih", "Hellholz-Wildbret", "Dornhaut-Wams", "Krone des Monarchen",
    ]),
    },
  },
  zh_CN: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "바위걸음 장화", "바람수호 다리보호구", "오우거 발가락 반지", "비활성 폭풍 파편", "해진 기도 구슬", "갈라진 고룡 비늘",
            ...
            "부드러운 솜털 뭉치", "호박색 가죽", "가지진 사슴뿔", "브라이트우드 사슴고기", "가시가죽 저킨", "군주의 왕관",
    ]),
    },
  },
  ja_JP: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "岩歩きのブーツ", "風守りのレギンス", "オーガの足指輪", "不活性の嵐片", "ほつれた祈りの数珠", "割れたワームの鱗",
            ...
            "柔らかな綿毛", "琥珀色の革", "枝分かれした角", "ブライトウッドの鹿肉", "茨革のジャーキン", "君主の王冠",
    ]),
    },
  },
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Botas Caminhapedra", "Perneiras Guardavento", "Anel de dedo de ogro", "Estilhaço de tempestade inerte", "Contas de oração desfiadas", "Escama de wyrm rachada",
            ...
            "Tufo de penugem macia", "Couro âmbar", "Galhada ramificada", "Carne de veado de Brightwood", "Gibão de couro de sarça", "Coroa do Monarca",
    ]),
    },
  },
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Сапоги Камнехода", "Поножи Ветростража", "Кольцо на палец огра", "Инертный осколок бури", "Истрепанные молитвенные четки", "Треснувшая чешуя вирма",
            ...
            "Пучок мягкого пуха", "Янтарная шкура", "Ветвистый рог", "Оленина Брайтвуда", "Колет из терновой шкуры", "Корона Монарха",
    ]),
    },
  },
};
