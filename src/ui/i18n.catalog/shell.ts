...
export const shellStrings = {
  en: {
    seo: {
      ...
      description:
        'Embark on an epic adventure in The Hollow, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
