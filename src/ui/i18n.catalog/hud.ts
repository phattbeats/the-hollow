  ...
  fr_FR: {
    hud: {
      tutorial: {
        ...
        slayBody: "Traque les loups des forêts sur la route du nord. Cible-en un et attaque pour réduire la meute.",
        slayProgress: "Loups des forêts tués : {current} / {needed}",
  ...
  de_DE: {
    hud: {
      tutorial: {
        ...
        doneBody: "Du beherrschst die Grundlagen, {name}. Das Tal liegt vor dir – drücke jederzeit {questKey}, um deine Quests einzusehen. Gute Jagd!",
        moveTitle: "Finde deinen Tritt",
        ...
        seekBody: "Marschall Redbrook wartet in der Stadt und hat Arbeit für eine neue Klinge. Folge der Markierung zu ihm.",
        talkTitle: "Nimm die Aufgabe an",
        talkBody: "Stell dich nahe an Marschall Redbrook und drücke {interactKey}, um zu sprechen, und nimm dann seine Aufgabe an.",
        slayTitle: "Wölfe vor der Tür",
        slayBody: "Jage die Waldwölfe auf der Nordstraße. Ziele auf einen und greife an, um das Rudel zu lichten.",
        slayProgress: "Erlegte Waldwölfe: {current} / {needed}",
        returnTitle: "Fordere deine Belohnung",
  ...
  zh_TW: {
    hud: {
      tutorial: {
        ...
        dismiss: "關閉",
        doneTitle: "準備好冒險了",
        doneBody: "你已掌握基礎，{name}。山谷任你探索——隨時按 {questKey} 查看任務。祝你狩獵順利！",
        moveTitle: "邁出第一步",
        moveBody: "使用 {moveKeys} 移動，用滑鼠環顧四周。先走幾步開始吧。",
        seekTitle: "尋找鎮長",
        seekBody: "雷德布魯克鎮長在鎮上等候，他有任務交給新人。跟隨指引前往找他。",
        talkTitle: "接受任務",
        talkBody: "靠近雷德布魯克鎮長並按 {interactKey} 與他交談，然後接受他的任務。",
        slayTitle: "狼群來襲",
        slayBody: "前往北路獵殺森林狼。選中一隻並發動攻擊，削減狼群。",
        slayProgress: "已擊殺森林狼：{current} / {needed}",
        returnTitle: "領取獎勵",
        returnBody: "任務已完成。返回雷德布魯克鎮長處並按 {interactKey} 繳交任務。",
      },
      core: {
        elite: "精英",
        boss: "首領",
  ...
  ru_RU: {
    hud: {
      tutorial: {
        ...
        dismiss: "Закрыть",
        doneTitle: "Готов к приключениям",
        doneBody: "Основы освоены, {name}. Долина ждёт — нажмите {questKey} в любой момент, чтобы просмотреть задания. Удачной охоты!",
        moveTitle: "Сделай первые шаги",
        ...
        seekBody: "Маршал Редбрук ждёт в городе, и у него есть работа для новичка. Следуйте за меткой, чтобы добраться до него.",
        ...
        slayBody: "Истребляйте лесных волков на северной дороге. Выберите цель и атакуйте, чтобы проредить стаю.",
