...
const en: Messages = {
  ...
  'moderation.banConfirm': 'Banned {name} for {duration}.',
  'moderation.muteUsage': 'Usage: /mute <minutes> <reason>',
  'moderation.banUsage': 'Usage: /ban <minutes> <reason>',
...
const es: Messages = {
  ...
  'moderation.banConfirm': 'Has baneado a {name} durante {duration}.',
  'moderation.muteUsage': 'Uso: /mute <minutos> <motivo>',
  'moderation.banUsage': 'Uso: /ban <minutos> <motivo>',
...
const fr: Messages = {
  ...
  'moderation.banConfirm': '{name} est banni pour {duration}.',
  'moderation.muteUsage': 'Usage : /mute <minutes> <raison>',
  'moderation.banUsage': 'Usage : /ban <minutes> <raison>',
...
const it: Messages = {
  ...
  'moderation.banConfirm': '{name} è stato bandito per {duration}.',
  'moderation.muteUsage': 'Uso: /mute <minuti> <motivo>',
  'moderation.banUsage': 'Uso: /ban <minuti> <motivo>',
...
const de: Messages = {
  ...
  'moderation.banConfirm': '{name} wurde für {duration} gebannt.',
  'moderation.muteUsage': 'Verwendung: /mute <Minuten> <Grund>',
  'moderation.banUsage': 'Verwendung: /ban <Minuten> <Grund>',
...
const zhCN: Messages = {
  ...
  'moderation.banConfirm': '已封禁 {name} {duration}。',
  'moderation.muteUsage': '用法：/mute <分钟> <原因>',
  'moderation.banUsage': '用法：/ban <分钟> <原因>',
...
const zhTW: Messages = {
  ...
  'moderation.banUsage': '用法：/ban <分鐘> <原因>',
  'moderation.spectateUsage': '用法：/spectate <名字>',
...
const ko: Messages = {
  ...
  'moderation.banConfirm': '{name}님을 {duration} 동안 차단했습니다.',
  'moderation.muteUsage': '사용법: /mute <분> <사유>',
  'moderation.banUsage': '사용법: /ban <분> <사유>',
...
const ja: Messages = {
  ...
  'moderation.banConfirm': '{name} を {duration} の間 BAN しました。',
  'moderation.muteUsage': '使い方: /mute <分> <理由>',
  'moderation.banUsage': '使い方: /ban <分> <理由>',
...
const pt: Messages = {
  ...
  'moderation.banConfirm': '{name} foi banido por {duration}.',
  'moderation.muteUsage': 'Uso: /mute <minutos> <motivo>',
  'moderation.banUsage': 'Uso: /ban <minutos> <motivo>',
  'moderation.spectateUsage': 'Uso: /spectate <nome>',
...
const ru: Messages = {
  ...
  'moderation.banConfirm': '{name} забанен на {duration}.',
  'moderation.muteUsage': 'Использование: /mute <минуты> <причина>',
  'moderation.banUsage': 'Использование: /ban <минуты> <причина>',
...
const da: Messages = {
  ...
  'moderation.banConfirm': '{name} blev udelukket i {duration}.',
  'moderation.muteUsage': 'Brug: /mute <minutter> <årsag>',
  'moderation.banUsage': 'Brug: /ban <minutter> <årsag>',
...
const id: Messages = {
  ...
  'moderation.banConfirm': '{name} diblokir selama {duration}.',
  'moderation.muteUsage': 'Penggunaan: /mute <menit> <alasan>',
  'moderation.banUsage': 'Penggunaan: /ban <menit> <alasan>',
...
const nl: Messages = {
  ...
  'moderation.banConfirm': '{name} is voor {duration} verbannen.',
  'moderation.muteUsage': 'Gebruik: /mute <minuten> <reden>',
  'moderation.banUsage': 'Gebruik: /ban <minuten> <reden>',
...
const pl: Messages = {
  ...
  'moderation.banConfirm': 'Gracz {name} został zbanowany na {duration}.',
  'moderation.muteUsage': 'Użycie: /mute <minuty> <powód>',
  'moderation.banUsage': 'Użycie: /ban <minuty> <powód>',
...
const sv: Messages = {
  ...
  'moderation.banConfirm': '{name} har stängts av i {duration}.',
  'moderation.muteUsage': 'Användning: /mute <minuter> <orsak>',
  'moderation.banUsage': 'Användning: /ban <minuter> <orsak>',
...
const tr: Messages = {
  ...
  'moderation.banConfirm': '{name}, {duration} boyunca yasaklandı.',
  'moderation.muteUsage': 'Kullanım: /mute <dakika> <neden>',
  'moderation.banUsage': 'Kullanım: /ban <dakika> <neden>',
...
const vi: Messages = {
  ...
  'moderation.banConfirm': '{name} đã bị cấm trong {duration}.',
  'moderation.muteUsage': 'Cách dùng: /mute <phút> <lý do>',
  'moderation.banUsage': 'Cách dùng: /ban <phút> <lý do>',
