...
const esQuestNarratives = {
  ...
  q_silence_the_call: [`Cada nombre del registro es un alma que Morthen quiere arrancar de la tierra. Silencia 12 huesos inquietos antes de que el susurro sea coro.`, `El patio está más quieto, pero la llamada sube ahora desde la cripta, {playerName}.`],
  ...
  q_sexton: [`El registro nombra al sacristán Marrow, primer guardián alzado por Morthen. Entra con cuatro compañeros y dale el descanso robado.`, `Marrow es libre al fin. No doblen campanas por él; oyó bastantes en vida.`],
  q_gravecallers_trail: [`Morthen murió, pero su secta no gastaría un siglo de silencio en una sola capilla. Busca su grimorio entre las ruinas, {playerName}.`, `Morthen escribía a un "Mistcaller" en la ciénaga norte. La secta no está muerta; solo esperó.`],
  ...
  q_fenbridge_muster: [`Los escritos de Morthen nombran a un maestro en la ciénaga norte. Toma la orden de reunión en la puerta de Fenbridge y llévala al guardián.`, `¿El sello de Aldric? Servirás. La ciénaga se traga mis patrullas enteras.`],
  ...
  q_prowler_pelts: [`La calzada se sostiene con piel de merodeador aceitada, y mis reservas se acabaron. Tráeme 8 pieles intactas antes de vadear hasta Eastbrook.`, `Buenas pieles gruesas. Ahora la calzada nos sobrevivirá a ambos.`],
  ...
  q_broodmother: [`Si las redes son tan gruesas, imagina qué las teje. Quema paso entre 8 viudas y mata a la vieja madre antes de que eclosione su puesta.`, `¿Muerta de verdad? Entonces el matorral vuelve a ser solo árboles.`],
  ...
  q_trolls: [`Los trolls de Mirefen abrieron túmulos más viejos que cualquier reino humano. Expúlsalos: 12 trolls muertos bastarán.`, `Los trolls no cavan sin motivo. Alguien de túnica gris les dijo dónde.`],
  ...
  q_grubjaw: [`Grubjaw no cava con los demás; se comió mis dos últimas mulas, arneses incluidos. Tráeme su colmillo.`, `¡Ese colmillo me llega al antebrazo! Las mulas están vengadas.`],
  ...
  q_summoners: [`Los invocadores llaman a los ahogados como perros a un silbato. Silencia 8 y tráeme 4 cifras.`, `Cada cifra está refrendada por el diácono Voss y enviada al Mistcaller. Lo hemos encontrado.`],
  ...
  q_bastion_door: [`El Bastión Sumergido guarda al Mistcaller, y su puerta está sellada con piedras de tumba. Tráeme una piedra guardiana.`, `El sello cede como cuerda podrida. La puerta se abre, y la oscuridad escucha.`],
  q_olen: [`Olen murió defendiendo el Bastión y ahora vigila su puerta como marioneta. Baja con cuatro compañeros y dale el descanso que ganó.`, `Su guardia terminó por fin. Yo mismo grabaré su nombre en la puerta.`],
  q_mistcaller: [`Vael espera en el fondo del Bastión, voz que ahogó a cien viajeros. Lleva cuatro compañeros y acaba con él, {playerName}.`, `Vael murió y la niebla se levanta, pero sus últimas palabras hielan: el Wyrm se agita bajo los picos.`],
  q_highwatch_summons: [`Las últimas palabras de Vael no me dejan, {playerName}. Toma la citación de Highwatch y dile a Thessaly que Aldric sube tras de ti.`, `Si Aldric sube en persona, esto es tan grave como temía. Bienvenido a Highwatch.`],
  ...
  q_stalker_pelts: [`El invierno de esta montaña derriba puertas. Ocho pieles de acechador forrarán capas para la muralla.`, `Gruesas como mi brazo. La guardia no se congelará este año.`],
  q_kobold_tunnels: [`Los kobolds de Deeprock cavan recto hacia abajo, como si algo los llamara bajo la muralla. Mata 12 tuneladores.`, `Cada galería baja en línea recta. Los kobolds no cavan así por voluntad propia.`],
  q_glowing_wax: [`La cera de esos tuneladores brilla y está cálida como un latido. Trae 6 trozos para que Caddis la estudie.`, `Sigue tibia. El brillo no coincide con ninguna llama que conozca el maestro.`],
  ...
  q_ogre_totems: [`Los ogros levantaron tótems de cuero y cráneo: señales de reunión, no de incursión. Derriba 6 y tráemelos.`, `Calavera, cuero... y ligaduras de escama de wyrm. Son regalos del culto, {playerName}.`],
  ...
  q_drogmar: [`Drogmar tomó la moneda del Wyrmcult y juró los clanes al despertar de la montaña. Entra en su campamento y mátalo por Highwatch.`, `Drogmar yace muerto en su propio campamento. Compraste un invierno para mi muralla, {playerName}.`],
  q_elementals: [`Stormcrag calló mil años y ahora sus piedras caminan. Derriba 12 elementales para estudiar lo que quede.`, `Los fragmentos zumban como campanas. La montaña no está furiosa, la están perturbando.`],
  q_shard_cores: [`Cada elemental lleva un núcleo de tormenta. Seis juntos me dirán dónde nace la perturbación, aunque temo saberlo.`, `Todos apuntan al sur como limaduras hacia un imán. Al Santuario, {playerName}.`],
  ...
  q_zealots: [`El viento trae cánticos desde los picos del sur. Silencia 12 fanáticos, {playerName}; cada voz callada compra otra noche de sueño.`, `El viento está más callado. Lo que me inquieta es que algo quizá responda al canto.`],
  q_cult_orders: [`Los fanáticos se mueven como soldados antes de un asedio. Mata 8 más y tráeme 4 órdenes escritas.`, `Esta letra viene del grimorio de Morthen. La misma mano guio cada tumba, {playerName}.`],
  q_necromancers: [`Las órdenes hablan de un anillo de filacterias, vasos de alma alrededor del Santuario. Mata 8 nigromantes y trae 3 intactas.`, `Que la Luz nos perdone. Guardan los muertos del Valle y la ciénaga; eran un diezmo.`],
  q_revenants: [`Al este del camino yace un viejo campo de batalla. El culto levantó sus huesos con armaduras oxidadas. Devuelve 12 al suelo.`, `Fueron soldados como los míos. Quien los llamó no respeta a los muertos.`],
  ...
  q_wyrm_sigils: [`Los Gravecallers sirven a Korzul el Gravewyrm, y cada alma robada alimenta su despertar. Tráeme 3 sigilos del acceso al Santuario.`, `Sí... una letanía de despertar escrita durante generaciones. Están cerca, {playerName}.`],
  q_breaking_the_seal: [`El sello del Santuario se forjó con fuego de montaña. Trae 5 brasas benditas de los elementales para abrirlo sin romperlo.`, `Arden azules y limpias. La montaña recuerda su antiguo juramento.`],
  q_voice_below: [`Anoche el campamento entero se arrodilló mirando al Santuario. Mata 10 fanáticos y 6 nigromantes antes de que esa voz tenga manos suficientes.`, `La genuflexión cesó. No silenciamos la voz, {playerName}; solo redujimos su coro.`],
  q_sanctum_gate: [`La llave del Santuario fue rota en fragmentos bajo la mirada de los muertos acorazados. Tráeme 3 y abriré el camino en silencio.`, `Los fragmentos encajan y la puerta reconoce su llave. Reúne a los más fuertes, {playerName}.`],
  q_korgath: [`Maren halló cadenas gruesas como mástiles y algo con forma de ogro tirando de ellas. Lleva cuatro compañeros y derriba a Korgath.`, `Korgath está roto al fin. Hasta sus cadenas merecían un final más amable.`],
...
const frQuestNarratives = {
  ...
  q_silence_the_call: [`Chaque nom du registre est une âme que Morthen veut tirer de terre. Faites taire 12 ossements avant que le murmure devienne choeur.`, `Le cimetière se calme, mais l'appel monte maintenant de la crypte, {playerName}.`],
  ...
  q_sexton: [`Le registre nomme le sacristain Marrow, premier serviteur relevé par Morthen. Descendez avec quatre compagnons et rendez-lui son repos.`, `Marrow est enfin libre. Ne sonnez pas pour lui; il a assez entendu de cloches.`],
  q_gravecallers_trail: [`Morthen est mort, mais sa secte n'aurait pas attendu un siècle pour une seule chapelle. Cherchez son grimoire dans les ruines, {playerName}.`, `Morthen écrivait à un Mistcaller dans le marais du nord. La secte n'est pas morte; elle a patienté.`],
  ...
  q_fenbridge_muster: [`Les écrits de Morthen nomment un maître dans le marais du nord. Prenez l'ordre de rassemblement à Fenbridge et présentez-le au gardien.`, `Le sceau d'Aldric? Alors vous ferez l'affaire. Le marais avale mes patrouilles entières.`],
  ...
  q_prowler_pelts: [`La chaussée tient grâce à des peaux de rôdeur huilées, et mon stock est vide. Rapportez 8 peaux intactes avant que nous pataugions jusqu'à Eastbrook.`, `De bonnes peaux épaisses. La chaussée nous survivra maintenant.`],
  ...
  q_broodmother: [`Des toiles grosses comme des cordes ont forcément une mère. Brûlez la voie à travers 8 veuves et tuez l'ancienne avant l'éclosion.`, `Vraiment morte? Alors le fourré redevient seulement des arbres.`],
  ...
  q_trolls: [`Les trolls de Mirefen ont ouvert des tertres plus vieux que les royaumes humains. Chassez-les: 12 trolls morts suffiront.`, `Les trolls ne creusent jamais sans raison. Quelqu'un en robe grise les a guidés.`],
  ...
  q_grubjaw: [`Grubjaw ne creuse pas avec les autres; il a mangé mes deux dernières mules, harnais compris. Rapportez-moi sa défense.`, `Cette défense est longue comme mon avant-bras! Les mules sont vengées.`],
  q_cult_camp: [`Au nord, là où la brume ne se lève jamais, les Gravecallers campent comme s'ils possédaient déjà le marais. Tuez 12 cultistes.`, `Douze robes face contre boue. Ils savent maintenant que le marais les regarde aussi.`],
  q_summoners: [`Les invocateurs appellent les noyés comme des chiens au sifflet. Faites-en taire 8 et rapportez 4 chiffres.`, `Chaque chiffre porte le contreseing du diacre Voss et s'adresse au Mistcaller. Nous l'avons trouvé.`],
  ...
  q_bastion_door: [`Le Bastion englouti abrite le Mistcaller, et sa porte est scellée par des pierres tombales. Rapportez une pierre de garde.`, `Le sceau cède comme une corde pourrie. La porte est ouverte, et l'ombre écoute.`],
  q_olen: [`Olen est mort en défendant le Bastion et garde maintenant sa porte en pantin. Descendez avec quatre compagnons et rendez-lui son repos.`, `Sa garde est enfin terminée. Je ferai graver son nom sur la porte moi-même.`],
  q_mistcaller: [`Vael attend au fond du Bastion, voix qui a noyé cent voyageurs. Prenez quatre compagnons et mettez-y fin, {playerName}.`, `Vael est mort et la brume se lève, mais ses derniers mots glacent: le Wyrm remue sous les pics.`],
  q_highwatch_summons: [`Les derniers mots de Vael ne me quittent pas, {playerName}. Prenez la convocation de Highwatch et dites à Thessaly qu'Aldric monte derrière vous.`, `Si Aldric monte lui-même, c'est aussi grave que je le craignais. Bienvenue à Highwatch.`],
  ...
  q_stalker_pelts: [`L'hiver de cette montagne n'attend pas qu'on ouvre. Huit peaux de traqueur doubleront les capes du mur.`, `Épaisses comme mon bras. La garde ne gèlera pas cette année.`],
  q_kobold_tunnels: [`Les kobolds de Deeprock creusent droit vers le bas, comme appelés sous le mur. Tuez 12 tunneliers.`, `Tout descend droit. Les kobolds ne creusent pas ainsi seuls.`],
  q_glowing_wax: [`La cire de ces tunneliers luit et reste chaude comme un coeur. Rapportez 6 morceaux pour l'étude de Caddis.`, `Encore chaude. Cette lueur ne ressemble à aucune flamme connue du maître.`],
  ...
  q_ogre_totems: [`Les ogres ont dressé des totems de peau et de crâne: une muster, pas un raid. Abattez-en 6 et rapportez-les.`, `Crâne, peau... et liens d'écailles de wyrm. Ce sont des cadeaux du culte, {playerName}.`],
  ...
  q_drogmar: [`Drogmar a pris la monnaie du Wyrmcult et juré les clans au réveil de la montagne. Entrez dans son camp et tuez-le pour Highwatch.`, `Drogmar est mort dans son propre camp. Vous avez acheté un hiver à mon mur, {playerName}.`],
  q_elementals: [`Stormcrag est resté muet mille ans, et ses pierres marchent. Tuez 12 élémentaires pour que j'étudie les restes.`, `Les fragments vibrent comme des cloches frappées. La montagne n'est pas en colère, on la dérange.`],
  q_shard_cores: [`Chaque élémentaire porte un coeur de tempête. Six côte à côte révéleront le centre du trouble, même si je le redoute.`, `Tous pointent au sud comme de la limaille vers un aimant. Vers le Sanctuaire, {playerName}.`],
  ...
  q_zealots: [`Le vent porte des chants depuis les pics du sud. Faites taire 12 zélotes, {playerName}; chaque voix tue achète une nuit de sommeil.`, `Le vent est plus calme. Ce qui m'inquiète, c'est que quelque chose réponde peut-être.`],
  q_cult_orders: [`Les zélotes bougent comme des soldats avant un siège. Tuez-en 8 autres et rapportez 4 jeux d'ordres.`, `Cette écriture vient du grimoire de Morthen. La même main a guidé chaque tombe, {playerName}.`],
  q_necromancers: [`Les ordres parlent d'un anneau de phylactères, vases d'âme autour du Sanctuaire. Tuez 8 nécromanciens et rapportez-en 3 intacts.`, `Que la Lumière nous pardonne. Ils contiennent les morts du Val et du marais; c'était une dîme.`],
  q_revenants: [`À l'est de la route dort un vieux champ de bataille. Le culte a relevé ses os en armures rouillées. Remettez-en 12 en terre.`, `Ils furent soldats, comme les miens. Ce qui les a relevés ne respecte pas les morts.`],
  ...
  q_wyrm_sigils: [`Les Gravecallers servent Korzul le Gravewyrm, et chaque âme volée nourrit son réveil. Rapportez 3 sigils de l'approche du Sanctuaire.`, `Oui... une litanie de réveil écrite sur des générations. Ils sont proches, {playerName}.`],
  q_breaking_the_seal: [`Le sceau du Sanctuaire fut forgé au feu de montagne. Rapportez 5 braises bénies des élémentaires pour l'ouvrir sans le déchirer.`, `Elles brûlent bleu et pur. La montagne se souvient de son ancien serment.`],
  q_voice_below: [`Hier, tout le camp s'est agenouillé face au Sanctuaire. Tuez 10 zélotes et 6 nécromanciens avant que cette voix ait assez de mains.`, `L'agenouillement a cessé. Nous n'avons pas réduit la voix au silence, {playerName}; seulement son choeur.`],
  q_sanctum_gate: [`La clef du Sanctuaire fut brisée sous les yeux des morts cuirassés. Rapportez 3 éclats et j'ouvrirai la voie en silence.`, `Les éclats s'ajustent et la porte reconnaît sa clef. Rassemblez les plus forts, {playerName}.`],
  q_korgath: [`Maren a trouvé des chaînes grosses comme des mâts et une forme d'ogre qui tirait dessus. Prenez quatre compagnons et abattez Korgath.`, `Korgath est enfin brisé. Même ses chaînes méritaient une fin plus douce.`],
...
const deQuestNarratives = {
  ...
  q_silence_the_call: [`Jeder Name im Buch ist eine Seele, die Morthen aus der Erde ziehen will. Bringe 12 ruhelose Knochen zum Schweigen, bevor der Flüsterton zum Chor wird.`, `Der Hof wird stiller, doch der Ruf steigt jetzt aus der Gruft, {playerName}.`],
  ...
  q_sexton: [`Das Buch nennt Küster Marrow, Morthens ersten erhobenen Wächter. Steig mit vier Gefährten hinab und gib ihm die geraubte Ruhe zurück.`, `Marrow ist endlich frei. Läutet keine Glocke für ihn; er hörte im Leben genug.`],
  q_gravecallers_trail: [`Morthen ist tot, doch seine Sekte verschwendet kein Jahrhundert des Schweigens an eine einzige Kapelle. Suche sein Grimoire in den Ruinen, {playerName}.`, `Morthen schrieb an einen Mistcaller im nördlichen Moor. Die Sekte ist nicht tot; sie war nur geduldig.`],
  ...
  q_fenbridge_muster: [`Morthens Schriften nennen einen Meister im Nordmoor. Zieh den Musterungsbefehl vom Tor in Fenbridge und zeig ihn dem Wärter.`, `Aldrics Siegel, ja? Dann taugst du. Das Moor verschlingt meine Patrouillen ganz.`],
  ...
  q_prowler_pelts: [`Der Damm hält nur durch geölte Pirscherfelle, und mein Vorrat ist aufgebraucht. Bring 8 unversehrte Bälge, bevor wir nach Eastbrook waten.`, `Gute, dicke Bälge. Der Damm wird uns beide überdauern.`],
  ...
  q_broodmother: [`Netze dick wie Taue haben eine Mutter. Brenn dich durch 8 Witwen und leg die Alte um, bevor ihr Gelege schlüpft.`, `Wirklich tot? Dann ist das Dickicht wieder nur ein Wald.`],
  ...
  q_trolls: [`Die Mirefen-Trolle reißen Hügelgräber auf, älter als Menschenreiche. Vertreib sie: 12 tote Trolle sollten genügen.`, `Trolle graben nicht ohne Grund. Jemand in grauer Robe zeigte ihnen die Stelle.`],
  ...
  q_grubjaw: [`Grubjaw gräbt nicht mit den anderen; er fraß meine letzten zwei Packmulis samt Geschirr. Bring mir seinen Hauer.`, `Dieser Hauer ist so lang wie mein Unterarm! Die Maultiere sind gerächt.`],
  ...
  q_summoners: [`Beschwörer rufen die Ertrunkenen wie Hunde zur Pfeife. Bring 8 zum Schweigen und hol 4 Chiffren.`, `Jede Chiffre ist von Diakon Voss gegengezeichnet und an den Mistcaller gerichtet. Wir haben ihn gefunden.`],
  ...
  q_bastion_door: [`Die versunkene Bastion birgt den Mistcaller, und ihre Tür ist mit Grabsteinen versiegelt. Bring mir einen Wachstein.`, `Das Siegel zerfällt wie morsches Tau. Die Tür steht offen, und die Dunkelheit lauscht.`],
  q_olen: [`Olen starb bei der Verteidigung der Bastion und bewacht nun als Marionette ihre Tür. Geh mit vier Gefährten hinab und gib ihm Ruhe.`, `Seine Wacht ist endlich vorüber. Ich werde seinen Namen selbst ins Tor schlagen.`],
  q_mistcaller: [`Vael wartet am Grund der Bastion, die Stimme, die hundert Reisende ertränkte. Nimm vier Gefährten und beende ihn, {playerName}.`, `Vael ist tot und der Nebel hebt sich, doch seine letzten Worte frieren Blut: Der Wyrm regt sich unter den Gipfeln.`],
  q_highwatch_summons: [`Vaels letzte Worte lassen mich nicht los, {playerName}. Nimm die Einberufung von Highwatch und sag Thessaly, dass Aldric hinter dir aufsteigt.`, `Wenn Aldric selbst den Berg steigt, ist es so schlimm wie befürchtet. Willkommen in Highwatch.`],
  ...
  q_stalker_pelts: [`Der Winter dieser Berge klopft nicht an, er tritt die Tür ein. Acht Pirscherfelle füttern genug Mäntel für die Mauer.`, `Dick wie mein Arm. Die Wacht wird dieses Jahr nicht erfrieren.`],
  q_kobold_tunnels: [`Die Kobolde von Deeprock graben gerade nach unten, als rufe etwas unter der Mauer. Töte 12 Tunnelgräber.`, `Jeder Schacht führt senkrecht hinab. Kobolde graben nicht von allein so.`],
  q_glowing_wax: [`Das Wachs dieser Gräber leuchtet und ist warm wie ein Herzschlag. Bring 6 Brocken für Caddis' Studien.`, `Noch immer warm. Dieses Leuchten passt zu keiner Flamme, die der Lehrmeister kennt.`],
  ...
  q_ogre_totems: [`Die Oger stellten Totems aus Haut und Schädeln auf: Musterzeichen, kein Raubzug. Reiße 6 nieder und bring sie her.`, `Schädel, Haut... und Wyrmschuppen-Bindungen. Das sind Geschenke des Kults, {playerName}.`],
  ...
  q_drogmar: [`Drogmar nahm Wyrmkult-Gold und schwor die Clans dem Erwachen des Berges. Geh ins Kriegslager und töte ihn für Highwatch.`, `Drogmar liegt tot im eigenen Lager. Du hast meiner Mauer einen Winter erkauft, {playerName}.`],
  q_elementals: [`Stormcrag schwieg tausend Jahre, und nun laufen seine Steine. Erlege 12 Elementare, damit ich die Reste prüfen kann.`, `Die Splitter summen wie angeschlagene Glocken. Der Berg ist nicht zornig, {playerName}; er wird gestört.`],
  q_shard_cores: [`Im Herzen jedes Elementars sitzt ein Sturmkern. Sechs nebeneinander zeigen mir den Ursprung der Störung, so sehr ich ihn fürchte.`, `Alle zeigen nach Süden wie Späne zum Magneten. Zum Heiligtum, {playerName}.`],
  ...
  q_zealots: [`Der Wind trägt Gesänge von den Südgipfeln. Bringe 12 Eiferer zum Schweigen, {playerName}; jede Stimme kauft dem Berg Schlaf.`, `Der Wind ist stiller. Was mich beunruhigt: Vielleicht singt etwas zurück.`],
  q_cult_orders: [`Die Eiferer bewegen sich wie Soldaten vor einer Belagerung. Töte 8 weitere und bring 4 Befehlssätze.`, `Diese Schrift kenne ich aus Morthens Grimoire. Dieselbe Hand führte jedes Grab, {playerName}.`],
  q_necromancers: [`Die Befehle nennen einen Ring von Phylakterien, Seelengefäße um das Heiligtum. Töte 8 Nekromanten und bring 3 unversehrt.`, `Licht, vergib uns. Darin sind die Toten aus Tal und Moor; sie waren ein Zehnt.`],
  q_revenants: [`Östlich der Straße liegt ein altes Schlachtfeld. Der Kult hob die Knochen in rostiger Rüstung. Leg 12 zurück in die Erde.`, `Sie waren Soldaten wie meine. Was sie rief, achtet die Toten nicht.`],
  ...
  q_wyrm_sigils: [`Die Gravecaller dienen Korzul dem Gravewyrm, und jede gestohlene Seele nährt sein Erwachen. Bring mir 3 Siegel vom Zugang zum Heiligtum.`, `Ja... eine Wecklitanei, über Generationen geschrieben. Sie sind nah, {playerName}.`],
  q_breaking_the_seal: [`Das Siegel des Heiligtums wurde mit Bergfeuer geschmiedet. Bring 5 gesegnete Gluten von Elementaren, damit wir es öffnen statt zerreißen.`, `Sie brennen blau und rein. Der Berg erinnert sich an seinen alten Schwur.`],
  q_voice_below: [`Gestern kniete das ganze Lager zum Heiligtum. Töte 10 Eiferer und 6 Nekromanten, bevor diese Stimme genug Hände hat.`, `Das Knien hat aufgehört. Wir haben die Stimme nicht zum Schweigen gebracht, {playerName}; nur ihren Chor ausgedünnt.`],
  q_sanctum_gate: [`Der Schlüssel des Heiligtums wurde unter den Augen knochengepanzerter Toter zerbrochen. Bring 3 Splitter, und ich öffne leise den Weg.`, `Die Splitter sitzen richtig, und das Tor erkennt seinen Schlüssel. Sammle die Stärksten, {playerName}.`],
  q_korgath: [`Maren fand Ketten dick wie Masten und etwas Ogerförmiges darin. Nimm vier Gefährten und bring Korgath zu Fall.`, `Korgath ist endlich gebrochen. Sogar seine Ketten verdienten ein freundlicheres Ende.`],
...
const itQuestNarratives = {
  ...
  q_silence_the_call: [`Ogni nome nel registro è un'anima che Morthen vuole strappare dalla terra. Zittisci 12 ossa irrequiete prima che il sussurro diventi coro.`, `Il cimitero è più quieto, ma il richiamo ora sale dalla cripta, {playerName}.`],
  ...
  q_sexton: [`Il registro nomina il sagrestano Marrow, primo guardiano rialzato da Morthen. Scendi con quattro compagni e ridagli il riposo rubato.`, `Marrow è libero finalmente. Non suonate campane per lui; ne udì abbastanza in vita.`],
  q_gravecallers_trail: [`Morthen è morto, ma la sua setta non sprecò un secolo di silenzio per una sola cappella. Cerca il suo grimorio tra le rovine, {playerName}.`, `Morthen scriveva a un Mistcaller nella palude del nord. La setta non è morta; ha solo atteso.`],
  ...
  q_fenbridge_muster: [`Gli scritti di Morthen nominano un maestro nella palude del nord. Prendi l'ordine di adunata al cancello di Fenbridge e consegnalo al custode.`, `Il sigillo di Aldric? Allora andrai bene. La palude inghiotte intere le mie pattuglie.`],
  ...
  q_prowler_pelts: [`La strada rialzata regge grazie a pelli di predatore oliate, e le mie scorte sono finite. Portami 8 pelli integre.`, `Belle pelli spesse. Ora la strada sopravvivrà a entrambi.`],
  ...
  q_broodmother: [`Ragnatele grosse come gomene hanno una madre. Fatti strada tra 8 vedove e uccidi la vecchia prima che la covata si schiuda.`, `Davvero morta? Allora il folto torna a essere solo alberi.`],
  ...
  q_trolls: [`I troll di Mirefen hanno aperto tumuli più antichi di ogni regno umano. Cacciali: 12 troll morti basteranno.`, `I troll non scavano senza motivo. Qualcuno in veste grigia li ha guidati.`],
  ...
  q_grubjaw: [`Grubjaw non scava con gli altri; ha mangiato i miei ultimi due muli, finimenti compresi. Portami la sua zanna.`, `Quella zanna è lunga quanto il mio avambraccio! I muli sono vendicati.`],
  ...
  q_summoners: [`Gli evocatori richiamano gli annegati come cani al fischio. Zittiscine 8 e portami 4 cifrari.`, `Ogni cifrario è controfirmato dal diacono Voss e diretto al Mistcaller. Lo abbiamo trovato.`],
  ...
  q_bastion_door: [`Il Bastione Sommerso custodisce il Mistcaller, e la sua porta è sigillata da pietre tombali. Portami una pietra di guardia.`, `Il sigillo cede come corda marcia. La porta è aperta, e il buio ascolta.`],
  q_olen: [`Olen morì difendendo il Bastione e ora ne guarda la porta come burattino. Scendi con quattro compagni e dagli pace.`, `La sua guardia è finita finalmente. Inciderò io stesso il suo nome sul cancello.`],
  q_mistcaller: [`Vael attende in fondo al Bastione, la voce che ha annegato cento viaggiatori. Porta quattro compagni e finiscilo, {playerName}.`, `Vael è morto e la nebbia si alza, ma le sue ultime parole gelano: il Wyrm si agita sotto i picchi.`],
  q_highwatch_summons: [`Le ultime parole di Vael non mi lasciano, {playerName}. Prendi la convocazione di Highwatch e dì a Thessaly che Aldric sale dietro di te.`, `Se Aldric sale di persona, è grave come temevo. Benvenuto a Highwatch.`],
  ...
  q_stalker_pelts: [`L'inverno su questa montagna sfonda le porte. Otto pelli di braccatore fodereranno mantelli per il muro.`, `Spesse come il mio braccio. La guardia non gelerà quest'anno.`],
  q_kobold_tunnels: [`I coboldi di Deeprock scavano dritti verso il basso, come chiamati sotto il muro. Uccidi 12 scavatori.`, `Ogni galleria scende diritta. I coboldi non scavano così da soli.`],
  q_glowing_wax: [`La cera di quei minatori brilla ed è calda come un battito. Porta 6 pezzi per gli studi di Caddis.`, `Ancora calda. Il bagliore non somiglia a nessuna fiamma nota al maestro.`],
  ...
  q_ogre_totems: [`Gli ogre hanno eretto totem di pelle e teschio: segnali di adunata, non di razzia. Abbattene 6 e portali qui.`, `Teschio, pelle... e legature di scaglie di wyrm. Sono doni del culto, {playerName}.`],
  ...
  q_drogmar: [`Drogmar ha preso la moneta del Wyrmcult e giurato i clan al risveglio della montagna. Entra nel campo e uccidilo per Highwatch.`, `Drogmar giace morto nel suo campo. Hai comprato un inverno al mio muro, {playerName}.`],
  q_elementals: [`Stormcrag è rimasta muta per mille anni, e ora le sue pietre camminano. Abbatti 12 elementali per studiarne i resti.`, `I frammenti vibrano come campane colpite. La montagna non è adirata, viene disturbata.`],
  q_shard_cores: [`Nel cuore di ogni elementale c'è un nucleo della tempesta. Sei insieme indicheranno il centro del disturbo.`, `Tutti puntano a sud come limatura verso una calamita. Al Santuario, {playerName}.`],
  ...
  q_zealots: [`Il vento porta canti dai picchi del sud. Zittisci 12 zeloti, {playerName}; ogni voce fermata compra un'altra notte di sonno.`, `Il vento è più quieto. Mi turba che qualcosa possa rispondere al canto.`],
  q_cult_orders: [`Gli zeloti si muovono come soldati prima di un assedio. Uccidine altri 8 e portami 4 ordini scritti.`, `Questa scrittura viene dal grimorio di Morthen. La stessa mano ha guidato ogni tomba, {playerName}.`],
  q_necromancers: [`Gli ordini parlano di un anello di filatteri, vasi d'anima attorno al Santuario. Uccidi 8 negromanti e portane 3 intatti.`, `Che la Luce ci perdoni. Contengono i morti della Valle e della palude; erano una decima.`],
  q_revenants: [`A est della strada giace un vecchio campo di battaglia. Il culto ne ha rialzato le ossa in piastre arrugginite. Rimettine 12 a terra.`, `Erano soldati, come i miei. Ciò che li ha chiamati non rispetta i morti.`],
  ...
  q_wyrm_sigils: [`I Gravecaller servono Korzul il Gravewyrm, e ogni anima rubata alimenta il risveglio. Portami 3 sigilli dall'accesso al Santuario.`, `Sì... una litania del risveglio scritta per generazioni. Sono vicini, {playerName}.`],
  q_breaking_the_seal: [`Il sigillo del Santuario fu forgiato con fuoco di montagna. Porta 5 braci benedette dagli elementali per aprirlo senza strapparlo.`, `Bruciano azzurre e pure. La montagna ricorda il suo antico giuramento.`],
  q_voice_below: [`Ieri tutto il campo si è inginocchiato verso il Santuario. Uccidi 10 zeloti e 6 negromanti prima che quella voce abbia abbastanza mani.`, `L'inginocchiarsi è finito. Non abbiamo zittito la voce, {playerName}; solo ridotto il suo coro.`],
  q_sanctum_gate: [`La chiave del Santuario fu spezzata sotto gli occhi dei morti corazzati d'ossa. Portami 3 frammenti e aprirò la via in silenzio.`, `I frammenti combaciano e la porta riconosce la sua chiave. Raduna i più forti, {playerName}.`],
  q_korgath: [`Maren ha trovato catene grosse come alberi di nave e qualcosa di forma ogre che tirava. Porta quattro compagni e abbatti Korgath.`, `Korgath è spezzato infine. Persino le sue catene meritavano una fine più gentile.`],
...
const ptQuestNarratives = {
  ...
  q_silence_the_call: [`Cada nome do registro é uma alma que Morthen quer arrancar da terra. Silencie 12 ossos inquietos antes que o sussurro vire coro.`, `O pátio está mais quieto, mas o chamado agora sobe da cripta, {playerName}.`],
  ...
  q_sexton: [`O registro nomeia o sacristão Marrow, primeiro guardião erguido por Morthen. Desça com quatro companheiros e devolva o repouso roubado.`, `Marrow enfim está livre. Não toquem sinos por ele; ouviu sinos demais em vida.`],
  q_gravecallers_trail: [`Morthen está morto, mas sua seita não gastaria um século de silêncio por uma só capela. Procure o grimório nas ruínas, {playerName}.`, `Morthen escrevia a um Mistcaller no brejo ao norte. A seita não morreu; apenas esperou.`],
  ...
  q_fenbridge_muster: [`Os escritos de Morthen citam um mestre no pântano do norte. Pegue a ordem de concentração no portão de Fenbridge e apresente-a ao guardião.`, `O selo de Aldric, é? Então você serve. O pântano engole minhas patrulhas inteiras.`],
  ...
  q_prowler_pelts: [`A passarela depende de peles de espreitador oleadas, e meu estoque acabou. Traga 8 peles intactas antes que vadeemos até Eastbrook.`, `Boas peles grossas. A passarela sobreviverá a nós dois.`],
  ...
  q_broodmother: [`Teias grossas como cabos têm uma mãe. Abra caminho por 8 viúvas e mate a velha antes que a ninhada abra.`, `Morta de verdade? Então o matagal volta a ser só árvores.`],
  ...
  q_trolls: [`Os trolls de Mirefen abriram túmulos mais velhos que reinos humanos. Expulse-os: 12 trolls mortos bastam.`, `Trolls não cavam sem motivo. Alguém de robe cinza mostrou onde.`],
  ...
  q_grubjaw: [`Grubjaw não cava com os outros; comeu minhas duas últimas mulas, arreios e tudo. Traga-me a presa dele.`, `Essa presa tem o tamanho do meu antebraço! As mulas estão vingadas.`],
  ...
  q_summoners: [`Os invocadores chamam os afogados como cães ao assobio. Silencie 8 e traga 4 cifras.`, `Cada cifra é contra-assinada pelo diácono Voss e endereçada ao Mistcaller. Encontramos o mestre.`],
  ...
  q_bastion_door: [`O Bastião Submerso abriga o Mistcaller, e sua porta é selada por pedras tumulares. Traga uma pedra guardiã.`, `O selo se desfaz como corda podre. A porta está aberta, e a escuridão escuta.`],
  q_olen: [`Olen morreu defendendo o Bastião e agora guarda a porta como marionete. Desça com quatro companheiros e dê a ele repouso.`, `A vigília dele terminou enfim. Eu mesmo gravarei seu nome no portão.`],
  q_mistcaller: [`Vael espera no fundo do Bastião, a voz que afogou cem viajantes. Leve quatro companheiros e acabe com ele, {playerName}.`, `Vael morreu e a névoa se levanta, mas suas últimas palavras gelam: o Wyrm se agita sob os picos.`],
  q_highwatch_summons: [`As últimas palavras de Vael não me deixam, {playerName}. Pegue a convocação de Highwatch e diga a Thessaly que Aldric sobe atrás de você.`, `Se Aldric sobe em pessoa, é tão ruim quanto eu temia. Bem-vindo a Highwatch.`],
  ...
  q_stalker_pelts: [`O inverno desta montanha não bate, arromba a porta. Oito peles de rastreador forrarão capas para a muralha.`, `Grossas como meu braço. A guarda não congelará este ano.`],
  q_kobold_tunnels: [`Os kobolds de Deeprock cavam reto para baixo, como chamados sob a muralha. Mate 12 tuneladores.`, `Cada poço desce reto. Kobolds não cavam assim sozinhos.`],
  q_glowing_wax: [`A cera daqueles tuneladores brilha e é quente como batimento. Traga 6 pedaços para os estudos de Caddis.`, `Ainda quente. Esse brilho não combina com nenhuma chama que o mestre conheça.`],
  ...
  q_ogre_totems: [`Os ogros ergueram totens de couro e crânio: sinal de concentração, não de saque. Derrube 6 e traga-os.`, `Crânio, couro... e amarras de escama de wyrm. Presentes do culto, {playerName}.`],
  ...
  q_drogmar: [`Drogmar tomou a moeda do Wyrmcult e jurou os clãs ao despertar da montanha. Entre no acampamento e mate-o por Highwatch.`, `Drogmar jaz morto no próprio campo. Você comprou um inverno para minha muralha, {playerName}.`],
  q_elementals: [`Stormcrag ficou silencioso por mil anos, e agora suas pedras andam. Derrube 12 elementais para eu estudar o que restar.`, `Os fragmentos vibram como sinos tocados. A montanha não está furiosa, está sendo perturbada.`],
  q_shard_cores: [`No coração de cada elemental há um núcleo da tempestade. Seis juntos mostrarão o centro do distúrbio.`, `Todos apontam ao sul como limalha para um ímã. Ao Santuário, {playerName}.`],
  ...
  q_zealots: [`O vento traz cânticos dos picos do sul. Silencie 12 zelotes, {playerName}; cada voz calada compra outra noite de sono.`, `O vento está mais quieto. O que me preocupa é que algo talvez responda.`],
  q_cult_orders: [`Os zelotes se movem como soldados antes de um cerco. Mate mais 8 e traga 4 conjuntos de ordens.`, `Esta letra veio do grimório de Morthen. A mesma mão guiou cada túmulo, {playerName}.`],
  q_necromancers: [`As ordens falam de um anel de filactérios, vasos de alma ao redor do Santuário. Mate 8 necromantes e traga 3 intactos.`, `Que a Luz nos perdoe. Eles guardam os mortos do Vale e do pântano; eram um dízimo.`],
  q_revenants: [`A leste da estrada há um velho campo de batalha. O culto ergueu seus ossos em placas enferrujadas. Ponha 12 de volta no chão.`, `Foram soldados, como os meus. O que os chamou não respeita os mortos.`],
  ...
  q_wyrm_sigils: [`Os Gravecallers servem Korzul, o Gravewyrm, e cada alma roubada alimenta seu despertar. Traga 3 sigilos da aproximação do Santuário.`, `Sim... uma ladainha de despertar escrita por gerações. Estão perto, {playerName}.`],
  q_breaking_the_seal: [`O selo do Santuário foi forjado com fogo da montanha. Traga 5 brasas abençoadas dos elementais para abri-lo sem rasgar.`, `Queimam azul e limpo. A montanha lembra seu antigo juramento.`],
  q_voice_below: [`Ontem o campo inteiro se ajoelhou para o Santuário. Mate 10 zelotes e 6 necromantes antes que essa voz tenha mãos suficientes.`, `Os joelhos se ergueram. Não silenciamos a voz, {playerName}; só afinamos seu coro.`],
  q_sanctum_gate: [`A chave do Santuário foi quebrada sob os olhos dos mortos encouraçados de ossos. Traga 3 fragmentos e abrirei a passagem em silêncio.`, `Os fragmentos assentam e a porta reconhece a chave. Reúna os mais fortes, {playerName}.`],
  q_korgath: [`Maren achou correntes grossas como mastros e algo em forma de ogro puxando-as. Leve quatro companheiros e derrube Korgath.`, `Korgath está quebrado enfim. Até as correntes mereciam fim mais gentil.`],
...
const zhCnQuestNarratives = {
  ...
  q_silence_the_call: [`名册上的每个名字都是莫森想拖出泥土的灵魂。在低语变成合唱前，让12具不宁骸骨沉寂。`, `墓园安静了些，可召唤如今从墓穴下方升起，{playerName}。`],
  ...
  q_sexton: [`葬册写着司事马罗的名字，他是莫森唤起的第一个守门人。带四名同伴下墓穴，还给他被夺走的安息。`, `马罗终于自由了。别为他敲钟，他生前听得够多了。`],
  q_gravecallers_trail: [`莫森死了，但潜伏百年的教派不会只为一座村庄礼拜堂现身。去废墟里找他的魔典，{playerName}。`, `莫森写信给北方湿地的一名唤雾者。教派并未死去，只是在等待。`],
  ...
  q_fenbridge_muster: [`莫森的书信提到北方沼泽里有一位主人。取下芬桥门柱上的集结令，交给守望者。`, `奥德里克的印记？那你能用。湿地正把我的巡逻队整支吞掉。`],
  q_prowlers: [`泥沼潜伏兽已经学会补给骡的声音，开始在栈道上狩猎。杀死12只，{playerName}。`, `十二只，你身上还没伤。今晚栈道能喘口气。`],
  q_prowler_pelts: [`栈道靠浸油的潜伏兽皮包木桩才撑得住，我的库存见底了。带回8张完好的毛皮。`, `好厚的皮。现在这条栈道会比我们俩都长久。`],
  ...
  q_broodmother: [`你见过那些网，能织出腕粗蛛索的东西就在灌木丛上方。杀8只寡妇蛛，再杀蛛母。`, `真的死了？那片灌木丛终于只是树了。`],
  ...
  q_trolls: [`泥沼巨魔挖开了古老坟丘，比任何人类王国都古老。赶走它们，杀12个就够。`, `巨魔不会无缘无故挖掘。有人穿着灰袍告诉它们该挖哪里。`],
  q_troll_fetishes: [`那些护符不是巨魔手艺，结法不对，骨头是人骨，而且全指向敞开的坟丘。带回8个。`, `和邪教营地旗帜出自同一人之手。巨魔不过是雇来的铲子，{playerName}。`],
  q_grubjaw: [`格鲁布颚连其他巨魔都不愿靠近。它吃掉了我最后两头驮骡，连挽具也没剩。带回它的獠牙。`, `那根獠牙有我前臂那么长！驮骡终于得报了仇。`],
  q_cult_camp: [`向北越过第三片湖，雾从不散。唤墓者公开扎营，像已经拥有这片湿地。砍倒12名教徒，{playerName}。`, `十二件灰袍倒在泥里。现在他们知道湿地也会回望。`],
  q_summoners: [`玛伦报告说召唤师能像吹哨唤犬一样，把溺亡者从水里叫起。杀8个，带回4份密文。`, `每份密文都由执事沃斯副署，并递往堡垒里的唤雾者。我们找到他了。`],
  q_deacon: [`沃斯站在营地中心，把我淹死的守望者唱出湖面为他效命。沿营路北上，把他埋深些，{playerName}。`, `沃斯死了，营地的雾已经变薄。你打碎了湿地里的声音，只剩堡垒。`],
  q_bastion_door: [`沉没堡垒就是唤雾者唱颂溺水圣歌的地方。邪教用墓石封住门，带回一块护符石。`, `结界像烂绳一样分开。门开了，门后的黑暗正在聆听。`],
  q_olen: [`奥伦守着堡垒直到沉没，如今却被唤雾者当傀儡守门。带四名同伴下去，给他应得的安息。`, `他的守望终于结束。我会亲自把他的名字刻在门上。`],
  q_mistcaller: [`维尔在堡垒底部等待，他的声音淹死百名旅人来筑军。带四名同伴，终结他，{playerName}。`, `维尔死了，雾第一次散开。但他的遗言让我血冷：Wyrm在群峰下苏醒。`],
  q_highwatch_summons: [`维尔的遗言仍在我耳边，{playerName}：Wyrm在群峰下苏醒。取下高望召令，告诉瑟萨莉我随后上山。`, `奥德里克的消息传得很远。若他亲自上山，事情就和我担心的一样糟。欢迎来到高望。`],
  q_stalkers: [`山脊猫从雪线下来，饿得撕咬我的巡逻队。先杀12只，{playerName}。`, `山脊上少了十二道阴影。今晚巡逻队能喘口气。`],
  q_stalker_pelts: [`这座山的冬天不会敲门，它会踹门。8张山脊潜猎者皮能为守墙披风加衬。`, `厚得像我的手臂。今年守望者不会冻死。`],
  q_kobold_tunnels: [`深岩的狗头人往不该挖的深处直挖，像有东西在呼唤。杀12个深岩掘地者。`, `每条竖井都笔直向下。狗头人不会自己这样挖。`],
  q_glowing_wax: [`凯迪斯给我看了一支从掘地者身上拿来的蜡，发光又温热如心跳。带回6块发光蜡块。`, `还暖着。博学者说这光不属于任何他知道的火焰。`],
  q_ogre_edges: [`荆峰氏族从不来这么东边，如今却涂着战漆扎营。有人付了钱，{playerName}。砍倒12个。`, `十二个倒下，他们还是不退。买下他们的人付的不是普通黄金。`],
  q_ogre_totems: [`食人魔在营地周围竖起皮与颅骨的图腾，那是集结，不是劫掠。拆下6个带回来。`, `颅骨、兽皮...还有Wyrm鳞绑带。这些图腾是邪教送的礼，{playerName}。`],
  ...
  q_drogmar: [`德罗格玛收了龙教的报酬，把氏族献给山脉苏醒。他是砸向城墙的锤。进营地杀了他。`, `德罗格玛死在自己的营地。氏族会散向高山隘口，你为我的城墙买来一个冬天，{playerName}。`],
  q_elementals: [`风暴岩沉默千年，如今石头自己站起来行走。击倒12个元素，好让我研究残片。`, `碎片像被敲响的钟一样嗡鸣。山不是愤怒，{playerName}，它正被惊扰。`],
  q_shard_cores: [`每个元素心中都有风暴核心，石中缚着闪电。并列6枚就能告诉我扰动的中心。`, `每枚核心都朝同一方向倾斜，像铁屑指向磁石。南边，去圣所。`],
  q_kazzix: [`元素中有一个燃得更亮：碎片领主卡兹克斯，一场有肩膀的风暴。去远处峭壁夺下它的心裂片。`, `心裂片还在噼啪作响！太好了。拿上这些护腿，我是凭猜测和祈祷量的。`],
  q_zealots: [`南峰吹来的风带着圣歌。龙教不再隐藏，他们在圣所下扎营，对地下沉睡之物歌唱。让12名狂热者闭嘴。`, `风安静了些。但让我不安的不是歌声，{playerName}，而是也许有什么在回应。`],
  q_cult_orders: [`狂热者现在有岗哨、有清点，像围城前的士兵。杀8个并带回4份书面命令。`, `这笔迹...我在东溪莫森的魔典里见过。每座坟后都是同一只手，{playerName}。`],
  q_necromancers: [`命令提到一圈护命匣，灵魂容器围着圣所供养它。杀8名死灵法师，带回3个完整护命匣。`, `愿圣光宽恕我们。里面装着谷地和湿地的死者，所有被收割的灵魂。`],
  q_revenants: [`圣所路东有片古战场，上一支攻山军的先锋已埋两百年。邪教叫醒了他们，穿着锈甲。让12个归土。`, `他们也曾是士兵，像我的人一样。召唤他们的东西不尊重死者。`],
  q_revenant_vanguard: [`亡魂正在列队，{playerName}，真正的盾线和纵队。再击溃14个，别让那场向圣所的行军开始。`, `战场再次静了。拿着吧，这是为守墙者打造的，没有人比你更配。`],
  q_wyrm_sigils: [`你该知道全貌了。唤墓者侍奉墓龙科祖尔，每个被偷走的灵魂都是倒入苏醒的贡品。带回3枚圣所徽记。`, `没错...一篇苏醒祷文，写了好几代。他们很近了，{playerName}。`],
  q_breaking_the_seal: [`圣所封印由山火铸成，只有山火能让我们通过而不撕裂它。带回5枚祝福余烬。`, `它们蓝而纯净地燃烧。山记得古老的誓言。`],
  q_voice_below: [`昨夜整个营地同时跪向圣所。科祖尔已经在他们梦里说话。杀10名狂热者和6名死灵法师。`, `跪拜停止了。我们没有让那声音沉默，{playerName}，只是削薄了它的合唱。`],
  q_sanctum_gate: [`最后的门槛到了。邪教把圣所门钥石击碎，碎片散在门前广场。带回3片，我会悄悄开启道路。`, `碎片归位了，门认出了自己的钥匙。召集你能找到的最强同伴，{playerName}。`],
  q_korgath: [`玛伦最后一次扫过圣所口，发现粗如船桅的锁链和一个食人魔形体在其中挣扎。带四名同伴击倒科加斯。`, `科加斯终于被打碎。连他的锁链也配得到更温柔的结局。`],
  q_velkhar: [`我们追踪的每条线，莫森、维尔、护命匣，都由一只手编织：大死灵法师维尔卡。终结他，{playerName}。`, `维尔卡死了，仪式失去了头。但你也感觉到了吧？灵魂已经耗尽，Wyrm不再沉睡。`],
  q_gravewyrm: [`没有仪式可阻止了，{playerName}，只剩半醒的Wyrm，吞食了谷地和湿地的死者。带同伴进洞，完成我们从礼拜堂开始的事。`, `结束了。三地死者得以安息，山也不再被鬼魂惊扰，今晚每一口钟都为你的名字鸣响。`],
} satisfies QuestNarrativeTranslations;
...
const zhTwQuestNarratives = {
  ...
  q_silence_the_call: [`名冊上的每個名字都是莫森想拖出泥土的靈魂。在低語變成合唱前，讓12具不寧骸骨沉寂。`, `墓園安靜了些，可召喚如今從墓穴下方升起，{playerName}。`],
  ...
  q_sexton: [`葬冊寫著司事馬羅的名字，他是莫森喚起的第一個守門人。帶四名同伴下墓穴，還給他被奪走的安息。`, `馬羅終於自由了。別為他敲鐘，他生前聽得夠多了。`],
  q_gravecallers_trail: [`莫森死了，但潛伏百年的教派不會只為一座村莊禮拜堂現身。去廢墟裡找他的魔典，{playerName}。`, `莫森寫信給北方濕地的一名喚霧者。教派並未死去，只是在等待。`],
  ...
  q_fenbridge_muster: [`莫森的書信提到北方沼澤裡有一位主人。取下芬橋門柱上的集結令，交給守望者。`, `奧德里克的印記？那你能用。濕地正把我的巡邏隊整支吞掉。`],
  q_prowlers: [`泥沼潛伏獸已經學會補給騾的聲音，開始在棧道上狩獵。殺死12隻，{playerName}。`, `十二隻，你身上還沒傷。今晚棧道能喘口氣。`],
  q_prowler_pelts: [`棧道靠浸油的潛伏獸皮包木樁才撐得住，我的庫存見底了。帶回8張完好的毛皮。`, `好厚的皮。現在這條棧道會比我們倆都長久。`],
  ...
  q_broodmother: [`你見過那些網，能織出腕粗蛛索的東西就在灌木叢上方。殺8隻寡婦蛛，再殺蛛母。`, `真的死了？那片灌木叢終於只是樹了。`],
  ...
  q_trolls: [`泥沼巨魔挖開了古老墳丘，比任何人類王國都古老。趕走牠們，殺12個就夠。`, `巨魔不會無緣無故挖掘。有人穿著灰袍告訴牠們該挖哪裡。`],
  q_troll_fetishes: [`那些護符不是巨魔手藝，結法不對，骨頭是人骨，而且全指向敞開的墳丘。帶回8個。`, `和邪教營地旗幟出自同一人之手。巨魔不過是雇來的鏟子，{playerName}。`],
  q_grubjaw: [`格魯布顎連其他巨魔都不願靠近。牠吃掉了我最後兩頭馱騾，連挽具也沒剩。帶回牠的獠牙。`, `那根獠牙有我前臂那麼長！馱騾終於得報了仇。`],
  q_cult_camp: [`向北越過第三片湖，霧從不散。喚墓者公開紮營，像已經擁有這片濕地。砍倒12名教徒，{playerName}。`, `十二件灰袍倒在泥裡。現在他們知道濕地也會回望。`],
  q_summoners: [`瑪倫報告說召喚師能像吹哨喚犬一樣，把溺亡者從水裡叫起。殺8個，帶回4份密文。`, `每份密文都由執事沃斯副署，並遞往堡壘裡的喚霧者。我們找到他了。`],
  q_deacon: [`沃斯站在營地中心，把我淹死的守望者唱出湖面為他效命。沿營路北上，把他埋深些，{playerName}。`, `沃斯死了，營地的霧已經變薄。你打碎了濕地裡的聲音，只剩堡壘。`],
  q_bastion_door: [`沉沒堡壘就是喚霧者唱頌溺水聖歌的地方。邪教用墓石封住門，帶回一塊護符石。`, `結界像爛繩一樣分開。門開了，門後的黑暗正在聆聽。`],
  q_olen: [`奧倫守著堡壘直到沉沒，如今卻被喚霧者當傀儡守門。帶四名同伴下去，給他應得的安息。`, `他的守望終於結束。我會親自把他的名字刻在門上。`],
  q_mistcaller: [`維爾在堡壘底部等待，他的聲音淹死百名旅人來築軍。帶四名同伴，終結他，{playerName}。`, `維爾死了，霧第一次散開。但他的遺言讓我血冷：Wyrm在群峰下甦醒。`],
  q_highwatch_summons: [`維爾的遺言仍在我耳邊，{playerName}：Wyrm在群峰下甦醒。取下高望召令，告訴瑟薩莉我隨後上山。`, `奧德里克的消息傳得很遠。若他親自上山，事情就和我擔心的一樣糟。歡迎來到高望。`],
  q_stalkers: [`山脊貓從雪線下來，餓得撕咬我的巡邏隊。先殺12隻，{playerName}。`, `山脊上少了十二道陰影。今晚巡邏隊能喘口氣。`],
  q_stalker_pelts: [`這座山的冬天不會敲門，它會踹門。8張山脊潛獵者皮能為守牆披風加襯。`, `厚得像我的手臂。今年守望者不會凍死。`],
  q_kobold_tunnels: [`深岩的狗頭人往不該挖的深處直挖，像有東西在呼喚。殺12個深岩掘地者。`, `每條豎井都筆直向下。狗頭人不會自己這樣挖。`],
  q_glowing_wax: [`凱迪斯給我看了一支從掘地者身上拿來的蠟，發光又溫熱如心跳。帶回6塊發光蠟塊。`, `還暖著。博學者說這光不屬於任何他知道的火焰。`],
  q_ogre_edges: [`荊峰氏族從不來這麼東邊，如今卻塗著戰漆紮營。有人付了錢，{playerName}。砍倒12個。`, `十二個倒下，他們還是不退。買下他們的人付的不是普通黃金。`],
  q_ogre_totems: [`食人魔在營地周圍豎起皮與顱骨的圖騰，那是集結，不是劫掠。拆下6個帶回來。`, `顱骨、獸皮...還有Wyrm鱗綁帶。這些圖騰是邪教送的禮，{playerName}。`],
  ...
  q_drogmar: [`德羅格瑪收了龍教的報酬，把氏族獻給山脈甦醒。他是砸向城牆的錘。進營地殺了他。`, `德羅格瑪死在自己的營地。氏族會散向高山隘口，你為我的城牆買來一個冬天，{playerName}。`],
  q_elementals: [`風暴岩沉默千年，如今石頭自己站起來行走。擊倒12個元素，好讓我研究殘片。`, `碎片像被敲響的鐘一樣嗡鳴。山不是憤怒，{playerName}，它正被驚擾。`],
  q_shard_cores: [`每個元素心中都有風暴核心，石中縛著閃電。並列6枚就能告訴我擾動的中心。`, `每枚核心都朝同一方向傾斜，像鐵屑指向磁石。南邊，去聖所。`],
  q_kazzix: [`元素中有一個燃得更亮：碎片領主卡茲克斯，一場有肩膀的風暴。去遠處峭壁奪下它的心裂片。`, `心裂片還在劈啪作響！太好了。拿上這些護腿，我是憑猜測和祈禱量的。`],
  q_zealots: [`南峰吹來的風帶著聖歌。龍教不再隱藏，他們在聖所下紮營，對地下沉睡之物歌唱。讓12名狂熱者閉嘴。`, `風安靜了些。但讓我不安的不是歌聲，{playerName}，而是也許有什麼在回應。`],
  q_cult_orders: [`狂熱者現在有崗哨、有清點，像圍城前的士兵。殺8個並帶回4份書面命令。`, `這筆跡...我在東溪莫森的魔典裡見過。每座墳後都是同一隻手，{playerName}。`],
  q_necromancers: [`命令提到一圈護命匣，靈魂容器圍著聖所供養它。殺8名死靈法師，帶回3個完整護命匣。`, `願聖光寬恕我們。裡面裝著谷地和濕地的死者，所有被收割的靈魂。`],
  q_revenants: [`聖所路東有片古戰場，上一支攻山軍的先鋒已埋兩百年。邪教叫醒了他們，穿著鏽甲。讓12個歸土。`, `他們也曾是士兵，像我的人一樣。召喚他們的東西不尊重死者。`],
  q_revenant_vanguard: [`亡魂正在列隊，{playerName}，真正的盾線和縱隊。再擊潰14個，別讓那場向聖所的行軍開始。`, `戰場再次靜了。拿著吧，這是為守牆者打造的，沒有人比你更配。`],
  q_wyrm_sigils: [`你該知道全貌了。喚墓者侍奉墓龍科祖爾，每個被偷走的靈魂都是倒入甦醒的貢品。帶回3枚聖所徽記。`, `沒錯...一篇甦醒禱文，寫了好幾代。他們很近了，{playerName}。`],
  q_breaking_the_seal: [`聖所封印由山火鑄成，只有山火能讓我們通過而不撕裂它。帶回5枚祝福餘燼。`, `它們藍而純淨地燃燒。山記得古老的誓言。`],
  q_voice_below: [`昨夜整個營地同時跪向聖所。科祖爾已經在他們夢裡說話。殺10名狂熱者和6名死靈法師。`, `跪拜停止了。我們沒有讓那聲音沉默，{playerName}，只是削薄了它的合唱。`],
  q_sanctum_gate: [`最後的門檻到了。邪教把聖所門鑰石擊碎，碎片散在門前廣場。帶回3片，我會悄悄開啟道路。`, `碎片歸位了，門認出了自己的鑰匙。召集你能找到的最強同伴，{playerName}。`],
  q_korgath: [`瑪倫最後一次掃過聖所口，發現粗如船桅的鎖鏈和一個食人魔形體在其中掙扎。帶四名同伴擊倒科加斯。`, `科加斯終於被打碎。連他的鎖鏈也配得到更溫柔的結局。`],
  q_velkhar: [`我們追蹤的每條線，莫森、維爾、護命匣，都由一隻手編織：大死靈法師維爾卡。終結他，{playerName}。`, `維爾卡死了，儀式失去了頭。但你也感覺到了吧？靈魂已經耗盡，Wyrm不再沉睡。`],
  q_gravewyrm: [`沒有儀式可阻止了，{playerName}，只剩半醒的Wyrm，吞食了谷地和濕地的死者。帶同伴進洞，完成我們從禮拜堂開始的事。`, `結束了。三地死者得以安息，山也不再被鬼魂驚擾，今晚每一口鐘都為你的名字鳴響。`],
} satisfies QuestNarrativeTranslations;
...
const jaQuestNarratives = {
  ...
  q_names_of_the_dead: [`グレイブコーラーが墓を暴いたなら、誰の眠りが奪われたのか知る必要があります。埋葬記録のページを3枚集めてください。`, `哀れな魂たち...ここに墓守マロウの名があります。モーセンはイーストブルックの死者を埋めた男から始めたのです。`],
  q_silence_the_call: [`記録の名はすべて、モーセンが土から引き出そうとする魂です。囁きが合唱になる前に、安らがぬ骨を12体沈めてください。`, `墓地は静まりましたが、呼び声は今や地下の墓所から昇っています、{playerName}。`],
  ...
  q_sexton: [`記録には墓守マロウの名があります。モーセンが最初に起こした門番です。四人の仲間と下り、奪われた眠りを返してください。`, `マロウはようやく自由です。鐘は鳴らさないでください。生前に十分聞きました。`],
  q_gravecallers_trail: [`モーセンは死にましたが、一世紀潜んだ一派が一つの礼拝堂だけで終わるはずがありません。廃墟で彼の魔導書を探してください。`, `モーセンは北の湿地のミストコーラーに書いていました。一派は死んでいません。ただ待っていたのです。`],
  ...
  q_fenbridge_muster: [`モーセンの書き物は北の湿地の主を名指ししています。フェンブリッジの門柱から召集令を取り、番人へ届けてください。`, `アルドリックの印ですか。なら役に立ちます。湿地は私の巡察を丸ごと飲み込んでいます。`],
  q_prowlers: [`沼の徘徊者は補給ラバの音を覚え、土手道そのものを狩っています。12体を倒してください、{playerName}。`, `十二体、しかも噛まれていない。今夜の土手道は少し楽に息をします。`],
  q_prowler_pelts: [`土手道は油を染み込ませた徘徊者の皮で支えられています。備蓄が尽きました。無傷の毛皮を8枚持ってきてください。`, `よい厚い毛皮です。土手道は私たちより長く持つでしょう。`],
  ...
  q_broodmother: [`腕ほど太い糸を紡ぐものがいます。寡婦蜘蛛を8匹焼き払い、群れの母を倒してください。`, `本当に死にましたか。なら茂みはただの木々に戻ります。`],
  q_drowned: [`土手道で溺れた旅人が、水草をまとって湖から歩き出しています。溺れ死者を12体眠らせてください。`, `倒した一体ごとに、盗まれた魂が解き放たれます。`],
  ...
  q_trolls: [`マイアフェンのトロルが、人の王国より古い塚を開きました。12体倒して追い払ってください。`, `トロルは理由なしに掘りません。灰色のローブが場所を教えたのでしょう。`],
  q_troll_fetishes: [`その護符はトロル製ではありません。結び目が違い、人骨で、すべて開いた塚を指しています。8つ持ってきてください。`, `教団の旗と同じ作り手です。トロルは雇われたシャベルにすぎません、{playerName}。`],
  q_grubjaw: [`グラブジョーは他のトロルも避ける大食らいです。最後の荷ラバ二頭を馬具ごと食べました。牙を持ってきてください。`, `前腕ほどの牙です！ラバたちの仇は討たれました。`],
  q_cult_camp: [`三つ目の湖の北、霧が晴れぬ場所にグレイブコーラーが堂々といます。信徒を12人倒してください。`, `十二のローブが泥に伏しました。湿地も見返すと知ったでしょう。`],
  q_summoners: [`召喚師は笛に応じる犬のように溺死者を水から呼びます。8人を沈黙させ、暗号を4つ持ち帰ってください。`, `暗号はすべて助祭ヴォスの副署で、砦のミストコーラー宛てです。見つけました。`],
  q_deacon: [`ヴォスは溺れた番人を歌で湖から呼び、仕えさせています。野営地の道を進み、深く埋めてください。`, `ヴォスは死に、野営地の霧は薄れています。残るは砦だけです。`],
  q_bastion_door: [`沈んだ砦はミストコーラーの場所で、扉は墓石で封じられています。護り石を一つ持ってきてください。`, `封印は腐った縄のようにほどけます。扉は開き、闇が耳を澄ませています。`],
  q_olen: [`オレンは砦を守って溺れ、今は操り人形として同じ扉を守っています。四人の仲間と下り、眠らせてください。`, `彼の見張りはようやく終わりました。門に名を刻むのは私がやります。`],
  q_mistcaller: [`ヴァエルは砦の底にいます。百人を溺れさせ、軍を作った声です。四人の仲間と終わらせてください、{playerName}。`, `ヴァエルは死に、霧は晴れています。だが最後の言葉は血を凍らせます。Wyrmが峰の下で動く、と。`],
  q_highwatch_summons: [`ヴァエルの最後の言葉が離れません、{playerName}。ハイウォッチ召喚状を取り、テサリーにアルドリックが後から登ると伝えてください。`, `アルドリックが自ら山へ来るなら、恐れていた通りです。ハイウォッチへようこそ。`],
  q_stalkers: [`尾根の猫が雪から飢えて下り、私の巡察を傷つけています。まず12頭倒してください、{playerName}。`, `尾根の影が十二減りました。今夜、巡察は息をつけます。`],
  q_stalker_pelts: [`この山の冬は扉を叩かず、蹴破ります。追跡者の毛皮8枚で壁の外套を裏打ちできます。`, `腕ほど厚い毛皮です。今年の見張りは凍えずに済みます。`],
  q_kobold_tunnels: [`ディープロックのコボルドは、壁の下から呼ばれているように真下へ掘っています。坑夫を12体倒してください。`, `どの坑も真下です。コボルドだけではこう掘りません。`],
  q_glowing_wax: [`坑夫のろうは光り、鼓動のように温かい。キャディスの研究のために6塊持ってきてください。`, `まだ温かい。博識者の知る炎とは違う光です。`],
  q_ogre_edges: [`ソーンピークの氏族が東へ出すぎて、戦化粧で野営しています。誰かが払っています。12体倒してください。`, `十二倒れても退きません。買った者は金より重いもので払ったのでしょう。`],
  q_ogre_totems: [`オーガは皮と頭蓋のトーテムを立てました。襲撃ではなく集結の印です。6つ倒して持ち帰ってください。`, `頭蓋、皮...そしてWyrmの鱗の結び。教団の贈り物です、{playerName}。`],
  q_ogre_bounty: [`氏族は買われ、私の壁が最初の用件です。ソーンピーク・オーガをさらに14体、報奨金つきで倒してください。`, `報奨金は全額です。丘陵は少し静かになりました。`],
  q_crushers: [`ドログマーの戦営で粉砕者は背骨です。一体が兵三人分。仲間と共に10体を砕いてください。`, `粉砕者が十体倒れました。戦営は背骨のない体です。`],
  q_drogmar: [`ドログマーはワーム教団の金を取り、山の目覚めへ氏族を誓わせました。戦営に入り、ハイウォッチのために討ってください。`, `ドログマーは自分の野営地で死にました。あなたは壁に冬を一つ買ってくれました、{playerName}。`],
  q_elementals: [`ストームクラッグは千年沈黙していましたが、今は石が歩いています。精霊を12体倒し、残骸を調べさせてください。`, `破片は打たれた鐘のように鳴ります。山は怒っていません、乱されているのです。`],
  q_shard_cores: [`精霊の心には嵐の核があります。6つ並べれば、乱れの中心が分かります。`, `すべて南を向きます。磁石に寄る鉄粉のように。聖所へ、{playerName}。`],
  q_kazzix: [`カジックスは他より明るく燃えます。肩を持った嵐です。遠い岩場で心臓片をもぎ取ってください。`, `心臓片はまだ弾けています！見事です。礼にこの脚具を。`],
  q_zealots: [`南の峰からの風が詠唱を運びます。信徒を12人沈黙させてください、{playerName}。声が止まるほど山は眠れます。`, `風は静かです。怖いのは詠唱ではなく、何かが返しているかもしれないことです。`],
  q_cult_orders: [`信徒は攻城前の兵のように動いています。8人を倒し、書かれた命令を4組持ってきてください。`, `この筆跡はモーセンの魔導書と同じです。すべての墓を導いた同じ手です、{playerName}。`],
  q_necromancers: [`命令は経箱の輪を語っています。聖所を養う魂の器です。死霊術師を8人倒し、3つを壊さず持ってきてください。`, `光よ、赦したまえ。谷と湿地の死者が入っています。これは軍ではなく、貢ぎ物でした。`],
  q_revenants: [`聖所道の東には古い戦場があります。教団は錆びた甲冑の骨を起こしました。12体を土へ戻してください。`, `彼らも兵でした。私の兵と同じです。起こしたものは死者を敬いません。`],
  q_revenant_vanguard: [`亡霊は本物の隊列を組んでいます、{playerName}。聖所へ行進する前に、さらに14体を砕いてください。`, `野は再び静まりました。受け取ってください。これほどふさわしい者はいません。`],
  q_wyrm_sigils: [`全てを知る時です。グレイブコーラーは墓ワームのコルズルに仕え、盗んだ魂を目覚めの貢ぎ物にしています。印章を3つ持ってきてください。`, `はい...何世代も書かれた目覚めの連祷です。彼らは近い、{playerName}。`],
  q_breaking_the_seal: [`聖所の封印は山火で作られました。同じ火だけが裂かずに道を開きます。祝福された残り火を5つ持ってきてください。`, `青く清く燃えています。山は古い誓いを覚えています。`],
  q_voice_below: [`昨夜、野営地全体が聖所へ膝をつきました。コルズルは夢で語っています。信徒10人と死霊術師6人を倒してください。`, `跪きは止まりました。声を黙らせたのではなく、合唱を薄くしただけです、{playerName}。`],
  q_sanctum_gate: [`最後の敷居です。教団は聖所の要石を砕き、広場に散らしました。3片を持ち帰れば、静かに開けます。`, `破片は合い、門は鍵を知りました。最も強い仲間を集めてください、{playerName}。`],
  q_korgath: [`マレンは聖所口で船のマストほどの鎖と、縛られたオーガの影を見つけました。四人の仲間とコルガスを倒してください。`, `コルガスはついに砕けました。彼の鎖でさえ、もっと優しい終わりに値しました。`],
  q_velkhar: [`モーセン、ヴァエル、経箱、すべての糸は大死霊術師ヴェルカーが紡ぎました。彼を終わらせてください、{playerName}。`, `ヴェルカーは死に、儀式は頭を失いました。けれど感じたでしょう。Wyrmはもう眠っていません。`],
  q_gravewyrm: [`止める儀式はもうありません、{playerName}。半ば目覚めたWyrmだけです。仲間と入り、礼拝堂で始めたことを終わらせてください。`, `終わりました。三つの地の死者は休み、山は憑かれずに眠ります。今夜すべての鐘があなたの名を鳴らします。`],
} satisfies QuestNarrativeTranslations;
...
const koQuestNarratives = {
  ...
  q_names_of_the_dead: [`무덤부름이 우리 무덤을 더럽혔다면 누구의 잠을 훔쳤는지 알아야 합니다. 매장 장부 페이지 3장을 모아 오십시오.`, `가엾은 영혼들... 여기 성구지기 매로우가 처음입니다. 모르덴은 이스트브룩의 죽은 자를 묻던 사람부터 시작했습니다.`],
  q_silence_the_call: [`장부의 모든 이름은 모르덴이 흙에서 끌어내려는 영혼입니다. 속삭임이 합창이 되기 전에 불안한 뼈 12구를 잠재우십시오.`, `묘지는 조용해졌지만, 부름은 이제 묘실 아래에서 올라옵니다, {playerName}.`],
  ...
  q_hollow: [`모르덴은 텅 빈 묘실 밑바닥에서 자신이 일으킨 정예 망자들에게 둘러싸여 있습니다. 네 동료와 함께 끝내십시오.`, `속삭임이 멎었습니다. 죽은 자들은 잠들었고, 이스트브룩은 당신에게 모든 것을 빚졌습니다.`],
  q_sexton: [`장부에는 성구지기 매로우의 이름이 있습니다. 모르덴이 처음 일으킨 문지기입니다. 네 동료와 내려가 빼앗긴 안식을 돌려주십시오.`, `매로우가 마침내 자유롭습니다. 종은 울리지 마십시오. 살아서 충분히 들었습니다.`],
  q_gravecallers_trail: [`모르덴은 죽었지만, 한 세기 숨어 있던 교단이 한 예배당 때문에 움직였을 리 없습니다. 폐허에서 그의 마법서를 찾으십시오.`, `모르덴은 북쪽 습지의 안개부름에게 편지를 보냈습니다. 교단은 죽지 않았고, 기다렸을 뿐입니다.`],
  ...
  q_fenbridge_muster: [`모르덴의 글은 북쪽 습지의 주인을 말합니다. 펜브리지 문기둥의 소집 명령서를 가져와 감시관에게 보이십시오.`, `알드릭의 인장입니까? 그럼 충분합니다. 습지가 내 순찰대를 통째로 삼키고 있습니다.`],
  q_prowlers: [`수렁 배회자들은 보급 노새 소리를 익히고 둑길까지 사냥합니다. 12마리를 처치하십시오, {playerName}.`, `열둘, 물린 자국도 없군요. 오늘 밤 둑길이 한숨 돌리겠습니다.`],
  q_prowler_pelts: [`둑길은 기름 먹인 배회자 가죽으로 말뚝을 감싸 버팁니다. 재고가 없습니다. 온전한 가죽 8장을 가져오십시오.`, `두꺼운 좋은 가죽입니다. 이제 둑길은 우리 둘보다 오래 버틸 겁니다.`],
  ...
  q_broodmother: [`밧줄 같은 거미줄을 짜는 어미가 있습니다. 과부거미 8마리를 뚫고 거미어미를 쓰러뜨리십시오.`, `정말 죽었습니까? 그럼 덤불은 다시 나무일 뿐입니다.`],
  q_drowned: [`둑길에서 익사한 여행자들이 수초를 두르고 호수에서 걸어 나옵니다. 익사한 망자 12구를 쉬게 하십시오.`, `쓰러진 하나하나가 훔쳐진 영혼을 풀어 줍니다.`],
  ...
  q_trolls: [`마이어펜 트롤들이 인간 왕국보다 오래된 봉분을 찢어 열었습니다. 12마리를 죽여 쫓아내십시오.`, `트롤은 이유 없이 파지 않습니다. 회색 로브가 어디를 팔지 알려준 겁니다.`],
  q_troll_fetishes: [`그 부적들은 트롤 솜씨가 아닙니다. 매듭도 틀리고, 사람 뼈이며, 열린 봉분을 가리킵니다. 8개를 가져오십시오.`, `교단 깃발과 같은 손입니다. 트롤은 고용된 삽에 불과합니다, {playerName}.`],
  q_grubjaw: [`그럽죠는 다른 트롤도 피합니다. 내 마지막 짐노새 두 마리를 마구째 먹었습니다. 그 엄니를 가져오십시오.`, `내 팔뚝만 한 엄니군요! 노새들의 원수는 갚았습니다.`],
  q_cult_camp: [`셋째 호수 북쪽, 안개가 걷히지 않는 곳에 무덤부름이 대놓고 야영합니다. 교단원 12명을 베십시오, {playerName}.`, `회색 로브 열둘이 진흙에 엎어졌습니다. 이제 습지도 되돌아본다는 걸 알겠지요.`],
  q_summoners: [`소환사들은 휘파람에 개를 부르듯 익사자를 물에서 부릅니다. 8명을 침묵시키고 암호문 4장을 가져오십시오.`, `모든 암호문은 부제 보스가 부서했고, 요새의 안개부름에게 보낸 것입니다. 찾았습니다.`],
  q_deacon: [`보스는 익사한 감시관들을 호수에서 노래로 불러 섬기게 합니다. 야영지 길을 따라가 깊이 묻어 버리십시오, {playerName}.`, `보스는 죽었고 야영지의 안개가 옅어집니다. 이제 요새만 남았습니다.`],
  q_bastion_door: [`가라앉은 요새는 안개부름의 자리이고, 문은 묘석으로 봉해져 있습니다. 수호석 하나를 가져오십시오.`, `봉인이 썩은 밧줄처럼 갈라집니다. 문이 열렸고, 어둠이 듣고 있습니다.`],
  q_olen: [`올렌은 요새를 지키다 익사했고, 이제 꼭두각시가 되어 같은 문을 지킵니다. 네 동료와 내려가 안식을 주십시오.`, `그의 경계가 마침내 끝났습니다. 문에 새길 이름은 내가 직접 새기겠습니다.`],
  q_mistcaller: [`바엘은 요새 밑바닥에서 기다립니다. 백 명의 여행자를 익사시켜 군대를 만든 목소리입니다. 네 동료와 끝내십시오.`, `바엘은 죽었고 안개가 걷힙니다. 그러나 마지막 말이 피를 얼립니다. Wyrm이 봉우리 아래서 꿈틀댄다고 했습니다.`],
  q_highwatch_summons: [`바엘의 마지막 말이 떠나지 않습니다, {playerName}. 하이워치 소환장을 들고 테살리에게 알드릭이 뒤따라 산을 오른다고 전하십시오.`, `알드릭이 직접 오른다면 두려워하던 만큼 나쁜 일입니다. 하이워치에 온 것을 환영합니다.`],
  q_stalkers: [`산등성이 고양이들이 눈 아래에서 굶주려 내려와 순찰대를 물어뜯습니다. 먼저 12마리를 처치하십시오, {playerName}.`, `산등성이의 그림자가 열둘 줄었습니다. 오늘 밤 순찰대가 숨 돌리겠습니다.`],
  q_stalker_pelts: [`이 산의 겨울은 문을 두드리지 않고 걷어찹니다. 추적자 가죽 8장이 성벽 망토를 덧댈 겁니다.`, `내 팔만큼 두껍습니다. 올해 경비대는 얼지 않겠습니다.`],
  q_kobold_tunnels: [`딥록 코볼트들이 성벽 아래에서 부르는 것처럼 곧장 아래로 파고 있습니다. 굴꾼 12마리를 처치하십시오.`, `모든 갱도가 곧장 아래입니다. 코볼트가 혼자 이렇게 파지는 않습니다.`],
  q_glowing_wax: [`굴꾼에게서 나온 밀랍은 빛나고 심장처럼 따뜻합니다. 캐디스의 연구를 위해 빛나는 밀랍 6개를 가져오십시오.`, `아직 따뜻합니다. 이 빛은 현자가 아는 어떤 불꽃과도 맞지 않습니다.`],
  q_ogre_edges: [`쏜피크 부족들이 너무 동쪽에 전쟁칠을 하고 야영했습니다. 누군가 값을 치렀습니다. 12마리를 베십시오.`, `열둘이 쓰러졌지만 물러나지 않습니다. 그들을 산 자는 금보다 무거운 것을 냈습니다.`],
  q_ogre_totems: [`오우거들은 가죽과 해골 토템을 세웠습니다. 약탈이 아니라 소집의 표식입니다. 6개를 쓰러뜨려 가져오십시오.`, `해골, 가죽... 그리고 Wyrm 비늘 끈입니다. 교단의 선물입니다, {playerName}.`],
  ...
  q_drogmar: [`드로그마르는 고룡교단의 돈을 받고 부족들을 산의 깨어남에 맹세시켰습니다. 전쟁 야영지에 들어가 하이워치를 위해 죽이십시오.`, `드로그마르가 제 야영지에서 죽었습니다. 당신은 내 성벽에 겨울 하나를 사 주었습니다, {playerName}.`],
  q_elementals: [`스톰크래그는 천 년 동안 조용했지만 이제 돌이 걷습니다. 정령 12마리를 쓰러뜨려 잔해를 연구하게 해 주십시오.`, `파편들이 울린 종처럼 웅웅댑니다. 산은 화난 것이 아니라 방해받고 있습니다.`],
  q_shard_cores: [`정령의 심장에는 폭풍 핵이 있습니다. 여섯 개를 나란히 놓으면 흔들림의 중심을 알 수 있습니다.`, `모두 남쪽을 가리킵니다. 자석으로 끌리는 쇳가루처럼. 성소입니다, {playerName}.`],
  q_kazzix: [`카직스는 다른 것보다 더 밝게 탑니다. 어깨 달린 폭풍입니다. 먼 바위에서 심장파편을 뽑아 오십시오.`, `아직도 파직댑니다! 훌륭합니다. 이 다리갑옷을 받으십시오.`],
  q_zealots: [`남쪽 봉우리의 바람이 성가를 실어 옵니다. 광신자 12명을 침묵시키십시오, {playerName}. 멎는 목소리마다 산이 하룻밤 더 잡니다.`, `바람은 조용해졌습니다. 두려운 건 노래가 아니라 무언가 대답할지도 모른다는 겁니다.`],
  q_cult_orders: [`광신자들은 공성 전 병사처럼 움직입니다. 8명을 더 죽이고 명령서 4묶음을 가져오십시오.`, `이 필체는 모르덴의 마법서에서 본 것입니다. 모든 무덤을 같은 손이 이끌었습니다, {playerName}.`],
  q_necromancers: [`명령서는 성소 둘레의 성물함 고리를 말합니다. 영혼 그릇입니다. 강령술사 8명을 죽이고 3개를 온전하게 가져오십시오.`, `빛이여 용서하소서. 계곡과 습지의 죽은 자들이 담겨 있습니다. 그들은 군대가 아니라 십일조였습니다.`],
  q_revenants: [`성소 길 동쪽에는 오래된 전장이 있습니다. 교단이 녹슨 갑옷의 뼈들을 일으켰습니다. 12구를 흙으로 돌려보내십시오.`, `그들도 한때 병사였습니다. 내 병사들과 같습니다. 그들을 부른 것은 죽은 자를 존중하지 않습니다.`],
  q_revenant_vanguard: [`망령들이 진짜 대열을 짭니다, {playerName}. 성소로 행군하기 전에 14구를 더 꺾으십시오.`, `들판이 다시 고요합니다. 받으십시오. 이보다 더 자격 있는 이는 없습니다.`],
  q_wyrm_sigils: [`이제 전부 알아야 합니다. 무덤부름은 무덤고룡 코르줄을 섬기며, 훔친 영혼마다 깨어남의 공물이 됩니다. 인장 3개를 가져오십시오.`, `그렇습니다... 세대를 거쳐 쓰인 깨어남의 기도입니다. 그들은 가까이 왔습니다, {playerName}.`],
  q_breaking_the_seal: [`성소의 봉인은 산불로 빚어졌습니다. 같은 불만이 찢지 않고 길을 엽니다. 축복받은 불씨 5개를 가져오십시오.`, `푸르고 맑게 탑니다. 산은 오래된 맹세를 기억합니다.`],
  q_voice_below: [`어젯밤 온 야영지가 성소를 향해 무릎 꿇었습니다. 코르줄이 꿈속에서 말합니다. 광신자 10명과 강령술사 6명을 처치하십시오.`, `무릎 꿇음은 멈췄습니다. 목소리를 침묵시킨 게 아니라 합창을 줄였을 뿐입니다, {playerName}.`],
  q_sanctum_gate: [`마지막 문턱입니다. 교단은 성소 열쇠돌을 깨뜨려 광장에 흩었습니다. 3조각을 가져오면 조용히 열겠습니다.`, `조각들이 맞고 문이 제 열쇠를 알아봅니다. 가장 강한 동료들을 모으십시오, {playerName}.`],
  q_korgath: [`마렌은 성소 입구에서 돛대 같은 사슬과 그 안에서 버티는 오우거 형상을 보았습니다. 네 동료와 코르가스를 쓰러뜨리십시오.`, `코르가스가 마침내 부서졌습니다. 그의 사슬조차 더 나은 끝을 받을 만했습니다.`],
  q_velkhar: [`모르덴, 바엘, 성물함까지 모든 실은 대강령술사 벨카르가 엮었습니다. 그를 끝내십시오, {playerName}.`, `벨카르는 죽었고 의식은 머리를 잃었습니다. 하지만 느꼈겠지요. Wyrm은 더 이상 잠들지 않습니다.`],
  q_gravewyrm: [`멈출 의식은 없습니다, {playerName}. 반쯤 깬 Wyrm뿐입니다. 동료들과 들어가 예배당에서 시작한 일을 끝내십시오.`, `끝났습니다. 세 땅의 죽은 자들이 쉬고 산은 혼령 없이 잠듭니다. 오늘 밤 모든 종이 당신 이름을 울립니다.`],
} satisfies QuestNarrativeTranslations;
...
const ruQuestNarratives = {
  ...
  q_silence_the_call: [`Каждое имя в книге - душа, которую Мортен хочет вытащить из земли. Упокойте 12 беспокойных костей, пока шепот не стал хором.`, `Двор стал тише, но зов теперь поднимается из самой крипты, {playerName}.`],
  ...
  q_sexton: [`Книга называет пономаря Марроу, первого стража, поднятого Мортеном. Спуститесь с четырьмя спутниками и верните ему украденный покой.`, `Марроу наконец свободен. Не звоните по нему; в жизни он слышал достаточно колоколов.`],
  q_gravecallers_trail: [`Мортен мертв, но его секта не пряталась век ради одной деревенской часовни. Найдите его гримуар среди руин, {playerName}.`, `Мортен писал некому Зовущему Туман в северной топи. Секта не умерла, а терпеливо ждала.`],
  ...
  q_fenbridge_muster: [`В писаниях Мортена назван хозяин в северной топи. Снимите приказ о сборе с ворот Фенбриджа и предъявите стражу.`, `Печать Алдрика? Тогда сгодитесь. Топь глотает мои патрули целиком.`],
  ...
  q_prowler_pelts: [`Настилка держится на промасленных шкурах хищников, а мой запас пуст. Принесите 8 целых шкур, пока нам не пришлось брести в Истврук.`, `Добрые толстые шкуры. Теперь настилка переживет нас обоих.`],
  ...
  q_broodmother: [`Паутина толщиной с канат имеет мать. Прорубитесь через 8 вдов и убейте старую матку до выхода выводка.`, `Правда мертва? Тогда чаща снова просто деревья.`],
  ...
  q_trolls: [`Мирефенские тролли вскрыли курганы древнее человеческих королевств. Прогоните их: 12 мертвых троллей хватит.`, `Тролли не копают без причины. Кто-то в серой робе показал им место.`],
  ...
  q_grubjaw: [`Грубджо не копает с остальными; он съел двух моих последних мулов вместе со сбруей. Принесите его клык.`, `Клык длиной с мое предплечье! Мулы отомщены.`],
  ...
  q_summoners: [`Призыватели зовут утопших из воды, как собак на свист. Заставьте 8 умолкнуть и принесите 4 шифра.`, `Каждый шифр заверен дьяконом Воссом и адресован Зовущему Туман в бастионе. Мы нашли его.`],
  ...
  q_bastion_door: [`Затонувший бастион хранит Зовущего Туман, а его дверь запечатана могильными камнями. Принесите один обереговый камень.`, `Печать расходится, как гнилая веревка. Дверь открыта, и тьма слушает.`],
  q_olen: [`Олен умер, защищая бастион, а теперь как кукла стережет ту же дверь. Спуститесь с четырьмя спутниками и дайте ему покой.`, `Его стража наконец окончена. Я сам вырежу его имя на воротах.`],
  q_mistcaller: [`Ваэль ждет на дне бастиона, голос, утопивший сотню путников ради армии. Возьмите четырех спутников и покончите с ним.`, `Ваэль мертв, и туман поднимается. Но его последние слова леденят кровь: Wyrm шевелится под пиками.`],
  q_highwatch_summons: [`Последние слова Ваэля не отпускают меня, {playerName}. Возьмите призыв Хайвотча и скажите Тессали, что Алдрик поднимается следом.`, `Если Алдрик сам идет в горы, дело так плохо, как я боялась. Добро пожаловать в Хайвотч.`],
  ...
  q_stalker_pelts: [`Зима на этой горе не стучит, а вышибает дверь. 8 шкур хребтовых охотников утеплят плащи для стены.`, `Толстые, как моя рука. В этом году дозор не замерзнет.`],
  q_kobold_tunnels: [`Кобольды Глубокоскалья роют прямо вниз, словно их зовут из-под стены. Убейте 12 туннельщиков.`, `Каждый ствол уходит прямо вниз. Кобольды сами так не копают.`],
  q_glowing_wax: [`Воск этих туннельщиков светится и теплый, как сердцебиение. Принесите 6 кусков для исследований Каддиса.`, `Все еще теплый. Хранитель знаний не знает пламени с таким светом.`],
  ...
  q_ogre_totems: [`Огры подняли тотемы из кожи и черепов: знак сбора, не набега. Сорвите 6 и принесите мне.`, `Черепа, кожа... и перевязи из чешуи Wyrm. Подарки культа, {playerName}.`],
  ...
  q_drogmar: [`Дрогмар взял монету Культа Вирма и присягнул кланы пробуждению горы. Войдите в лагерь и убейте его ради Хайвотча.`, `Дрогмар мертв в собственном лагере. Вы купили моей стене зиму, {playerName}.`],
  q_elementals: [`Грозовой Утес молчал тысячу лет, а теперь его камни ходят. Уложите 12 элементалей, чтобы я изучил остатки.`, `Осколки гудят, как ударенные колокола. Гора не злится, {playerName}; ее тревожат.`],
  q_shard_cores: [`В сердце каждого элементаля есть ядро бури. Шесть рядом покажут центр возмущения, хотя я боюсь ответа.`, `Все указывают на юг, как опилки к магниту. К святилищу, {playerName}.`],
  ...
  q_zealots: [`Ветер с южных пиков несет песнопения. Заставьте 12 фанатиков умолкнуть, {playerName}; каждая тишина дает горе еще ночь сна.`, `Ветер стал тише. Меня тревожит не пение, а то, что кто-то может отвечать.`],
  q_cult_orders: [`Фанатики движутся как солдаты перед осадой. Убейте еще 8 и принесите 4 комплекта приказов.`, `Этот почерк я видел в гримуаре Мортена. Одна рука вела каждую могилу, {playerName}.`],
  q_necromancers: [`В приказах сказано о кольце филактерий, сосудах душ вокруг святилища. Убейте 8 некромантов и принесите 3 целыми.`, `Свет, прости нас. В них мертвые долины и топи. Это была не армия, а десятина.`],
  q_revenants: [`К востоку от дороги старое поле боя. Культ поднял кости в ржавых латах. Верните 12 в землю.`, `Когда-то они были солдатами, как мои. То, что их подняло, не чтит мертвых.`],
  ...
  q_wyrm_sigils: [`Пора знать все. Могильный Зов служит Корзулу Могильному Вирму, и каждая украденная душа питает его пробуждение. Принесите 3 сигила.`, `Да... литания пробуждения, писавшаяся поколениями. Они близко, {playerName}.`],
  q_breaking_the_seal: [`Печать святилища выкована горным огнем, и только он откроет путь, не разорвав ее. Принесите 5 благословенных углей.`, `Они горят синим и чистым. Гора помнит старую клятву.`],
  q_voice_below: [`Прошлой ночью весь лагерь встал на колени к святилищу. Корзул говорит им во сне. Убейте 10 фанатиков и 6 некромантов.`, `Коленопреклонение прекратилось. Мы не заставили голос умолкнуть, {playerName}; лишь проредили его хор.`],
  q_sanctum_gate: [`Это последний порог. Культ разбил ключевой камень святилища и разбросал осколки на площади. Принесите 3, и я тихо открою путь.`, `Осколки легли верно, и врата узнали ключ. Соберите сильнейших спутников, {playerName}.`],
  q_korgath: [`Марен нашла у входа в святилище цепи толщиной с мачты и огрскую фигуру внутри. Возьмите четырех спутников и сразите Коргата.`, `Коргат наконец сломлен. Даже его цепи заслуживали более доброго конца.`],
  ...
  q_gravewyrm: [`Больше нет обряда, который можно остановить, {playerName}. Есть только полупроснувшийся Wyrm. Войдите со спутниками и завершите то, что началось у часовни.`, `Все кончено. Мертвые трех земель покоятся, гора спит без призраков, и каждый колокол сегодня звонит вашим именем.`],
} satisfies QuestNarrativeTranslations;
