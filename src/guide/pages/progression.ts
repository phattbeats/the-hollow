// Leveling and Progression. How experience is earned, the journey across the zones,
// rested XP, and what waits at the cap. Spoiler-safe and number-free by design:
...
// The zones, in level-band order, named from the existing world teaser keys.
