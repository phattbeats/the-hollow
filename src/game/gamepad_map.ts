...
// Human-readable names for the bindable buttons, used by the Controller options
// panel. Order is the panel's display order. Guide/home (16) is intentionally
// omitted — the OS usually swallows it.
export const GAMEPAD_BUTTON_LABELS: Record<number, string> = {
  ...
  [GP.L3]: 'L3 (left stick click)',
  [GP.R3]: 'R3 (right stick click)',
  [GP.DPAD_UP]: 'D-pad Up',
