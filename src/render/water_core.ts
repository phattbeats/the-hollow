...
// build time. It reads the ACTIVE water surface (waterLevel(): a custom map's
// override when one is loaded, else the built-in constant) against the same
// deterministic terrainHeight the sim uses. Registered in RENDER_PURE_CORES
