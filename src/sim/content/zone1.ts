...
export const ZONE1_MOBS: Record<string, MobTemplate> = {
  ...
  // -------------------------------------------------------------------------
  // Brightwood Glade: a sunlit wildlife grove south of Eastbrook. Gentle
...
export const ZONE1_QUESTS: Record<string, QuestDef> = {
  ...
  q_brightwood_thinning: {
    id: 'q_brightwood_thinning',
    name: 'Thinning the Glade',
    giverNpcId: 'ranger_elwyn',
    turnInNpcId: 'ranger_elwyn',
    ...
    completionText:
      'Good. The pride is thinned and these pelts are sound — the glade will hold another season.',
    objectives: [
  ...
  q_brightwood_monarch: {
    ...
    completionText:
      'So the old king has fallen. A heavy thing, this — but a kinder end than the wolves would have given him. Wear this crown of his antlers with respect, $N.',
    objectives: [
      { type: 'collect', itemId: 'monarch_heart', count: 1, label: "The Monarch's Heart" },
    ],
    xpReward: 900,
    copperReward: 450,
    itemRewards: {
      warrior: 'monarch_crown_helm',
      mage: 'monarch_crown_helm',
      rogue: 'monarch_crown_helm',
    },
  ...
  // -------------------------------------------------------------------------
  q_ledger_first_duty: {
    id: 'q_ledger_first_duty',
    name: "A Warden's First Duty",
    giverNpcId: 'marshal_redbrook',
    turnInNpcId: 'marshal_redbrook',
    text: 'You want to earn your keep in Eastbrook, $N? Then start where every warden starts. The thornpelt badgers have dug their setts through the south edge of Brightwood Glade, and the grove floor is caving into their burrows. Cull 8 Thornpelt Badgers and the ledger will remember your name.',
    completionText:
      'Eight setts emptied and the grove floor settled. Good. Every name in this ledger started just where you are standing.',
    objectives: [
      { type: 'kill', targetMobId: 'thornpelt_badger', count: 8, label: 'Thornpelt Badger culled' },
    ],
    xpReward: 240,
    copperReward: 70,
    itemRewards: {},
  ...
  q_ledger_teeth: {
    ...
    completionText:
      'Ten foxes, and the henhouses are quiet at dusk again. The ledger grows kinder to you.',
  ...
  q_ledger_reedwater: {
    id: 'q_ledger_reedwater',
    name: 'Reedwater Patrol',
    giverNpcId: 'fisherman_brandt',
    turnInNpcId: 'fisherman_brandt',
    ...
    completionText:
      'That will keep the long-legged thieves out of the south meadow for a season. Tell the Marshal the cranes are thinned.',
    objectives: [
      { type: 'kill', targetMobId: 'meadow_crane', count: 8, label: 'Meadow Crane driven off' },
    ],
    xpReward: 430,
    copperReward: 150,
    itemRewards: {},
  ...
  q_ledger_silk: {
    ...
    completionText:
      'The beds may yet recover, thanks to you. A hard mercy — but a child burning with fever needs the simples more than the wood needs the deer. The ledger is square.',
    objectives: [
      { type: 'kill', targetMobId: 'spotted_fawn', count: 8, label: 'Spotted Fawn culled' },
    ],
    xpReward: 450,
    copperReward: 160,
    itemRewards: {},
  ...
  q_ledger_brood: {
    ...
    completionText:
      'A grim work, drowning a nest. But mercy now is a hundred funerals spared later. The ledger is square.',
    objectives: [
      {
        type: 'kill',
        targetMobId: 'sableweb_hatchling',
        count: 8,
  ...
  q_ledger_deepvermin: {
    id: 'q_ledger_deepvermin',
    name: 'Vermin in the Deep',
    giverNpcId: 'foreman_odell',
    turnInNpcId: 'foreman_odell',
    ...
    completionText:
      'Twelve of the candle-headed vermin, gone! Right, lads — back down the shaft. You have earned the Marshal a good word, $N.',
    objectives: [
      { type: 'kill', targetMobId: 'tunnel_rat', count: 12, label: 'Tunnel Rat Digger slain' },
    ],
    xpReward: 540,
    copperReward: 200,
    itemRewards: {},
  ...
  q_ledger_toll: {
    ...
    completionText:
      'Eight brutes off the road, and the carts are rolling again. Word is already spreading that the trade road has a new keeper. The ledger climbs in your favor.',
    objectives: [
      { type: 'kill', targetMobId: 'grovetusk_boar', count: 8, label: 'Grovetusk Boar slain' },
    ],
    xpReward: 560,
    copperReward: 220,
    itemRewards: {},
  ...
  q_ledger_vigil: {
    ...
    completionText:
      'Ten souls returned to the earth, and a night of peace bought for the chapel. The Light remembers such vigils, even when the ledger forgets.',
    objectives: [
      {
        type: 'kill',
        targetMobId: 'restless_bones',
  ...
  q_ledger_great_boar: {
    id: 'q_ledger_great_boar',
    name: 'The Great Bristleback',
    giverNpcId: 'trader_wilkes',
    turnInNpcId: 'trader_wilkes',
    ...
    completionText:
      'The Elder Bristleback, dead by your hand! That hide alone is worth a season of trade. You have made the ledger proud, $N.',
    objectives: [
      {
        type: 'kill',
        targetMobId: 'elder_bristleback',
        count: 1,
  ...
  q_ledger_outlaw_captain: {
    id: 'q_ledger_outlaw_captain',
    name: 'The Outlaw Captain',
    giverNpcId: 'marshal_redbrook',
    turnInNpcId: 'marshal_redbrook',
    ...
    completionText:
      'Captain Verlan, dead, and his coat brought to my door. The ledger is closed, $N — and the Vale will tell wardens-to-come the name of the one who closed it.',
    objectives: [
...
export const ZONE1_CAMPS: CampDef[] = [
  ...
  // Brightwood Glade: now staged directly south of Eastbrook. Lower-level
  // wildlife starts closest to town, with the harder packs deeper south.
  { mobId: 'glade_fox', center: { x: -24, z: -46 }, radius: 14, count: 5 },
  { mobId: 'spotted_fawn', center: { x: 20, z: -48 }, radius: 14, count: 5 },
  { mobId: 'meadow_crane', center: { x: -28, z: -76 }, radius: 14, count: 4 },
  { mobId: 'thornpelt_badger', center: { x: 24, z: -82 }, radius: 14, count: 4 },
  { mobId: 'bramble_lynx', center: { x: -8, z: -112 }, radius: 16, count: 6 },
  { mobId: 'grovetusk_boar', center: { x: 36, z: -118 }, radius: 14, count: 4 },
  { mobId: 'brightwood_monarch', center: { x: 6, z: -146 }, radius: 5, count: 1 },
];
