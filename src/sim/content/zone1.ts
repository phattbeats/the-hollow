...
export const ZONE1_ZONE: ZoneDef = {
  ...
  pois: [
    ...
    { x: 0, z: -86, label: 'Brightwood Glade' },
  ],
...
export const ZONE1_NPCS: Record<string, NpcDef> = {
  ...
  ranger_elwyn: {
    ...
    name: 'Ranger Elwyn',
    title: 'Glade Warden',
    // Posted south of Eastbrook, outside town but ahead of the first wildlife pockets.
    pos: { x: 0, z: -34 },
    facing: 0,
    color: 0x3a7d44,
    questIds: [],
