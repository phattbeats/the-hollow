...
export const CLASSES: Record<PlayerClass, ClassDef> = {
  ...
  warlock: {
    ...
    abilities: ['shadow_bolt', 'demon_skin', 'summon_imp', 'immolate', 'corruption', 'life_tap', 'curse_of_agony', 'summon_voidwalker', 'drain_life', 'fear', 'searing_pain', 'shadowburn'],
    color: 0x9482c9,
  },
  druid: {
    id: 'druid',
...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  summon_imp: {
    id: 'summon_imp', name: 'Summon Fire Demon', class: 'warlock', learnLevel: 1,
    cost: 35, castTime: 4.0, cooldown: 0, range: 0, school: 'shadow',
    requiresTarget: false,
    effects: [{ type: 'summonPet', templateId: 'warlock_imp' }],
    description: 'Summons a fiery demon companion that casts Firebolt at your enemies.',
  },
  immolate: {
  ...
  summon_voidwalker: {
    id: 'summon_voidwalker', name: 'Summon Void Demon', class: 'warlock', learnLevel: 10,
    cost: 65, castTime: 5.0, cooldown: 0, range: 0, school: 'shadow',
    requiresTarget: false,
    effects: [{ type: 'summonPet', templateId: 'warlock_voidwalker' }],
    description: 'Summons a sturdy void demon that protects you with high health, armor, and Growl.',
  },
  drain_life: {
