...
describe('Api URL helpers', () => {
  ...
  it('resolves native or realm calls against an absolute origin', () => {
    expect(apiUrl('/api/status', 'https://thehollow.world/')).toBe(
      'https://thehollow.world/api/status',
    );
    expect(apiUrl('https://realm.example.com/api/status', 'https://thehollow.world')).toBe(
