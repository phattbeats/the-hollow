...
//
// `IWorld` (src/world_api.ts:341-510, 146 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (146 / 36 / 110)
...
// The 146 members of `interface IWorld`, in interface order (world_api.ts:342-509).
// Partition: 36 `data` + 110 `method` (read-returning + command-void + 3 async).
