...
// it lands the matching edit here in the SAME commit. The count pins (162 / 44 / 118)
...
// Partition: 44 `data` + 118 `method` (read-returning + command-void + 3 async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 24 facets', () => {
  ...
  it('the union of the 24 facets equals the pinned 162-member IWORLD_MEMBERS set', () => {
