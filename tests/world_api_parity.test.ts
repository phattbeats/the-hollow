...
// it lands the matching edit here in the SAME commit. The count pins (184 / 53 / 131)
...
// The 29 facet interfaces the W1 split produced (src/world_api/<facet>.ts). Imported
...
// Partition: 53 `data` + 131 `method` (read-returning + command-void + 3 async).
...
// --- W1: aggregate == disjoint union of the 29 facet member sets --------------------
...
//   (3) the 29 arrays are pairwise DISJOINT (a member filed in two facets reddens);
...
// The 29-facet partition, keyed by facet for legible failure messages.
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 29 facets', () => {
  it('pins the facet count at 29', () => {
  ...
  it('the 29 facet arrays are pairwise disjoint (no member filed in two facets)', () => {
  ...
  it('the union of the 29 facets equals the pinned 184-member IWORLD_MEMBERS set', () => {
