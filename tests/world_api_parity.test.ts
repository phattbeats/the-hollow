...
// it lands the matching edit here in the SAME commit. The count pins (160 / 42 / 118)
...
// Partition: 42 `data` + 118 `method` (read-returning + command-void + 3 async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 25 facets', () => {
  ...
  it('the union of the 25 facets equals the pinned 160-member IWORLD_MEMBERS set', () => {
