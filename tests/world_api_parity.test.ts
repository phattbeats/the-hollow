...
//
// `IWorld` (src/world_api.ts, 163 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (163 / 44 / 119)
...
// The 163 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 44 `data` + 119 `method` (read-returning + command-void + 3 async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the sorted data-kind set is exactly the pinned 44', () => {
...
// The 24-facet partition, keyed by facet for legible failure messages.
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 24 facets', () => {
  ...
  it('the union of the 24 facets equals the pinned 163-member IWORLD_MEMBERS set', () => {
