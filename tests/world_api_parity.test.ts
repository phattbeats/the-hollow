...
// it lands the matching edit here in the SAME commit. The count pins (171 / 45 / 126)
...
// Partition: 45 `data` + 126 `method` (read-returning + command-void + 3 async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 126', () => {
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 26 facets', () => {
  ...
  it('the union of the 26 facets equals the pinned 171-member IWORLD_MEMBERS set', () => {
