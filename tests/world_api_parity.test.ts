...
// it lands the matching edit here in the SAME commit. The count pins (158 / 42 / 116)
...
// Partition: 42 `data` + 116 `method` (read-returning + command-void + 3 async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 24 facets', () => {
  ...
  it('the union of the 24 facets equals the pinned 159-member IWORLD_MEMBERS set', () => {
