...
// collectors (server/periodic_collector.ts): it caches the last successful query
// result, refresh() re-runs the query, and a failed query keeps the previous
...
import { PeriodicCollector } from '../server/periodic_collector';
