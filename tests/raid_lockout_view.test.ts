...
import { raidLockoutPanelHtml, type RaidLockoutI18n } from '../src/ui/raid_lockout_view';
...
describe('raidLockoutPanelHtml', () => {
  ...
  it('lists a locked raid with its resolved name and duration', () => {
    const html = raidLockoutPanelHtml([{ id: 'nythraxis_boss_arena', msRemaining: 5 * 3600000 }], i18n);
