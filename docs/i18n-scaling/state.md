...
## Current status
- **Active phase:** Phase 3 + Phase 3 QA DONE (PASS, 2026-06-16); next up Phase 4. Phase 3 QA added a permanent subset guard `tests/i18n_overlay_key_membership.test.ts` (commit `2c2066f`) and corrected the one-shot migration's idempotency comments (commit `c5f6738`); no source/data change, SHA `d9db528..` unchanged. Phase 2 DONE (commits `3f1ed8d`, `a92ff37`, `ffb40e5`); Phase 2 QA still NOT STARTED. Phase 1 DONE + QA PASS.
