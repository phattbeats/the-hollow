...
| `the-hollow-book-of-the-plant.md` (v1.0, 386 lines) | In-world scripture, Chronicle through Coda, with factual glosses | `docs/lore/book-of-the-plant.md` |
| `the-hollow-lorebook-notes.md` (v1.0, 435 lines) | The working bible: approach, cast, worldbuilding, numbered fable seeds | `docs/lore/lorebook-notes.md` |
