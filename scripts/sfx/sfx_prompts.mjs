...
export const SFX = [
  ...
  ...mob(
    'plant',
    'A carnivorous plant creature',
    'creaking and bristling with rustling leaves and thorns',
    'lashing out with a wet vine-snap and rattling thorns',
    'wilting into a slow creaking collapse of dry rustling leaves',
  ),
