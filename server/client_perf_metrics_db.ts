...
// (server/client_perf_metrics.ts) does zero SQL and only shapes these rows into
// gauges. This module only READS the existing client_perf_reports table (and its
// existing _release_created / _gpu_created indexes); it adds no schema.
