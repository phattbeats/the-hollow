...
// The host persists an override document ({ [fieldId]: value }), audits
// before/after values, and replays it through applyConfig at boot. Config fields
// are operator-visible and MUST NOT expose secrets.
